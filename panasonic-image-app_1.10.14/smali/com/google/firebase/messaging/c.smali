...
.method private final a(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v2, v1}, Landroid/support/v4/content/a;->b(Landroid/content/Context;I)I
...
.method final c(Landroid/os/Bundle;)Z
    ...
    invoke-static {v0, v7, v6, v12}, Lcom/google/firebase/iid/p;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v7, v8, v0, v12}, Lcom/google/firebase/iid/p;->b(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-direct {v0, v8}, Landroid/support/v4/a/ac$d;-><init>(Landroid/content/Context;)V

    invoke-virtual {v0, v9}, Landroid/support/v4/a/ac$d;->a(Z)Landroid/support/v4/a/ac$d;

    move-result-object v0

    invoke-virtual {v0, v3}, Landroid/support/v4/a/ac$d;->a(I)Landroid/support/v4/a/ac$d;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/a/ac$d;->a(Ljava/lang/CharSequence;)Landroid/support/v4/a/ac$d;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/a/ac$d;->b(Ljava/lang/CharSequence;)Landroid/support/v4/a/ac$d;

    new-instance v1, Landroid/support/v4/a/ac$c;

    invoke-direct {v1}, Landroid/support/v4/a/ac$c;-><init>()V

    invoke-virtual {v1, v2}, Landroid/support/v4/a/ac$c;->a(Ljava/lang/CharSequence;)Landroid/support/v4/a/ac$c;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/a/ac$d;->b(I)Landroid/support/v4/a/ac$d;

    :cond_13
    if-eqz v5, :cond_14

    invoke-virtual {v0, v5}, Landroid/support/v4/a/ac$d;->a(Landroid/net/Uri;)Landroid/support/v4/a/ac$d;

    :cond_14
    if-eqz v6, :cond_15

    invoke-virtual {v0, v6}, Landroid/support/v4/a/ac$d;->a(Landroid/app/PendingIntent;)Landroid/support/v4/a/ac$d;

    :cond_15
    if-eqz v7, :cond_16

    invoke-virtual {v0, v7}, Landroid/support/v4/a/ac$d;->b(Landroid/app/PendingIntent;)Landroid/support/v4/a/ac$d;
