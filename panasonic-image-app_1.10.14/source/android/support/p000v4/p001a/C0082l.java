...
public class C0082l extends C0074i implements C0010a, C0065a {
    ...
    final Handler f220c = new Handler() {
        public void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    if (C0082l.this.f224g) {
                        C0082l.this.mo203a(false);
                        return;
                    }
                    return;
                case 2:
                    C0082l.this.mo200a();
                    C0082l.this.f221d.mo268n();
                    return;
                default:
    ...
    class C0084a extends C0088o<C0082l> {
        public C0084a() {
            super(C0082l.this);
        }
        ...
        public void mo233a(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            C0082l.this.dump(str, fileDescriptor, printWriter, strArr);
        }

        /* renamed from: a */
        public boolean mo234a(C0076k kVar) {
            return !C0082l.this.isFinishing();
        }

        /* renamed from: b */
        public LayoutInflater mo235b() {
            return C0082l.this.getLayoutInflater().cloneInContext(C0082l.this);
        }
        ...
        public void mo232a(C0076k kVar, Intent intent, int i, Bundle bundle) {
            C0082l.this.mo202a(kVar, intent, i, bundle);
        }

        /* renamed from: d */
        public boolean mo238d() {
            return C0082l.this.getWindow() != null;
        }

        /* renamed from: e */
        public int mo239e() {
            Window window = C0082l.this.getWindow();
            if (window == null) {
                return 0;
            }
        ...
        public void mo236b(C0076k kVar) {
            C0082l.this.mo201a(kVar);
        }

        /* renamed from: a */
        public View mo196a(int i) {
            return C0082l.this.findViewById(i);
        }
