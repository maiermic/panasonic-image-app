...
class NotificationCompat {
    ...
    public static class C0046a implements C0011aa, C0012ab {
        ...
        public void mo5a(C0040a aVar) {
            this.f86c.add(NotificationCompat.m116a(this.f84a, aVar));
        }
        ...
        public Notification mo7b() {
            ...
            Bundle a = NotificationCompat.m117a(build);
            ...
            a.putAll(bundle);
            SparseArray a2 = NotificationCompat.m118a(this.f86c);
            if (a2 != null) {
                NotificationCompat.m117a(build).putSparseParcelableArray("android.support.actionExtras", a2);
            }
            if (this.f87d != null) {
