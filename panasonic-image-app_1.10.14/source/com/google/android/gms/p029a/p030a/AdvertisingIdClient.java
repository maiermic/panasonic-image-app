...
public class AdvertisingIdClient {
    ...
    static class C0521b extends Thread {
        ...
        /* renamed from: c */
        private WeakReference<AdvertisingIdClient> f1097c;

        /* renamed from: d */
        private long f1098d;

        public C0521b(AdvertisingIdClient aVar, long j) {
        ...
        private final void m2044a() {
            AdvertisingIdClient aVar = (AdvertisingIdClient) this.f1097c.get();
            if (aVar != null) {
                aVar.mo1400b();
                this.f1096b = true;
            }
    ...
    public static C0520a m2033a(Context context) {
        ...
        boolean z = false;
        try {
            Context e = GooglePlayServicesUtil.m2587e(context);
            if (e != null) {
        ...
        AdvertisingIdClient aVar = new AdvertisingIdClient(context, -1, z);
        try {
            aVar.m2038b(false);
        ...
        try {
            ...
            switch (C0672m.m2498b().mo1609a(context)) {
                ...
                case 2:
                    ...
                    try {
                        if (ConnectionTracker.m2525a().mo1749a(context, intent, iVar, 1)) {
                            return iVar;
                        }
    ...
    public void mo1400b() {
        ...
        L_0x0010:
            ...
            com.google.android.gms.common.stats.ConnectionTracker.m2525a()     // Catch:{ IllegalArgumentException -> 0x002c, Throwable -> 0x0035 }
        ...
        L_0x0035:
            ...
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.p029a.p030a.AdvertisingIdClient.mo1400b():void");
    }
