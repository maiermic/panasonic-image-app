...
public final class C0685u extends C0658a {
    public static final Creator<C0685u> CREATOR = new C0702v();
    ...
    C0685u(String str, IBinder iBinder, boolean z) {
        this.f1453a = str;
        this.f1454b = m2533a(iBinder);
        this.f1455c = z;
    }

    C0685u(String str, C0674o oVar, boolean z) {
        this.f1453a = str;
        this.f1454b = oVar;
        this.f1455c = z;
    }
