...
public class GooglePlayServicesUtil {
    ...
    public static boolean m2579a(Context context, int i) {
        return UidVerifier.m2565a(context, i);
    }
    ...
    public static boolean m2580a(Context context, int i, String str) {
        return UidVerifier.m2566a(context, i, str);
    }
    ...
    static boolean m2581a(android.content.Context r5, java.lang.String r6) {
        ...
        L_0x0078:
            ...
            goto L_0x0035
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.common.GooglePlayServicesUtil.m2581a(android.content.Context, java.lang.String):boolean");
    }
    ...
    public static int m2582b(Context context) {
        ...
        try {
            ...
            GoogleSignatureVerifier.m2589a(context);
            if (z) {
                C0674o a = GoogleSignatureVerifier.m2588a(packageInfo, C0677r.f1420a);
                if (a == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play Store signature invalid.");
                    return 9;
                }
                if (GoogleSignatureVerifier.m2588a(packageInfo2, a) == null) {
                    Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                    return 9;
                }
            } else if (GoogleSignatureVerifier.m2588a(packageInfo2, C0677r.f1420a) == null) {
                Log.w("GooglePlayServicesUtil", "Google Play services signature invalid.");
                return 9;
            }
    ...
    public static boolean m2585c(Context context) {
        if (!f1480f) {
            try {
                ...
                if (b != null) {
                    GoogleSignatureVerifier.m2589a(context);
                    if (GoogleSignatureVerifier.m2588a(b, C0677r.f1420a[1]) != null) {
                        f1479e = true;
                    }
                }
                f1479e = false;
