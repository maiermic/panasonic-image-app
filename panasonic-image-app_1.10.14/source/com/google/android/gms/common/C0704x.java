...
public class C0704x {
    ...
    /* renamed from: a */
    private static C0704x f1482a;

    /* renamed from: b */
    private final Context f1483b;

    private C0704x(Context context) {
    ...
    /* renamed from: a */
    public static C0704x m2589a(Context context) {
        C0612ab.m2289a(context);
        synchronized (C0704x.class) {
            if (f1482a == null) {
                C0673n.m2504a(context);
                f1482a = new C0704x(context);
            }
        }
        return f1482a;
    }
