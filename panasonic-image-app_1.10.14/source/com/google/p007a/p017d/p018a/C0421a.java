...
final class C0421a {
    ...
    public byte[] mo1258a() {
        ...
        int e = this.f852b.mo1185e();
        int d = this.f852b.mo1184d();
        for (int i = 0; i < e; i++) {
            int[] iArr = f851a[i];
            for (int i2 = 0; i2 < d; i2++) {
                int i3 = iArr[i2];
                if (i3 >= 0 && this.f852b.mo1178a(i2, i)) {
                    int i4 = i3 / 6;
