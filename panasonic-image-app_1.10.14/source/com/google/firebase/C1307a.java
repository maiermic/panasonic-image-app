...
public class C1307a {
    ...
    /* renamed from: a */
    static final Map<String, C1307a> f3589a = new C0132a();
    ...
    static class C1310c extends BroadcastReceiver {
        ...
        public final void onReceive(Context context, Intent intent) {
            synchronized (C1307a.f3595g) {
                for (C1307a a : C1307a.f3589a.values()) {
                    a.m5120h();
                }
            }
    ...
    private C1307a(Context context, String str, C1314b bVar) {
    ...
    /* renamed from: a */
    public static C1307a m5110a(Context context) {
        C1307a a;
        synchronized (f3595g) {
    ...
    /* renamed from: a */
    public static C1307a m5111a(Context context, C1314b bVar) {
        return m5112a(context, bVar, "[DEFAULT]");
    }

    /* renamed from: a */
    public static C1307a m5112a(Context context, C1314b bVar, String str) {
        C1307a aVar;
        ...
        synchronized (f3595g) {
            ...
            aVar = new C1307a(context, trim, bVar);
            f3589a.put(trim, aVar);
        }
        C0732b.m2705a(aVar);
        aVar.m5114a(C1307a.class, (T) aVar, (Iterable<String>) f3590b);
        if (aVar.mo3113e()) {
            aVar.m5114a(C1307a.class, (T) aVar, (Iterable<String>) f3591c);
    ...
    /* renamed from: d */
    public static C1307a m5117d() {
        C1307a aVar;
        synchronized (f3595g) {
            aVar = (C1307a) f3589a.get("[DEFAULT]");
            if (aVar == null) {
    ...
    public final void m5120h() {
        m5114a(C1307a.class, (T) this, (Iterable<String>) f3590b);
        if (mo3113e()) {
            m5114a(C1307a.class, (T) this, (Iterable<String>) f3591c);
    ...
    public boolean equals(Object obj) {
        ...
        return this.f3597i.equals(((C1307a) obj).mo3111b());
    }
