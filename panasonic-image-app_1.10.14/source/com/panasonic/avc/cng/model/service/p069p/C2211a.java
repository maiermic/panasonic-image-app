...
public class C2211a extends C2252y {
    ...
    private class C2222a implements C2018b {
        ...
        public void mo5297a(boolean z, C1892f fVar, boolean z2, int i) {
            C2261g.m9763a("WifiService", "Passwordless OnFinishConnectCamera");
            if (C2211a.this.f6857g != null) {
                C2211a.this.f6857g.mo5612a(z, fVar, z2, i);
            }
        }
    }
    ...
    public C2211a(Context context, Handler handler) {
        super(context, handler);
        this.f6947a = context;
        this.f6856f = new C2754l(this.f6947a);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x009f, code lost:
        com.panasonic.avc.cng.util.C2261g.m9763a("WifiService", "FindTargetAP() Failed... ");
     */
    ...
    public com.panasonic.avc.cng.view.cameraconnect.C2649a mo5859b(java.lang.String r13, java.lang.String r14) {
        ...
        L_0x00a8:
            ...
            goto L_0x0022
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p069p.C2211a.mo5859b(java.lang.String, java.lang.String):com.panasonic.avc.cng.view.cameraconnect.a");
    }
    ...
    public int m9496b(C2649a aVar, final boolean z) {
        int i;
        if (aVar == null) {
            C2261g.m9769c("WifiService", "ConnectWifiAP2: AccessPointInfo is null...");
            return 4;
        }
        if (aVar.mo6533c()) {
            WifiConfiguration a = this.f6856f.mo6733a(aVar.mo6528a(), aVar.mo6534d());
            if (a == null) {
                C2261g.m9769c("WifiService", "ConnectWifiAP2: CreateNewConfig() is failed...");
                return 4;
            }
            aVar.mo6529a(a);
        }
        ...
        C22164 r8 = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                C2261g.m9763a("WifiService", "onReceive");
                if (intent != null) {
                    ...
                    if (action.equals("android.net.wifi.supplicant.STATE_CHANGE")) {
                        ...
                        if (supplicantState != null) {
                            switch (C22153.f6876a[supplicantState.ordinal()]) {
                                case 1:
                                    C2261g.m9771e("WifiService", "ASSOCIATED");
                                    break;
                                case 2:
                                    C2261g.m9771e("WifiService", "ASSOCIATING");
                                    break;
                                case 3:
                                    C2261g.m9771e("WifiService", "AUTHENTICATING");
                                    break;
                                case 4:
                                    C2261g.m9771e("WifiService", "COMPLETED");
                                    break;
                                case 5:
                                    C2261g.m9771e("WifiService", "DISCONNECTED");
                                    break;
                                case 6:
                                    C2261g.m9771e("WifiService", "DORMANT");
                                    break;
                                case 7:
                                    C2261g.m9771e("WifiService", "FOUR_WAY_HANDSHAKE");
                                    break;
                                case C1702a.HorizontalPicker_title_area_width /*8*/:
                                    C2261g.m9771e("WifiService", "GROUP_HANDSHAKE");
                                    break;
                                case C1702a.HorizontalPicker_title_image /*9*/:
                                    C2261g.m9771e("WifiService", "INACTIVE");
                                    break;
                                case C1702a.HorizontalPicker_right_blank_area_width /*10*/:
                                    C2261g.m9771e("WifiService", "INTERFACE_DISABLED");
                                    break;
                                case C1702a.HorizontalPicker_hairline_visible /*11*/:
                                    C2261g.m9771e("WifiService", "INVALID");
                                    break;
                                case 12:
                                    C2261g.m9771e("WifiService", "SCANNING");
                                    break;
                                case 13:
                                    C2261g.m9771e("WifiService", "UNINITIALIZED");
                                    break;
                                default:
                                    C2261g.m9771e("WifiService", "Unknown");
                                    break;
                            }
                            if (intent.getIntExtra("supplicantError", -1) == 1) {
                                C2261g.m9769c("WifiService", "ERROR_AUTHENTICATING");
                                C2211a.this.f6855e = 6;
                                countDownLatch.countDown();
                            }
                        }
                    } else if (action.equals("android.net.conn.CONNECTIVITY_CHANGE")) {
                        if (C2211a.this.f6856f.mo6739a(b)) {
                            C2261g.m9769c("WifiService", "ConnectivityManager.CONNECTIVITY_ACTION　接続OK");
                            C2211a.this.f6855e = 3;
                            countDownLatch.countDown();
                        }
                    } else if (action.equals("android.net.wifi.STATE_CHANGE") && C2211a.this.f6856f.mo6739a(b)) {
                        C2261g.m9769c("WifiService", "WifiManager.NETWORK_STATE_CHANGED_ACTION 接続OK");
                        C2211a.this.f6855e = 3;
                        countDownLatch.countDown();
                    }
                }
        ...
        if (this.f6856f.mo6740a(aVar.mo6532b(), !z)) {
            ...
            while (true) {
                ...
                C2261g.m9769c("WifiService", "ConnectWifiAP2: ConnectWifiAP() waiting..." + i2);
                if (m9513i()) {
                    C2261g.m9769c("WifiService", "停止要求確認　Break");
                    break;
                }
                try {
                    if (countDownLatch.await(1, TimeUnit.SECONDS)) {
                        C2261g.m9769c("WifiService", "latch確認　Break");
                        break;
                    }
                    C2261g.m9769c("WifiService", "指定APに接続しているかチェック");
                    if (i2 % 15 == 14 && this.f6856f.mo6747b(aVar.mo6532b())) {
                        C2261g.m9769c("WifiService", "指定APに接続されていない→再接続");
            ...
            C2261g.m9769c("WifiService", "ConnectWifiAP2: ConnectWifiAP() is failed...");
            this.f6855e = 4;
        }
        if (this.f6856f != null) {
            ...
            if (str2 != null && (str2.equals("SO-01F") || str2.equals("SO-01J"))) {
                new Timer(true).schedule(new TimerTask() {
                    public void run() {
                        cancel();
                        if (C2211a.this.f6856f != null && !z) {
                            C2211a.this.f6856f.mo6751d();
                        }
                    }
                }, 15000);
    ...
    public void mo5854a(final C2649a aVar, final boolean z) {
        ...
        this.f6860j = new Thread(new Runnable() {
            public void run() {
                C2211a.this.f6855e = 0;
                int a = C2211a.this.m9496b(aVar, z);
                if (C2211a.this.f6857g != null) {
                    C2211a.this.f6857g.mo5609a(a, aVar);
                }
                if (!C2211a.this.m9513i()) {
                    C2211a.this.f6855e = a;
                }
            }
        });
        this.f6860j.start();
    ...
    private void m9515j() {
        if (this.f6858h == null) {
            this.f6858h = new Thread(new Runnable() {
                public void run() {
                    if (C2211a.this.f6859i != null) {
                        try {
                            C2211a.this.f6859i.join();
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                        C2211a.this.f6859i = null;
                    }
                    C2211a.this.f6858h = null;
                }
            }, "stopAction");
            this.f6858h.start();
        }
    ...
    public void mo5862d() {
        ...
        this.f6860j = new Thread(new Runnable() {
            public void run() {
                int e = C2211a.this.m9516k();
                boolean c = C2211a.this.m9513i();
                if (C2211a.this.f6857g != null) {
                    C2211a.this.f6857g.mo5610a(e, c);
                }
            }
        });
        this.f6860j.start();
    ...
    public int m9516k() {
        C2046c cVar = null;
        C2043f b = C2253z.m9688b(this.f6947a, true);
        for (int i = 0; i < 100; i++) {
            cVar = b.mo5319a(0);
            if (cVar != null || m9513i()) {
                break;
    ...
    public void m9499b(final boolean z) {
        ...
        this.f6860j = new Thread(new Runnable() {
            public void run() {
                boolean b = C2211a.this.m9504c(z);
                int e = C2211a.this.m9516k();
                boolean c = C2211a.this.m9513i();
                if (C2211a.this.f6857g != null) {
                    C2211a.this.f6857g.mo5611a(b, e, c);
                }
            }
        });
        this.f6860j.start();
        ...
        this.f6859i = new Thread(new Runnable() {
            ...
            public void run() {
                /*
                    ...
                    r5 = 1
                    r2 = 0
                    com.panasonic.avc.cng.model.service.p.a r0 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                ...
                L_0x0021:
                    ...
                    com.panasonic.avc.cng.model.service.p.a r0 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    android.content.Context r0 = r0.f6947a
                    com.panasonic.avc.cng.model.service.p.a r1 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    android.os.Handler r1 = r1.f6854d
                    com.panasonic.avc.cng.model.service.f r0 = com.panasonic.avc.cng.model.service.C2253z.m9689b(r0, r5, r1)
                    r0.mo5330g()
                L_0x004a:
                    com.panasonic.avc.cng.model.service.p.a r0 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    android.content.Context r0 = r0.f6947a
                    com.panasonic.avc.cng.model.service.p.a r1 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    android.os.Handler r1 = r1.f6854d
                    com.panasonic.avc.cng.model.service.e r7 = com.panasonic.avc.cng.model.service.C2253z.m9681a(r0, r5, r1)
                    r1 = r2
                    r0 = r3
                L_0x005c:
                    com.panasonic.avc.cng.model.service.p.a r4 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    java.lang.Object r4 = r4.f6862l
                    monitor-enter(r4)
                    com.panasonic.avc.cng.model.service.p.a r6 = com.panasonic.avc.cng.model.service.p069p.C2211a.this     // Catch:{ all -> 0x0129 }
                    boolean r6 = r6.f6861k     // Catch:{ all -> 0x0129 }
                    if (r6 == 0) goto L_0x0107
                    com.panasonic.avc.cng.model.service.p.a r1 = com.panasonic.avc.cng.model.service.p069p.C2211a.this     // Catch:{ all -> 0x0129 }
                    r6 = 0
                ...
                L_0x0074:
                    ...
                    monitor-enter(r8)
                    com.panasonic.avc.cng.model.service.p.a r0 = com.panasonic.avc.cng.model.service.p069p.C2211a.this     // Catch:{ all -> 0x01ab }
                ...
                L_0x008a:
                    ...
                    com.panasonic.avc.cng.util.C2261g.m9763a(r0, r8)
                ...
                L_0x0107:
                    ...
                    monitor-enter(r6)
                    com.panasonic.avc.cng.model.service.p.a r0 = com.panasonic.avc.cng.model.service.p069p.C2211a.this     // Catch:{ all -> 0x0167 }
                ...
                L_0x0175:
                    ...
                    com.panasonic.avc.cng.model.service.p.a r6 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                ...
                L_0x01c3:
                    ...
                    com.panasonic.avc.cng.model.service.j r0 = com.panasonic.avc.cng.model.service.C2253z.m9682a(r0, r6, r2)
                ...
                L_0x0246:
                    ...
                    com.panasonic.avc.cng.model.f r0 = (com.panasonic.avc.cng.model.C1892f) r0
                    r9.mo4897a(r0)
                    com.panasonic.avc.cng.model.service.p.a r9 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    java.lang.Object r0 = r4.get(r2)
                    com.panasonic.avc.cng.model.f r0 = (com.panasonic.avc.cng.model.C1892f) r0
                ...
                L_0x02d7:
                    ...
                    com.panasonic.avc.cng.model.service.p.a r7 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                    ...
                    com.panasonic.avc.cng.model.service.p.a r8 = com.panasonic.avc.cng.model.service.p069p.C2211a.this
                ...
                L_0x035c:
                    ...
                    goto L_0x0074
                */
                throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p069p.C2211a.C22142.run():void");
            }
        });
        this.f6859i.start();
    }
    ...
    public boolean m9494a(C1892f fVar) {
        ...
        C2013a aVar = (C2013a) C2253z.m9680a(this.f6947a, false);
        if (aVar == null) {
            return true;
        }
        ...
        while (true) {
            ...
            if (this.f6861k) {
                ...
                if (aoVar.mo3546a(3, 10) == null) {
                    C2261g.m9769c("WifiService", "CameraStatus is null.");
                }
                mo5851a(1000);
            }
        }
