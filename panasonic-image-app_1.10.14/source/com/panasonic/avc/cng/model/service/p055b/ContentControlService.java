...
public class ContentControlService implements C2010c {
    ...
    public ContentControlService(Context context) {
        this.f6121a = context;
    }
    ...
    public void m8097a(C1878d dVar, String str) {
        ...
        ServiceFactory.m9695c(this.f6121a, null).mo5040e();
    }
    ...
    private void m8105b(List<C1878d> list, final C2011a aVar) {
        ...
        if (a != null && list.size() != 0) {
            ...
            this.f6123c = new Thread() {
                public void run() {
                    ContentControlService.this.f6126f.mo3439a();
                }
            };
            this.f6123c.start();
        }
            ...
            this.f6123c = new Thread() {
                ...
                public void run() {
                    /*
                        ...
                        r5.<init>()
                        com.panasonic.avc.cng.model.service.a r6 = com.panasonic.avc.cng.model.service.ServiceFactory.m9703f()
                        r6.mo5041f()
                    ...
                    L_0x0022:
                        ...
                        com.panasonic.avc.cng.model.service.b.a r0 = com.panasonic.avc.cng.model.service.p055b.ContentControlService.this     // Catch:{ all -> 0x0093 }
                    ...
                    L_0x0042:
                        ...
                        com.panasonic.avc.cng.util.ImageAppLog.debug(r2, r3)     // Catch:{ all -> 0x0093 }
                        r2 = 1
                    ...
                    L_0x006e:
                        ...
                        com.panasonic.avc.cng.util.ImageAppLog.error(r0, r1)     // Catch:{ all -> 0x0093 }
                        com.panasonic.avc.cng.model.service.c$a r0 = r4     // Catch:{ all -> 0x0093 }
                    ...
                    L_0x00ab:
                        ...
                        com.panasonic.avc.cng.util.ImageAppLog.debug(r0, r1)     // Catch:{ all -> 0x0093 }
                        r0 = 1
                    ...
                    L_0x00c4:
                        ...
                        goto L_0x0041
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p055b.ContentControlService.C19987.run():void");
                }
            };
            this.f6123c.start();
        }
            ...
            this.f6123c = new Thread() {
                public void run() {
                    ...
                    while (true) {
                        int i2 = i;
                        if (i2 >= list.size()) {
                            ServiceFactory.m9703f().mo5033a((List<C1878d>) arrayList);
                            if (aVar != null) {
                                aVar.mo4442a("finish");
                                return;
                            }
                            return;
                        } else if (ContentControlService.this.f6127g) {
                            ServiceFactory.m9703f().mo5033a((List<C1878d>) arrayList);
                            if (aVar != null) {
                                aVar.mo4442a("cancel");
                                return;
                            ...
                            ContentControlService.this.m8096a((C1878d) kVar);
                            arrayList.add(kVar);
                            i = i2 + 1;
                        }
                    }
            ...
            public void run() {
                ...
                if (file.exists()) {
                    if (file.isDirectory()) {
                        ...
                        int i = 0;
                        while (i < list.length) {
                            if (ContentControlService.this.m8100a(ContentControlService.this.f6122b, str, list[i])) {
                                if (aVar != null) {
    ...
    public void mo5206a(C1878d dVar, String str, C2011a aVar) {
        synchronized (C1910l.m7679a()) {
            ServiceFactory.m9693b(true);
            m8107b(dVar, str, 0, aVar);
            ServiceFactory.m9693b(false);
        }
    }
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    while (true) {
                        ...
                        if (i2 < list4.size()) {
                            final int i3 = i2 + 1;
                            if (ContentControlService.this.m8107b((C1878d) list4.get(i2), (String) list5.get(i2), ((Integer) list6.get(i2)).intValue(), (C2011a) new C2011a() {
                                /* renamed from: a */
    ...
    public boolean m8107b(C1878d dVar, String str, int i, C2011a aVar) {
        ...
        if (dVar instanceof C1833c) {
            final StatusCommand aoVar = null;
            C1892f a = C1712b.m6919c().mo4896a();
            if (a != null) {
                aoVar = new StatusCommand(a.f5682d);
            }
            ...
            this.f6124d = new C1417c(cVar.f5308l.f5315a, cVar.mo4628r(), str, i, new C1529m() {
                ...
                public void mo3768a(String str) {
                    if (str.equalsIgnoreCase("finish")) {
                        ContentControlService.this.m8097a((C1878d) cVar, str2);
                        ContentControlService.this.f6128h = true;
                    }
                    if (aVar2 != null) {
                        aVar2.mo4442a(str);
                    }
                ...
                public void mo3767a(int i) {
                    ...
                    if (aoVar != null) {
                        ...
                        if (currentTimeMillis != this.f6146g) {
                            ImageAppLog.debug("ContentControlService", "GetState() for alive...");
                            this.f6146g = currentTimeMillis;
                            CameraStatus a = aoVar.mo3546a(1, 1000);
            ...
            this.f6124d = new C1417c(str, 0, str2, new C1529m() {
                ...
                public void mo3768a(String str) {
                    if (str.equalsIgnoreCase("finish") && z2) {
                        ContentControlService.this.m8097a((C1878d) null, str3);
                    }
                    if (aVar2 != null) {
                        aVar2.mo4442a(str);
                    }
        ...
        synchronized (C1910l.m7679a()) {
            ...
            this.f6125e = new C1420d(cVar, 0, new C1528l() {
                ...
                public void mo3766a(String str, C2003c cVar) {
                    if (str.equalsIgnoreCase("finish") && z2) {
                        ContentControlService.this.m8097a((C1878d) null, cVar.f6191c);
                    }
                    if (bVar2 != null) {
