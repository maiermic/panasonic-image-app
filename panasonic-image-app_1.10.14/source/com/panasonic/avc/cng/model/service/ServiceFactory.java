...
import com.panasonic.avc.cng.model.service.imageapp.ImageAppService;
...
import com.panasonic.avc.cng.model.service.p055b.ContentControlService;
...
import com.panasonic.avc.cng.model.service.p057d.DmsService;
import com.panasonic.avc.cng.model.service.p058e.C2032a;
import com.panasonic.avc.cng.model.service.p059f.LiveViewLumixService;
import com.panasonic.avc.cng.model.service.p059f.C2056e;
import com.panasonic.avc.cng.model.service.p059f.C2058f;
import com.panasonic.avc.cng.model.service.p059f.LiveViewVerticalService;
import com.panasonic.avc.cng.model.service.p060g.MultiPhotoService;
import com.panasonic.avc.cng.model.service.p061h.C2084a;
import com.panasonic.avc.cng.model.service.p062i.C2098a;
import com.panasonic.avc.cng.model.service.p063j.PlayerServiceDLNA;
import com.panasonic.avc.cng.model.service.p063j.PlayerServiceLocal;
import com.panasonic.avc.cng.model.service.p063j.C2150c;
import com.panasonic.avc.cng.model.service.p063j.C2157d;
import com.panasonic.avc.cng.model.service.p064k.RemoteViewService;
...
import com.panasonic.avc.cng.model.service.p067n.ThreeBoxService;
...
public class ServiceFactory {
    ...
    /* renamed from: q */
    private static Picmate f6966q = null;
    /* access modifiers changed from: private */

    /* renamed from: r */
    public static Picmate f6967r = null;
    ...
    public static void m9692b() {
        ...
        if (f6964o != null) {
            ImageAppLog.debug("ServiceFactory", "_nfcService.Finalize()");
            f6964o.mo5501f();
            f6964o = null;
        }
        if (f6969t != null) {
    ...
    /* renamed from: a */
    public static Picmate m9676a(Context context) {
        if (f6966q == null) {
            f6966q = new Picmate(context);
        }
        return f6966q;
    }

    /* renamed from: a */
    public static Picmate m9677a(Context context, Handler handler) {
        if (f6966q == null) {
            f6966q = new Picmate(context);
        } else {
            f6966q.mo4223n();
    ...
    public static void m9696c() {
        new Thread(new Runnable() {
            public void run() {
                if (ServiceFactory.f6967r != null) {
                    ServiceFactory.f6967r.mo4179a();
                }
            }
        }).start();
    }
    ...
    public static C2176k m9690b(Context context, C1892f fVar) {
        if (fVar.mo4886a()) {
            return new LiveViewLumixService();
        }
        if (fVar.f5688j == 131074) {
            return new C2056e();
        }
        if (fVar.f5688j == 131075) {
            return new LiveViewVerticalService();
        }
    ...
    public static C1921a m9695c(Context context, C1892f fVar) {
        if (fVar != null) {
            return new BrowserServiceCamera(context, fVar);
        }
        if (m9710i()) {
            return f6960k;
        }
    ...
    public static C2236s m9683a(Context context, C1878d dVar) {
        ...
        if (b.equals("hls")) {
            return new PlayerServiceDLNA(context);
        }
        if (b.equals("standard")) {
            return new PlayerServiceLocal(context);
        }
        return null;
    }
    ...
    public static C2137j m9682a(Context context, Handler handler, boolean z) {
        if (f6970u == null) {
            f6970u = new ImageAppService(context, handler, z);
            f6970u.mo5151a();
        }
        return f6970u;
    }
    ...
    public static C2199n m9709i(Context context) {
        return new MultiPhotoService(context);
    }

    /* renamed from: j */
    public static C2010c m9711j(Context context) {
        return new ContentControlService(context);
    }

    /* renamed from: k */
    public static C2248w m9714k(Context context) {
        return new ThreeBoxService(context);
    }

    /* renamed from: l */
    public static C2238t m9715l(Context context) {
        if (f6968s == null) {
            f6968s = new RemoteViewService(context);
        }
        return f6968s;
    }
    ...
    public static C2043f m9689b(Context context, boolean z, Handler handler) {
        ...
        synchronized (context.getApplicationContext()) {
            if (f6969t == null && z) {
                f6969t = new DmsService(context, handler);
            }
        }
        return f6969t;
    }
