...
public class C2060h implements C2176k {
    /* access modifiers changed from: private */

    /* renamed from: a */
    public C1535s f6370a;
    /* access modifiers changed from: private */

    /* renamed from: b */
    public C1543y f6371b;

    /* renamed from: c */
    private C2048b f6372c;
    ...
    private class C2061a implements Runnable {
                ...
                try {
                    if (!this.f6379c || m8572a()) {
                        synchronized (C1910l.m7679a()) {
                            a = C2060h.this.f6370a.mo3789a(gVar.mo5380b(), 5);
                        }
                        if (!a.mo4771a()) {
                            C2060h.this.mo5385a(a);
                            gVar.mo5382d();
                            return;
                        }
                        if (C2060h.this.f6374e != null) {
                            C2060h.this.f6374e.mo5766a(0);
                        }
                        while (!C2060h.this.f6376g) {
                            try {
                                C1473at atVar = new C1473at(gVar.mo5381c());
                                if (C2060h.this.f6374e != null) {
                                    C2060h.this.f6374e.mo5766a(1);
                                    C2060h.this.mo5384a(atVar);
                                }
                                long j = 1;
                                ...
                                C2060h.this.mo5383a(j);
                            } catch (Exception e) {
                                C2261g.m9769c("LiveViewVerticalService", e.toString());
                            }
                        }
                        synchronized (C1910l.m7679a()) {
                            C2060h.this.f6370a.mo3792b(1);
                        }
                        gVar.mo5382d();
                        return;
                    }
                    ...
                    C2261g.m9769c("LiveViewVerticalService", e2.toString());
                }
            } catch (SocketException e3) {
                C2261g.m9769c("LiveViewVerticalService", e3.toString());
            }
        }
        ...
        private boolean m8572a() {
            ...
            L_0x000e:
                ...
                com.panasonic.avc.cng.model.service.f.h r0 = com.panasonic.avc.cng.model.service.p059f.C2060h.this     // Catch:{ all -> 0x0107 }
            ...
            L_0x002d:
                ...
                r3 = -1
                com.panasonic.avc.cng.model.service.f.h r4 = com.panasonic.avc.cng.model.service.p059f.C2060h.this     // Catch:{ all -> 0x0107 }
            ...
            L_0x00ba:
                ...
                goto L_0x002d
            L_0x00c6:
                com.panasonic.avc.cng.model.service.f.h r3 = com.panasonic.avc.cng.model.service.p059f.C2060h.this     // Catch:{ all -> 0x0107 }
                long r10 = (long) r8     // Catch:{ all -> 0x0107 }
            ...
            L_0x010a:
                ...
                com.panasonic.avc.cng.model.service.f.h r2 = com.panasonic.avc.cng.model.service.p059f.C2060h.this     // Catch:{ all -> 0x0107 }
            ...
            L_0x011c:
                ...
                goto L_0x00a3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p059f.C2060h.C2061a.m8572a():boolean");
        }
    }
    ...
    public void mo5369f() {
        ...
        if (a != null) {
            this.f6370a = new C1535s(a.f5682d, a.mo4891e());
            this.f6371b = new C1543y(a.f5682d);
            this.f6372c = new C2048b();
    ...
    /* renamed from: a */
    public void mo5385a(C1853h hVar) {
        if (this.f6374e != null) {
