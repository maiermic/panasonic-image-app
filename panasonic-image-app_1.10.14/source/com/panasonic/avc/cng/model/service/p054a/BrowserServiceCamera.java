...
public class BrowserServiceCamera implements C1921a, C1922a {
    ...
    /* renamed from: c */
    ModeChangeCommand f5909c;

    /* renamed from: d */
    StatusCommand f5910d;

    /* renamed from: e */
    ParseTagDcTitle f5911e;

    /* renamed from: f */
    DlnaBrowseCore f5912f;
    ...
    private class C1938a {
        ...
        private class C1940b implements Runnable {
            ...
            public C1940b(int i) {
                ...
                try {
                    Display defaultDisplay = ((WindowManager) BrowserServiceCamera.this.f5907a.getSystemService("window")).getDefaultDisplay();
            ...
            public void run() {
                ...
                this.f5949h = false;
                while (!this.f5947f) {
                    if (BrowserServiceCamera.this.f5927u) {
                        this.f5949h = true;
                        return;
                    } else if (this.f5948g) {
                        try {
                            ...
                            if (aVar.f5938a.f5311o != null) {
                                ...
                                if (str != null) {
                                    synchronized (C1910l.m7679a()) {
                                        synchronized (BrowserServiceCamera.this.f5924r) {
                                ...
                                if (arVar == null || arVar.mo3578a() == null) {
                                    synchronized (this.f5943b) {
                                        ImageAppLog.error("BrowserServiceCamera", "ExecuteGetThumbnail() Error");
                                        this.f5953l++;
    ...
    public BrowserServiceCamera(Context context, C1892f fVar) {
        this.f5907a = context;
        this.f5908b = fVar;
        this.f5914h = "0";
        this.f5927u = false;
    ...
    public void mo5032a(java.lang.String r8, java.lang.String r9, java.lang.String r10) {
        ...
        L_0x0133:
            ...
            goto L_0x007e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p054a.BrowserServiceCamera.mo5032a(java.lang.String, java.lang.String, java.lang.String):void");
    }
    ...
    public void mo5029a() {
        Thread thread = new Thread(new Runnable() {
            public void run() {
                BrowserServiceCamera.this.mo5032a(BrowserServiceCamera.this.f5914h, BrowserServiceCamera.this.f5915i, BrowserServiceCamera.this.f5916j);
            }
        });
        thread.start();
        try {
    ...
    public void mo5084a(C1878d dVar) {
        ...
        if (cVar != null && this.f5918l.contains(cVar)) {
            ...
            if (str == null) {
                ImageAppLog.error("BrowserServiceCamera", "DmpBrowse() Error");
                this.f5927u = true;
                return;
            }
    ...
    private int m7837d(int i) {
        ...
        synchronized (this.f5924r) {
            ...
            while (true) {
                ...
                ImageAppLog.error("BrowserServiceCamera", String.format(Locale.US, "[%d] Browse() startIdx = %d, requestNum = %d", new Object[]{Integer.valueOf(i3), Integer.valueOf(i2), Integer.valueOf(min)}));
                if (this.f5916j == null || this.f5916j.equalsIgnoreCase("")) {
                    if (this.f5912f != null) {
                ...
                if (str2 != null) {
                    ...
                    ImageAppLog.error("BrowserServiceCamera", "content = 0 retry");
                }
                i3++;
            }
        }
        ...
        if (a2.size() == 0) {
            ImageAppLog.error("BrowserServiceCamera", "Invalid State.");
            this.f5927u = true;
        }
        return iArr[0];
    }
    ...
    private boolean m7840o() {
        C2028e a = ServiceFactory.m9680a(this.f5907a, false);
        if (a == null) {
            return false;
        }
        C2017a k = a.mo5287k();
