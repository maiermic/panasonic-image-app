...
public class C2202a implements C2248w {
    ...
    public void mo5830a(C1892f fVar, C1892f fVar2, C2249a aVar) {
        ...
        new Thread(new Runnable() {
            /* JADX WARNING: Code restructure failed: missing block: B:56:0x013f, code lost:
                if (com.panasonic.avc.cng.model.service.p067n.C2202a.m9418d(r12.f6840a) == null) goto L_0x014a;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:57:0x0141, code lost:
                com.panasonic.avc.cng.model.service.p067n.C2202a.m9418d(r12.f6840a).mo5923b();
             */
            /* JADX WARNING: Code restructure failed: missing block: B:59:0x0164, code lost:
                if (com.panasonic.avc.cng.model.service.p067n.C2202a.m9415b(r12.f6840a).mo4253a(com.panasonic.avc.cng.util.C2266l.m9791a(-1, true), com.panasonic.avc.cng.model.service.p067n.C2202a.m9419e(r12.f6840a).f5684f).mo4308a() != false) goto L_0x016d;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:60:0x0166, code lost:
                com.panasonic.avc.cng.util.C2261g.m9769c("ThreeBoxService", "DmcSetConnectRenderer");
             */
            /* JADX WARNING: Code restructure failed: missing block: B:62:0x0173, code lost:
                if (com.panasonic.avc.cng.model.service.p067n.C2202a.m9418d(r12.f6840a) == null) goto L_?;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:63:0x0175, code lost:
                com.panasonic.avc.cng.model.service.p067n.C2202a.m9418d(r12.f6840a).mo5921a();
             */
            ...
            public void run() {
                /*
                    ...
                    monitor-enter(r6)
                    com.panasonic.avc.cng.model.service.n.a r0 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.core.dlna.DlnaWrapper r0 = r0.f6832e     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.model.service.n.a r1 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    ...
                    com.panasonic.avc.cng.util.C2261g.m9769c(r0, r1)     // Catch:{ all -> 0x010a }
                L_0x0029:
                    com.panasonic.avc.cng.model.service.n.a r0 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.core.a.y r1 = new com.panasonic.avc.cng.core.a.y     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.model.service.n.a r5 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    ...
                    r7 = 0
                    com.panasonic.avc.cng.model.service.n.a r8 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    ...
                    com.panasonic.avc.cng.util.C2261g.m9771e(r0, r1)     // Catch:{ all -> 0x010a }
                ...
                L_0x0094:
                    ...
                    java.lang.String r9 = r0.f4990c     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.model.service.n.a r10 = com.panasonic.avc.cng.model.service.p067n.C2202a.this     // Catch:{ all -> 0x010a }
                    ...
                    com.panasonic.avc.cng.util.C2261g.m9771e(r1, r0)     // Catch:{ all -> 0x010a }
                    r1 = r2
                    r0 = r3
                L_0x00ce:
                ...
                L_0x00f9:
                    ...
                    com.panasonic.avc.cng.util.C2261g.m9771e(r5, r8)     // Catch:{ all -> 0x010a }
                    r5 = r1
                    goto L_0x007a
                L_0x0105:
                    r1 = move-exception
                ...
                L_0x012f:
                    ...
                    r0.mo4290s()     // Catch:{ all -> 0x010a }
                    monitor-exit(r6)     // Catch:{ all -> 0x010a }
                    com.panasonic.avc.cng.model.service.n.a r0 = com.panasonic.avc.cng.model.service.p067n.C2202a.this
                ...
                L_0x014a:
                    ...
                    com.panasonic.avc.cng.model.service.n.a r2 = com.panasonic.avc.cng.model.service.p067n.C2202a.this
                ...
                L_0x0180:
                    ...
                    goto L_0x00ce
                */
                throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p067n.C2202a.C22031.run():void");
            }
        }).start();
    }
    ...
    public boolean mo5831a(C1878d dVar) {
        ...
        synchronized (this.f6828a) {
            ...
            if (!b2.mo4308a()) {
                C2261g.m9769c("ThreeBoxService", "DmcSetAVTransportURI");
            }
        }
        return b2.mo4308a();
    }
    ...
    /* renamed from: c */
    public void mo5833c() {
        C2261g.m9771e("ThreeBoxService", "Play");
        this.f6835h = new Thread(new Runnable() {
            public void run() {
                synchronized (C2202a.this.f6828a) {
                    C2202a.this.f6836i = false;
                    C2202a.this.f6837j = false;
                    if (!C2202a.this.f6832e.mo4285n().mo4308a()) {
                        C2261g.m9769c("ThreeBoxService", "DmcPlay");
                    }
                }
                while (true) {
                    if (C2202a.this.f6836i) {
                        C2202a.this.f6836i = false;
                        if (C2202a.this.f6832e != null) {
                            C2202a.this.f6839l = C2202a.this.f6832e.mo4288q();
                            if (C2202a.this.f6834g != null) {
                                if (C2202a.this.f6839l != null) {
                                    C2202a.this.f6834g.mo5922a(0, C2202a.this.f6839l.f5026b);
                                }
                                C2202a.this.f6834g.mo5924c();
                            }
                        }
                    } else if (C2202a.this.f6837j) {
                        C2202a.this.f6837j = false;
                        if (C2202a.this.f6832e != null) {
                            C2202a.this.f6839l = C2202a.this.f6832e.mo4288q();
                            if (!(C2202a.this.f6834g == null || C2202a.this.f6839l == null)) {
                                C2202a.this.f6834g.mo5922a(C2202a.this.f6839l.f5025a, C2202a.this.f6839l.f5026b);
                            }
                        }
                    } else {
                        if (C2202a.this.f6832e != null) {
                            for (int i = 0; i < 2; i++) {
                                ...
                                C2261g.m9769c("ThreeBoxService", "GetPositionInfo retry!!!");
                            }
                            if (C2202a.this.f6839l == null) {
                                C2202a.this.mo5835e();
                                if (C2202a.this.f6834g != null) {
                                    C2202a.this.f6834g.mo5927f();
                                }
                            }
                            if (!(C2202a.this.f6839l == null || C2202a.this.f6834g == null)) {
                                C2261g.m9771e("ThreeBoxService", String.format("curTimeSecond = %d, totalTimeSecond = %d", new Object[]{Integer.valueOf(C2202a.this.f6839l.f5025a), Integer.valueOf(C2202a.this.f6839l.f5026b)}));
                                C2202a.this.f6834g.mo5922a(C2202a.this.f6839l.f5025a, C2202a.this.f6839l.f5026b);
                            }
                            if (C2202a.this.f6839l == null || C2202a.this.f6839l.f5025a == C2202a.this.f6839l.f5026b) {
                            }
                        }
                        try {
                            Thread.sleep(900);
    ...
    /* renamed from: d */
    public void mo5834d() {
        C2261g.m9771e("ThreeBoxService", "Pause");
        synchronized (this.f6828a) {
            if (!this.f6832e.mo4286o().mo4308a()) {
                C2261g.m9769c("ThreeBoxService", "DmcPause");
            }
            this.f6837j = true;
            if (this.f6835h != null) {
                try {
    ...
    public void mo5829a(final int i, final boolean z) {
        C2261g.m9771e("ThreeBoxService", "Seek");
        new Thread(new Runnable() {
            public void run() {
                synchronized (C2202a.this.f6828a) {
                    if (z) {
                        C2261g.m9771e("ThreeBoxService", String.format("seekPosSec(isPlaying) = %d", new Object[]{Integer.valueOf(i)}));
                        if (!C2202a.this.f6832e.mo4265b(i).mo4308a()) {
                            C2261g.m9769c("ThreeBoxService", "DmcSeek");
                        }
                    } else {
                        C2261g.m9771e("ThreeBoxService", String.format("seekPosSec(!isPlaying) = %d", new Object[]{Integer.valueOf(i)}));
                        if (!C2202a.this.f6832e.mo4285n().mo4308a()) {
                        ...
                        if (!C2202a.this.f6832e.mo4286o().mo4308a()) {
                            C2261g.m9769c("ThreeBoxService", "DmcPause");
                        }
                    }
                    for (int i = 0; i < 10; i++) {
                        ...
                        if (C2202a.this.f6839l != null && i - 1 <= C2202a.this.f6839l.f5025a && i + 1 >= C2202a.this.f6839l.f5025a) {
                            break;
                        }
                    }
                    if (C2202a.this.f6834g != null) {
                        C2202a.this.f6834g.mo5925d();
                    }
                }
                return;
            }
    ...
    /* renamed from: e */
    public void mo5835e() {
        C2261g.m9771e("ThreeBoxService", "Stop");
        synchronized (this.f6828a) {
            if (!this.f6832e.mo4287p().mo4308a()) {
                C2261g.m9769c("ThreeBoxService", "DmcStop");
            }
            this.f6836i = true;
            if (this.f6835h != null) {
                try {
