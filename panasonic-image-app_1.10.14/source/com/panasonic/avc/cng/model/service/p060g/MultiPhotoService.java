...
import com.panasonic.avc.cng.core.p040a.MultiPhotoCommand;
...
public class MultiPhotoService implements C2199n {
    ...
    /* renamed from: d */
    private MultiPhotoCommand f6383d;
    ...
    public MultiPhotoService(Context context) {
        this.f6382c = context;
    }
    ...
    public void mo5388a() {
        ...
        if (a != null) {
            this.f6383d = new MultiPhotoCommand(a.f5682d);
            this.f6384e = ServiceFactory.m9711j(this.f6382c);
            this.f6384e.mo5204a();
        }
    }
    ...
    public void mo5389a(List<String> list, final C2201b bVar) {
        if (this.f6383d != null && list != null && list.size() > 0) {
            ...
            while (!this.f6386g) {
                ...
                ImageAppLog.info("MultiPhotoService", String.format("state=%s progress=%d err=%s", new Object[]{strArr[0], Integer.valueOf(iArr[0]), strArr2[0]}));
                if (bVar != null) {
                    bVar.mo5826a(iArr[0]);
                }
                if (!strArr[0].equalsIgnoreCase("finish")) {
                    if (strArr[0].equalsIgnoreCase("cancel")) {
                        ImageAppLog.info("MultiPhotoService", "Cancelling...");
                ...
                try {
                    ...
                    this.f6384e.mo5207a(cVar, z, (C2012b) new C2012b() {
                        ...
                        public void mo5258a(int i, int i2) {
                            if (MultiPhotoService.this.f6386g) {
                                ImageAppLog.info("MultiPhotoService", "CopyFromDeviceExtraCancel");
                                MultiPhotoService.this.f6384e.mo5219e();
                                MultiPhotoService.this.f6386g = false;
                            }
                            if (aVar2 != null) {
                                if (MultiPhotoService.this.f6387h != i2) {
                                    aVar2.mo5824a(i, i2);
                                }
                                MultiPhotoService.this.f6387h = i2;
                            }
                        }
                        ...
                        public void mo5260a(String str, C2003c cVar) {
                            ...
                            if (str.equalsIgnoreCase("finish")) {
                                ...
                                MultiPhotoService.this.f6385f = true;
    ...
    public void mo5394d() {
        if (this.f6383d != null) {
            ImageAppLog.info("MultiPhotoService", "FinishMultiPhoto");
            this.f6383d.mo3834c();
        }
    }
    ...
    private void m8576a(String str, int i, C1449ak akVar, C2066a aVar) {
        ...
        int i3;
        m8575a(aVar, 0);
        ParseTagHighlightSceneInfo a = this.f6383d.mo3829a(str, (long) i);
        if (a.mo4771a()) {
            String I = a.mo4764I();
