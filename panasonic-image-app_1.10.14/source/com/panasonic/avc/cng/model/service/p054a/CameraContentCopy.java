...
public class CameraContentCopy extends C2252y {
    ...
    public CameraContentCopy(Context context, Handler handler) {
    ...
    /* renamed from: a */
    public void mo5151a() {
        this.f6083d = ServiceFactory.m9711j(this.f6084e);
        this.f6083d.mo5204a();
    }
    ...
    public void mo5152a(C1979b bVar) {
        ...
        this.f6089j = new Thread(new Runnable() {
            public void run() {
                if (CameraContentCopy.this.f6948b != null) {
                    CameraContentCopy.this.f6948b.post(new Runnable() {
                        public void run() {
                            if (CameraContentCopy.this.f6090k != null) {
                                CameraContentCopy.this.f6090k.mo5065a();
                            }
                        }
                    });
                    CameraContentCopy.this.f6087h = 0;
                    CameraContentCopy.this.m8040a(Integer.valueOf(0).intValue());
                }
            }
        });
        this.f6089j.start();
    ...
    public void m8040a(int i) {
        if (!this.f6088i) {
            ...
            this.f6948b.post(new Runnable() {
                public void run() {
                    if (CameraContentCopy.this.f6090k != null) {
                        CameraContentCopy.this.f6090k.mo5067a("cancel");
                    }
                }
            });
        }
    ...
    private void m8042b(int i) {
        ...
        ImageAppLog.debug("CameraContentCopy", "[" + this.f6087h + "]" + this.f6094o);
        this.f6083d.mo5215b(this.f6094o, b, new C2011a() {
            ...
            public void mo4441a(int i, final int i2) {
                if (CameraContentCopy.this.f6948b != null) {
                    CameraContentCopy.this.f6948b.post(new Runnable() {
                        public void run() {
                            if (CameraContentCopy.this.f6090k != null) {
                                CameraContentCopy.this.f6090k.mo5066a(CameraContentCopy.this.f6087h + 1, i2);
                            }
                        }
                    });
                }
            ...
            public void mo4442a(final String str) {
                if (str == "finish") {
                    if (CameraContentCopy.this.f6948b != null && CameraContentCopy.this.f6090k != null) {
                        CameraContentCopy.this.f6948b.post(new Runnable() {
                            public void run() {
                                if (CameraContentCopy.this.f6090k != null) {
                                    CameraContentCopy.this.f6090k.mo5068b();
                                }
                            }
                        });
                    }
                } else if (CameraContentCopy.this.f6948b != null) {
                    CameraContentCopy.this.f6948b.post(new Runnable() {
                        public void run() {
                            if (CameraContentCopy.this.f6090k != null) {
                                CameraContentCopy.this.f6090k.mo5067a(str);
                            }
                        }
                    });
                }
