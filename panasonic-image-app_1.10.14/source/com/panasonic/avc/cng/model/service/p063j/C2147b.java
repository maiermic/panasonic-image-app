...
public class C2147b implements C2236s {
    ...
    private class C2149a implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnSeekCompleteListener, OnVideoSizeChangedListener {
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            ...
            C2261g.m9771e("PlayerServiceLocal", String.format("onPrepared(): width = %d, height = %d", new Object[]{Integer.valueOf(videoWidth), Integer.valueOf(videoHeight)}));
            if (videoWidth == 0 || videoHeight == 0) {
                videoWidth = 640;
                videoHeight = 360;
            }
            if (C2147b.this.f6652e != null) {
                C2147b.this.f6652e.mo5900a(videoWidth, videoHeight);
            }
        }

        public void onCompletion(MediaPlayer mediaPlayer) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onCompletion()", new Object[0]));
            if (C2147b.this.f6652e != null) {
                C2147b.this.f6652e.mo5907f();
            }
        }

        public void onSeekComplete(MediaPlayer mediaPlayer) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onSeekComplete()", new Object[0]));
        }

        public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onVideoSizeChanged(): width = %d, height = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
        }

        public void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onBufferingUpdate(): percent = %d", new Object[]{Integer.valueOf(i)}));
        }

        public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onInfo(): what = %d, extra = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            return true;
        }

        public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceLocal", String.format("onError(): what = %d, extra = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            if (C2147b.this.f6652e != null) {
                C2147b.this.f6652e.mo5903b(i, i2);
            }
            return false;
        }
    }
