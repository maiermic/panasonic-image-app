...
public class C2180c implements P2pmwDelegate {
    ...
    public C2180c(Context context, C2182b bVar, C2240b bVar2) {
        this.f6760d = context;
        this.f6761e = bVar;
        this.f6762f = bVar2;
        ...
        while (this.f6763g) {
            switch (this.f6766j) {
                ...
                case C1702a.HorizontalPicker_right_blank_area_width /*10*/:
                    if (m9305h() != 1) {
                        C2261g.m9766b("VianaSetup", String.format("startVianaSetup() : Disconnect Error !!", new Object[0]));
                        this.f6766j = 12;
                        break;
                    } else {
                        this.f6768l = 50;
                ...
                case C1702a.HorizontalPicker_hairline_visible /*11*/:
                    try {
                        ...
                        if (this.f6768l != 0) {
                            ...
                            this.f6766j = 12;
                            C2261g.m9766b("VianaSetup", String.format("startVianaSetup() : Disconnect time out !!", new Object[0]));
                            break;
                        }
    ...
    public void mo5801a(ST_P2PMM_NotifyInitCfm sT_P2PMM_NotifyInitCfm) {
        ...
        if (sT_P2PMM_NotifyInitCfm.lP2PStatus != 1) {
            this.f6766j = 5;
            C2261g.m9769c("VianaSetup", String.format("p2pmwInitCB() error %d", new Object[]{Integer.valueOf(sT_P2PMM_NotifyInitCfm.lP2PStatus)}));
            return;
        }
    ...
    public void mo5798a(ST_P2PMM_ConnectCfm sT_P2PMM_ConnectCfm) {
        ...
        if (sT_P2PMM_ConnectCfm.lP2PStatus != 1) {
            this.f6766j = 8;
            C2261g.m9769c("VianaSetup", String.format("p2pmwConnectSuccessCB() error %d", new Object[]{Long.valueOf(sT_P2PMM_ConnectCfm.lP2PStatus)}));
            return;
        }
    ...
    public void mo5800a(ST_P2PMM_NotifyFinish sT_P2PMM_NotifyFinish) {
        C2261g.m9769c("VianaSetup", String.format("p2pmwConnectFinishCB() status %d", new Object[]{Integer.valueOf(sT_P2PMM_NotifyFinish.lP2PStatus)}));
    ...
    private int m9304g() {
        ...
        L_0x0102:
            ...
            goto L_0x0086
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.service.p064k.C2180c.m9304g():int");
    }
    ...
    private int m9302a(String str) {
        ...
        if (P2PAPLStart != 1) {
            C2261g.m9769c("VianaSetup", String.format("P2PAPLStart NG. code = %s", new Object[]{Integer.valueOf(P2PAPLStart)}));
        } else {
    ...
    private int m9303a(String str, String str2) {
        ...
        if (P2PAPLConnect != 1) {
            C2261g.m9769c("VianaSetup", String.format("P2PAPLConnect NG. code = %s", new Object[]{Integer.valueOf(P2PAPLConnect)}));
        }
    ...
    private int m9301a(int i) {
        ...
        C2261g.m9771e("VianaSetup", String.format("convertVianaError() : _error_no=%d, ret=%d", new Object[]{Integer.valueOf(this.f6759b), Integer.valueOf(i2)}));
        return i2;
    }
}
