...
public class C2048b {
    ...
    private class C2050a implements Runnable {
        ...
        public void run() {
            boolean d;
            C1473at atVar;
            C2048b.this.f6314e = new G711Codec();
            C2048b.this.f6315f = new PacketLossConcealer();
            C2048b.this.f6314e.mo4239a();
            C2048b.this.f6315f.mo4245a();
            C1892f a = C1712b.m6919c().mo4896a();
            if (a == null || a.f5688j != 131073) {
                C2048b.this.f6314e.mo4240a(1);
            } else if (C1879a.m7545b(a, "1.1")) {
                String k = a.f5691m.mo4739k();
                if (k != null && k.equalsIgnoreCase("m_since14spring_v9")) {
                    C2048b.this.f6314e.mo4240a(2);
            ...
            while (true) {
                synchronized (C2048b.this.f6311b) {
                    d = C2048b.this.f6313d;
                    if (d || C2048b.this.f6310a.size() <= 0) {
                        atVar = null;
                    } else {
                        if (C2048b.this.f6310a.size() > 50) {
                            C2261g.m9763a("G711Renderer", "G711 Queue Overflow...");
                            while (C2048b.this.f6310a.size() > 20) {
                                C1473at atVar2 = (C1473at) C2048b.this.f6310a.remove(0);
                                if (!(atVar2 == null || atVar2.f3978c == null)) {
                                    C2048b.this.f6320k.mo5353a(atVar2.f3978c.f3991a);
                                }
                            }
                        }
                        atVar = (C1473at) C2048b.this.f6310a.remove(0);
                    }
                }
                if (d) {
                    if (C2048b.this.f6316g != null) {
                        C2048b.this.f6316g.stop();
                        C2048b.this.f6316g = null;
                    }
                    if (C2048b.this.f6315f != null) {
                        C2048b.this.f6315f.mo4248b();
                        C2048b.this.f6315f = null;
                    }
                    if (C2048b.this.f6314e != null) {
                        C2048b.this.f6314e.mo4243b();
                        C2048b.this.f6314e = null;
                        return;
                    }
                    return;
                } else if (atVar != null) {
                    C2048b.this.m8478b(atVar);
                    if (atVar.f3978c != null) {
                        C2048b.this.f6320k.mo5353a(atVar.f3978c.f3991a);
                    }
                } else {
                    try {
                        Thread.sleep(10);
        ...
        if (this.f6314e != null) {
            ...
            if (this.f6315f == null || !this.f6319j) {
                ...
                if (this.f6317h == -1 || (this.f6317h >= 0 && this.f6317h + this.f6318i == atVar.f3976a.f3987i)) {
                    ...
                    C2261g.m9771e("G711Renderer", "ConcealLoss");
