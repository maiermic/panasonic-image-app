...
import com.panasonic.avc.cng.model.service.p054a.C1970m.C1979b;
...
public class C1925a extends C2252y {
    ...
    private class C1929a implements C2210p {
        ...
        public void mo5071a(int i, int i2) {
            C2261g.m9771e("BrowseMenuService", String.format("onResponseConnectionVM(%d, %d)", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            if (i == 1) {
                if (i2 == 4) {
                    C1925a.this.f5851e.mo4602g();
                } else {
                    C1925a.this.f5850d.mo5615a();
                }
            } else if (C1925a.this.f6948b != null) {
                C1925a.this.f6948b.post(new Runnable() {
                    public void run() {
                        if (C1925a.this.m7781h()) {
                            C1925a.this.m7779g();
                        }
                    }
                });
        ...
        public void mo5074b(int i, int i2) {
            C2261g.m9771e("BrowseMenuService", String.format("onResponseVM(%d, %d)", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            if (i2 != 4) {
                return;
            }
            if (C1925a.this.f6948b != null) {
                C1925a.this.f6948b.post(new Runnable() {
                    public void run() {
                        if (C1925a.this.f5851e.mo4603h()) {
                            C1925a.this.f5859m = C1925a.this.f5851e.mo4601f();
                        }
                        if (C1925a.this.m7781h()) {
                            C1925a.this.m7779g();
                        }
        ...
        public void mo5072a(boolean z) {
            C2261g.m9771e("BrowseMenuService", String.format("onResponseSyncAccountCheck(%s)", new Object[]{String.valueOf(z)}));
        }

        /* renamed from: b */
        public void mo5075b(boolean z) {
            C2261g.m9771e("BrowseMenuService", String.format("onResponseSyncAccountWrite(%s)", new Object[]{String.valueOf(z)}));
        }

        /* renamed from: a */
        public void mo5073a(boolean z, String str, String str2) {
            C2261g.m9771e("BrowseMenuService", String.format("onResponseSyncAccountCheckV2(%s, %s, %s)", new Object[]{String.valueOf(z), str, str2}));
        }
    }

    public C1925a(Context context, Handler handler) {
    ...
    public void mo5060b(String str, String str2) {
        C2261g.m9769c("BrowseMenuService", "prepareSimpleCopy");
        if (Environment.getExternalStorageState().equalsIgnoreCase("mounted")) {
            this.f5855i = new C1970m(this.f6947a, this.f6948b);
            this.f5855i.mo5151a();
    ...
    public void mo5061c() {
        this.f5855i.mo5152a((C1979b) new C1979b() {
            /* renamed from: a */
            public void mo5065a() {
                C1925a.this.f5849c = -1;
            }

            /* renamed from: a */
            public void mo5066a(int i, int i2) {
                if (C1925a.this.f5850d != null) {
                    C1925a.this.f5849c = i2;
                    C1925a.this.f5850d.mo5616a(2, i, i2);
                }
            }
            ...
            public void mo5067a(String str) {
                if (C1925a.this.f5850d != null) {
                    if (str.equalsIgnoreCase("cancel")) {
                        C1925a.this.f5850d.mo5616a(5, 0, 0);
                    } else if (str.equalsIgnoreCase("notRemain")) {
                        C1925a.this.f5850d.mo5616a(6, 2, 0);
                    } else if (str.equalsIgnoreCase("notFound")) {
                        C1925a.this.f5850d.mo5616a(6, 3, 0);
                    } else {
                        C1925a.this.f5850d.mo5616a(6, 0, 0);
                    }
                }
                C1925a.this.mo5062d();
                C1925a.this.f5849c = -1;
            ...
            public void mo5068b() {
                if (C1925a.this.f5850d != null) {
                    C1925a.this.f5850d.mo5616a(4, 0, 0);
                }
                C1925a.this.mo5062d();
                C1925a.this.f5849c = -1;
            }
    ...
    public void m7779g() {
        if (this.f5860n == null && this.f6947a != null) {
            ...
            if (findViewById != null) {
                this.f5860n = new C4088ba(findViewById);
            }
        }
        Activity activity = (Activity) this.f6947a;
        C2331d.m10100a((Activity) this.f6947a);
        int e = mo5063e();
        ...
        for (int i = 0; i < e; i++) {
            ...
            bVar.mo9720a((OnClickListener) new OnClickListener() {
                public void onClick(View view) {
                    ...
                    C2261g.m9771e("BrowseMenuService", String.format("index[%d], app[%s]", new Object[]{num, C1925a.this.mo5053a(num.intValue())}));
                    if (C1925a.this.f5860n != null) {
                        C1925a.this.f5860n.mo10061a((OnDismissListener) null);
                        C1925a.this.f5860n.mo10064d();
                        C1925a.this.f5860n = null;
                    }
                    C1925a.this.f5856j = (C1828g) C1925a.this.mo5064f().get(num.intValue());
                    Intent intent = new Intent(C1925a.this.f6947a, PictureJumpActivity.class);
                    if (intent != null) {
                        PictureJumpActivity.f18043b = false;
                        intent.putExtra("INTENT_CONTENTVIEWMODEL_LIST", C1925a.this.f5854h);
                        intent.putExtra("INTENT_APPINFO_ACTIVITY_NAME", C1925a.this.f5856j.mo4593a());
                        intent.putExtra("INTENT_APPINFO_ACTIVITY_TITLE", C1925a.this.f5856j.mo4594b());
                        intent.putExtra("INTENT_APPINFO_EQUIP_ADDRESS", C1925a.this.f5856j.mo4595c());
                        intent.putExtra("INTENT_FROM_SHARE", true);
                        ((Activity) C1925a.this.f6947a).startActivityForResult(intent, 3);
                    }
                }
            });
            if (this.f5860n != null) {
