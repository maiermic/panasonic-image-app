...
public class C2142a implements C2236s {
    ...
    /* renamed from: h */
    private C1693b f6634h = new C1693b();
    ...
    private class C2145a implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnSeekCompleteListener, OnVideoSizeChangedListener {
        ...
        public void onPrepared(MediaPlayer mediaPlayer) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onPrepared()", new Object[0]));
            if (C2142a.this.f6641o) {
                C2142a.this.f6641o = false;
            }
            if (C2142a.this.f6640n == 2) {
                if (C2142a.this.f6629c != null) {
                    C2142a.this.f6629c.mo5904c();
                }
                C2142a.this.f6640n = 0;
                if (C2142a.this.f6639m) {
                    C2142a.this.mo5682b();
                    return;
                }
                C2142a.this.mo5682b();
                C2142a.this.m9082c(30);
                C2142a.this.mo5683c();
                return;
            }
            int videoWidth = mediaPlayer.getVideoWidth();
            int videoHeight = mediaPlayer.getVideoHeight();
            C2261g.m9771e("PlayerServiceDLNA", String.format("onPrepared(): width = %d, height = %d", new Object[]{Integer.valueOf(videoWidth), Integer.valueOf(videoHeight)}));
            if (videoWidth == 0 || videoHeight == 0) {
                videoWidth = 640;
                videoHeight = 360;
            }
            if (C2142a.this.f6629c != null) {
                C2142a.this.f6629c.mo5900a(videoWidth, videoHeight);
            }
        }

        public void onCompletion(MediaPlayer mediaPlayer) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onCompletion()", new Object[0]));
            if (C2142a.this.f6629c != null) {
                C2142a.this.f6629c.mo5907f();
            }
        }

        public void onSeekComplete(MediaPlayer mediaPlayer) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onSeekComplete()", new Object[0]));
        }

        public void onVideoSizeChanged(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onVideoSizeChanged(): width = %d, height = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
        }

        public void onBufferingUpdate(MediaPlayer mediaPlayer, int i) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onBufferingUpdate(): percent = %d", new Object[]{Integer.valueOf(i)}));
        }

        public boolean onInfo(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onInfo(): what = %d, extra = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            return true;
        }

        public boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
            C2261g.m9771e("PlayerServiceDLNA", String.format("onError(): what = %d, extra = %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
            if (C2142a.this.f6641o) {
                C2142a.this.f6641o = false;
            }
            if (C2142a.this.f6629c != null) {
                C2142a.this.f6629c.mo5903b(i, i2);
            }
            return false;
        }
    }
    ...
    private class C2146b extends Thread {
        ...
        public void run() {
            ...
            int i = -1;
            int i2 = 0;
            while (!this.f6647b && C2142a.this.f6627a != null) {
                if (C2142a.this.f6627a.isPlaying()) {
                    int currentPosition = C2142a.this.f6627a.getCurrentPosition();
                    if (currentPosition != i || z) {
                        ...
                        if (i2 < 2) {
                            continue;
                        } else if (C2142a.this.f6629c != null) {
                            C2142a.this.f6629c.mo5907f();
                            return;
                        } else {
                            z = true;
    ...
    public boolean mo5685e() {
        ...
        new Thread(new Runnable() {
            public void run() {
                if (C2142a.this.f6627a != null) {
                    C2142a.this.f6627a.stop();
                    C2142a.this.f6627a.reset();
                }
                if (C2142a.this.f6630d != null) {
                    C2142a.this.f6630d.mo4280i();
                }
                C2142a.this.m9079b(C2142a.this.f6638l);
            }
        }).start();
        return true;
    }
                ...
                if (a.mo4308a()) {
                    if (this.f6627a != null) {
                        try {
                            ...
                            C2261g.m9769c("PlayerServiceDLNA", "setDataSource() failed.");
                            a = new C1697f(-1);
                        }
                    }
    ...
    private void m9075a(final int i, long j) {
        ...
        new Thread(new Runnable() {
            public void run() {
                do {
                    C2142a.this.m9082c((long) 1000);
                    if (C2142a.this.f6630d.mo4282k() == 1) {
                        break;
                    }
                } while (C2142a.this.f6641o);
                ...
                if (C2142a.this.f6641o) {
                    C2261g.m9763a("PlayerServiceDLNA", "SafetyLoad ==> Oh, My God !!! Dlna.DmpStop()");
                    C2142a.this.f6630d.mo4280i();
                    if (C2142a.this.f6629c != null) {
                        C2142a.this.f6629c.mo5903b(0, 0);
                        return;
                    }
                    return;
                }
                C2261g.m9763a("PlayerServiceDLNA", "SafetyLoad ==> No Problem.");
            }
        }).start();
    }
