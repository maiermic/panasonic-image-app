...
import com.panasonic.avc.cng.model.service.p070q.p071a.UdpService;
import com.panasonic.avc.cng.util.ImageAppLog;
import java.io.ByteArrayOutputStream;

/* renamed from: com.panasonic.avc.cng.model.service.q.c */
public class WTCService {

    /* renamed from: a */
    private Context f6931a;

    /* renamed from: b */
    private UdpService f6932b;

    public WTCService(Context context) {
    }

    /* renamed from: a */
    public void mo5896a(int i, String str) {
        this.f6932b = new UdpService(this.f6931a);
    ...
    public byte[] mo5898a(C2225a aVar, int i, int i2) {
        ...
        if (aVar != null) {
            try {
                ...
                ImageAppLog.error("WTCService", e.getMessage());
                e.printStackTrace();
            } catch (Exception e2) {
                if (e2.getMessage() != null) {
                    ImageAppLog.error("WTCService", e2.getMessage());
                }
                e2.printStackTrace();
            }
        }
