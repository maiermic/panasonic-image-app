...
public class WifiSimpleReceiver extends BroadcastReceiver implements C1881a {
    ...
    public WifiSimpleReceiver(Context context) {
    ...
    public void mo4869a(C1882a aVar) {
        ...
        this.f5654e.initialize(this.f5652c, this.f5652c.getMainLooper(), new ChannelListener() {
            ...
            public void onChannelDisconnected() {
                if (WifiSimpleReceiver.this.f5652c == null || WifiSimpleReceiver.this.f5654e == null || this.f5664b) {
                    ImageAppLog.error("WifiSimpleReceiver", "Channel lost permanently.");
                    return;
                }
                ImageAppLog.debug("WifiSimpleReceiver", "Channel lost. Trying again");
                this.f5664b = true;
                WifiSimpleReceiver.this.f5654e.initialize(WifiSimpleReceiver.this.f5652c, WifiSimpleReceiver.this.f5652c.getMainLooper(), this);
            }
        });
        this.f5655f = false;
        this.f5656g = false;
        ...
        ImageAppLog.error("WifiSimpleReceiver", "Start Wait For Ready...");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:45:0x0070, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.debug("WifiSimpleReceiver", "onReady");
        r4.mo4873a(r2, r1);
     */
    ...
    public boolean m7569d() {
        ...
        L_0x006d:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r3, r5)
            r4.mo4873a(r2, r1)
            goto L_0x0006
        L_0x007b:
            java.lang.Boolean r2 = r7.f5659j     // Catch:{ all -> 0x0092 }
        ...
        L_0x0099:
            ...
            goto L_0x006d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.model.p053e.WifiSimpleReceiver.m7569d():boolean");
    }
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (aVar != null) {
            ...
            if (action.equals("android.net.wifi.WIFI_STATE_CHANGED")) {
                ...
                if (wifiState == 3) {
                    ImageAppLog.debug("WifiSimpleReceiver", "WifiReceiver Wifi - Enabled");
                    synchronized (this.f5651b) {
                        this.f5657h = Boolean.TRUE;
                    }
                } else if (wifiState == 0 || wifiState == 1) {
                    ImageAppLog.error("WifiSimpleReceiver", "WifiReceiver Wifi - Disabling or Disabled");
                    synchronized (this.f5651b) {
                ...
                if (networkInfo != null) {
                    ...
                    if (state == State.CONNECTED) {
                        ImageAppLog.m9760a(2109441, str);
                    } else if (state == State.DISCONNECTED) {
                        ImageAppLog.m9760a(2109442, str);
                    }
                }
                WifiUtil lVar = new WifiUtil(context);
                WifiInfo b = lVar.mo6743b();
                if (b == null || !lVar.mo6748b(b)) {
                    ImageAppLog.error("WifiSimpleReceiver", "ConnectivityManager disconnected " + action);
                    synchronized (this.f5651b) {
                ...
                ImageAppLog.debug("WifiSimpleReceiver", "ConnectivityManager connected");
                if (!this.f5662m) {
                    ImageAppLog.error("WifiSimpleReceiver", "onRecieve 更新しない");
                    return;
                }
                ...
                if (((NetworkInfo) intent.getParcelableExtra("networkInfo")).isConnected()) {
                    ImageAppLog.debug("WifiSimpleReceiver", "WifiP2pManager Connected");
                    synchronized (this.f5651b) {
                ...
                ImageAppLog.error("WifiSimpleReceiver", "WifiP2pManager disconnected");
                synchronized (this.f5651b) {
    ...
    private void m7571e() {
        new Thread(new Runnable() {
            public void run() {
                try {
                    ImageAppLog.error("WifiSimpleReceiver", "WifiP2pManager Before TimeOut");
                    Thread.sleep(3000);
                } catch (InterruptedException e) {
                    ImageAppLog.error("WifiSimpleReceiver", "WifiP2pManager TimeOut Exception");
                }
                synchronized (WifiSimpleReceiver.this.f5651b) {
                    if (!WifiSimpleReceiver.this.f5656g) {
                        ImageAppLog.error("WifiSimpleReceiver", "WifiP2pManager TimeOut for Ready");
                        WifiSimpleReceiver.this.f5660k = Boolean.FALSE;
                        WifiSimpleReceiver.this.m7569d();
                    }
                }
                if (!WifiSimpleReceiver.this.f5655f) {
                    try {
                        ImageAppLog.error("WifiSimpleReceiver", "WifiNormalManager Before TimeOut");
                        Thread.sleep(4000);
                    } catch (InterruptedException e2) {
                        ImageAppLog.error("WifiSimpleReceiver", "WifiNormalManager TimeOut Exception");
                    }
                    synchronized (WifiSimpleReceiver.this.f5651b) {
                        if (!WifiSimpleReceiver.this.f5655f) {
                            ImageAppLog.error("WifiSimpleReceiver", "WifiNormalManager TimeOut for Ready");
                            WifiSimpleReceiver.this.f5659j = Boolean.FALSE;
                            WifiSimpleReceiver.this.m7569d();
                        }
                    }
                }
