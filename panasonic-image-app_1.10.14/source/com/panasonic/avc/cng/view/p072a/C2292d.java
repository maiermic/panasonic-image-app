...
public class C2292d implements C2030b {
    ...
    private class C2299a implements C2044a {
        ...
        public void mo5347a(int i) {
            if (C2292d.this.f7081a != null) {
                if (i == 1) {
                    C2261g.m9771e("CameraWatchUtility", "New File Comming!");
                    C2292d.this.mo6032a((Runnable) new Runnable() {
                        public void run() {
                            try {
                                C2292d.this.m9956a(1);
                                C2292d.this.f7081a.closeOptionsMenu();
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                    ...
                    C2261g.m9771e("CameraWatchUtility", "New File Uploaded!");
                    C2292d.this.mo6032a((Runnable) new Runnable() {
                        public void run() {
                            try {
                                if (C2292d.this.m9956a(2)) {
                                    C2292d.this.f7081a.closeOptionsMenu();
                                    C2292d.this.mo6047h();
                                }
                            } catch (Exception e) {
                    ...
                    C2261g.m9771e("CameraWatchUtility", "New File Continue!");
                    C2292d.this.mo6032a((Runnable) new Runnable() {
                        public void run() {
                            try {
                                C2292d.this.m9956a(5);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                    ...
                    C2261g.m9771e("CameraWatchUtility", "Error!");
                    C2292d.this.mo6032a((Runnable) new Runnable() {
                        public void run() {
                            try {
                                C2292d.this.m9956a(7);
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
    ...
    private class C2304b implements C2031c {
        ...
        public void mo5337a(final C1846e eVar) {
            if (C2292d.this.f7082b != null) {
                if (!C1846e.m7190a(eVar)) {
                    final boolean a = C2292d.this.f7082b.mo6020a(C2292d.this.f7085e);
                    if (C2292d.this.f7082b.mo6019a(C1846e.m7191b(eVar))) {
                        C2292d.this.mo6032a((Runnable) new Runnable() {
                            public void run() {
                                C2292d.this.mo6053m();
                                if (C2292d.this.f7082b != null) {
                                    C2292d.m9951a(C1846e.m7191b(eVar), C2292d.this.f7081a, C2292d.this.f7082b.mo6022d(), a);
                                }
                            }
                        });
                        return;
                ...
                C2292d.this.f7082b.mo6018a(eVar);
            }
        }
        ...
        public void mo5336a(C1699h hVar) {
            boolean z;
            boolean z2;
            C2028e a = C2253z.m9680a((Context) C2292d.this.f7081a, false);
            if (a != null) {
                C2017a k = a.mo5287k();
                if (k == null || !k.mo5292a()) {
                    z = false;
            ...
            if (z2) {
                for (int i = 0; i < hVar.mo4318b(); i++) {
                    C2261g.m9769c("Test", "notify.getProcessing(i) : " + hVar.mo4319b(i));
                    switch (hVar.mo4319b(i)) {
                        case 12:
                            C2292d.this.mo6032a((Runnable) new Runnable() {
                                public void run() {
                                    C2292d.this.m9956a(14);
                                }
                            });
                            break;
                        case 401:
                ...
                for (int i2 = 0; i2 < b; i2++) {
                    C2292d.this.m9952a(hVar.mo4319b(i2), true);
                }
                int a3 = hVar.mo4316a();
                for (int i3 = 0; i3 < a3; i3++) {
                    C2292d.this.m9952a(hVar.mo4317a(i3), false);
                }
            }
        }
    }
    ...
    public void mo6034b() {
        if (this.f7081a != null && this.f7082b != null && this.f7083c == null) {
            C2028e a = C2253z.m9680a((Context) this.f7081a, true);
    ...
    public void mo6038c() {
        if (this.f7081a != null && this.f7082b != null && this.f7083c != null) {
            C2253z.m9680a((Context) this.f7081a, true).mo5276b((C2031c) this.f7083c);
            this.f7083c = null;
        }
    }
    ...
    public void mo6039d() {
        if (this.f7081a != null && this.f7082b != null && this.f7084d == null) {
            C2043f b = C2253z.m9688b((Context) this.f7081a, true);
    ...
    public void mo6041e() {
        if (this.f7081a != null && this.f7082b != null && this.f7084d != null) {
            C2043f b = C2253z.m9688b((Context) this.f7081a, false);
            if (b != null) {
    ...
    public static void m9951a(int i, Activity activity, Bundle bundle, boolean z) {
        ...
        switch (i) {
            ...
            default:
                C2028e a = C2253z.m9680a((Context) activity, false);
                if (a == null || !a.mo5284h()) {
                    if (bundle != null) {
    ...
    public void OnConnectionChanged(boolean z) {
        mo6032a((Runnable) new Runnable() {
            public void run() {
                try {
                    if (!C2292d.this.f7092l) {
                        C2292d.this.f7081a.getWindow().addFlags(128);
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    public boolean mo6049i() {
        return this.f7088h && C2331d.m10125b(this.f7081a, this.f7086f);
    }
    ...
    public void mo6053m() {
        if (this.f7081a != null && mo6054n()) {
            if (this.f7081a instanceof C2289b) {
                ...
                C2331d.m10102a(this.f7081a, C2328a.DIALOG_ID_CAMERA_BUSY_NO_CANCEL);
            }
        }
    }
    ...
    public boolean mo6054n() {
        if (C2331d.m10125b(this.f7081a, C2328a.DIALOG_ID_CAMERA_BUSY_NO_CANCEL)) {
            return true;
        }
        return false;
    }
            ...
            case 306:
                mo6032a((Runnable) new Runnable() {
                    public void run() {
                        ...
                        if (!C2331d.m10125b(C2292d.this.f7081a, C2328a.ON_ERROR_HIGH_TEMP_REJECT_MOVIE)) {
                            C2331d.m10114a(C2292d.this.f7081a, C2328a.ON_ERROR_HIGH_TEMP_REJECT_MOVIE, (Bundle) null);
                        }
                    }
                });
                return;
            ...
            case 205:
                mo6032a((Runnable) new Runnable() {
                    public void run() {
                        ...
                        if (C2292d.this.f7090j && !C2292d.this.mo6054n()) {
                            C2292d.this.mo6029a(C2292d.this.f7091k, true);
                            C2292d.this.m9956a(10);
                        }
                    }
                });
                return;
