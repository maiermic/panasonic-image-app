...
public class NfcWrapper {
    ...
    /* renamed from: h */
    private FelicaConnection f8688h = null;
    /* access modifiers changed from: private */

    /* renamed from: i */
    public FelicaListener f8689i = null;

    /* renamed from: j */
    private CheckFelicaConnection f8690j = null;
    ...
    public NfcWrapper(Context context) {
        ...
        this.f8693m = 0;
        this.f8682b = null;
        this.f8688h = new FelicaConnection(context, this);
        this.f8689i = new FelicaListener(this);
        this.f8690j = new CheckFelicaConnection(context, this);
        ...
        this.f8691k = new BroadcastReceiver() {
            public void onReceive(Context context, Intent intent) {
                if (intent.getAction().equals("android.intent.action.BATTERY_CHANGED")) {
                    NfcWrapper.this.f8689i.mo6831a(intent.getIntExtra("status", 0));
                }
            }
        };
    ...
    public synchronized void mo6847a(boolean z) {
        ...
        synchronized (this) {
            f8678q++;
            ImageAppLog.debug("NfcWrapper", String.format("startCount=%d", new Object[]{Integer.valueOf(f8678q)}));
            m11677f();
            if (!z) {
                i = 2;
            }
    ...
    public synchronized void mo6850b() {
        ImageAppLog.debug("NfcWrapper", "タグ検出停止");
        m11677f();
    ...
    public synchronized void mo6853d() {
        f8679r++;
        ImageAppLog.debug("NfcWrapper", String.format("endCount=%d", new Object[]{Integer.valueOf(f8679r)}));
        m11677f();
        if (this.f8693m == 1 && this.f8682b != null) {
            ...
            ImageAppLog.debug("NfcWrapper", "else");
            if (this.f8689i != null) {
                ImageAppLog.debug("NfcWrapper", "mFelicaListener!=null");
            }
        }
        m11678g();
        return;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:76:?, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.debug("NfcWrapper", "transceiveReadCommand felica exception");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:78:0x01e6, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.debug("NfcWrapper", "transceiveReadCommand felica exception4");
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:80:0x01ee, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.debug("NfcWrapper", "transceiveReadCommand felica exception2");
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:86:0x0226, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.debug("NfcWrapper", "transceiveReadCommand felica exception3");
     */
    ...
    public synchronized byte[] mo6848a(int r10, int r11, int r12) {
        /*
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r1, r2)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x0092:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r0, r2)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x0180:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r2, r3)     // Catch:{ all -> 0x00d8 }
            com.felicanetworks.mfc.g r3 = r9.m11665b(r10, r11)     // Catch:{ all -> 0x00d8 }
            java.lang.String r2 = "NfcWrapper"
            java.lang.String r4 = "transceiveReadCommand felica1"
            com.panasonic.avc.cng.util.ImageAppLog.debug(r2, r4)     // Catch:{ all -> 0x00d8 }
            r2 = r0
        L_0x0198:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r0, r4)     // Catch:{ m -> 0x01c1 }
            goto L_0x0092
        L_0x01c1:
            r0 = move-exception
            java.lang.String r4 = "NfcWrapper"
            java.lang.String r5 = "transceiveReadCommand felica exception"
            com.panasonic.avc.cng.util.ImageAppLog.debug(r4, r5)     // Catch:{ all -> 0x00d8 }
        ...
        L_0x0237:
            ...
            goto L_0x007b
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.common.p074a.NfcWrapper.mo6848a(int, int, int):byte[]");
    }
    ...
    public synchronized void mo6844a(int r9, byte[] r10, int r11) {
        ...
        L_0x0169:
            ...
            goto L_0x00ef
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.common.p074a.NfcWrapper.mo6844a(int, byte[], int):void");
    }

    /* renamed from: a */
    public void mo6843a(final int i) {
        ImageAppLog.debug("NfcWrapper", "");
        m11659a("NfcWrapper#sendStatus() status=" + i);
        m11670c(false);
        if (i == 0) {
            ImageAppLog.debug("NfcWrapper", "status == STATUS_TAG_DETECTED");
            this.f8694n = Boolean.valueOf(false);
        }
        if (f8676o == null || this.f8687g == null) {
            ImageAppLog.debug("NfcWrapper", "sStatusListener or mAppContext is null!!");
            m11669c("sStatusListener or mAppContext is null!!");
            return;
        }
        ImageAppLog.debug("NfcWrapper", "sStatusListener != null && mAppContext != null");
        new Handler(this.f8687g.getMainLooper()).post(new Runnable() {
            public void run() {
                NfcWrapper.f8676o.mo5486a(i);
            }
        });
    }
