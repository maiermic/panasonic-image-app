...
import com.panasonic.avc.cng.core.p040a.C1472as;
...
public class C2810d extends C1342a {
    ...
    private class C2814a implements C2011a {
        ...
        public void mo4441a(int i, final int i2) {
            if (C2810d.this.f3707b != null) {
                C2810d.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C2810d.this.f8720r != null) {
                            C2810d.this.f8720r.mo6809a(1, i2);
                        }
                    }
                });
            }
            ...
            if (str == null || !str.equals("finish")) {
                if (C2810d.this.f3707b != null) {
                    C2810d.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (C2810d.this.f8720r != null) {
                                if (C2810d.this.f8719q) {
                                    C2810d.this.f8723u = "cancel";
                                } else {
                                    C2810d.this.f8723u = "error";
                                }
                                C2810d.this.f8722t = "";
                                C2810d.this.f8720r.mo6810a(str);
                            }
                        }
                    });
                }
            } else if (C2810d.this.f3707b != null) {
                C2810d.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C2810d.this.f8720r != null) {
                            C2810d.this.f8720r.mo6809a(C2810d.this.f8718p.size(), 100);
                        }
                    }
                });
                C2810d.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C2810d.this.f8720r != null) {
                            C2810d.this.f8723u = "finish";
                            C2810d.this.f8724v = C2810d.this.f8718p;
                            C2810d.this.f8722t = "";
                            C2810d.this.f8720r.mo6814e();
                        }
                    }
                });
            }
    ...
    public C2810d(Context context, Handler handler, C2819b bVar) {
    ...
    public void mo6859a(String str, String str2) {
        ...
        if (this.f8706d == null || !this.f8711i.equals(str) || !this.f8712j.equals(str2)) {
            ...
            this.f8706d = new Thread(new Runnable() {
                public void run() {
                    C2810d.this.f8722t = "apConnect";
                    C2810d.this.f8709g.mo6808a();
                    if (C2810d.this.m11714i() != 0) {
                        C2261g.m9763a("TouchShareViewModel", "ConnectToWiFiAp failed");
                        return;
                    }
                    try {
                        Thread.sleep(6000);
                    ...
                    if (!C2810d.this.f8707e) {
                        C2810d.this.f8722t = "deviceSearch";
                        C2810d.this.f8709g.mo6811b();
                        C2810d.this.m11717j();
                    }
                    C2261g.m9763a("TouchShareViewModel", "接続成功！");
                    while (true) {
                        if (!C2810d.this.f8707e) {
                            if (C2810d.this.f8708f) {
                                C2810d.this.f8708f = false;
                                C2810d.this.f8722t = "start";
                                C2810d.this.f8709g.mo6813d();
                                C2810d.this.m11721l();
                            } else {
                                try {
                                    Thread.sleep(1000);
    ...
    public void m11717j() {
        List k = m11719k();
        if (k.size() == 0) {
            C2261g.m9763a("TouchShareViewModel", "DeviceSeach failed");
            return;
        }
        this.f8722t = "deviceConnect";
        this.f8709g.mo6812c();
        if (C2253z.m9680a(this.f3706a, true).mo5263a((C1892f) k.get(0), true).equalsIgnoreCase("ok")) {
            m11702a((C1892f) k.get(0));
        } else {
            C2261g.m9763a("TouchShareViewModel", "IDeviceConnectService.Connect failed");
        }
    }
    ...
    public void m11721l() {
        ...
        if (a != null && new C1543y(a.f5682d).mo3409a().mo4771a()) {
            ArrayList o = m11726o();
            if (o != null && o.size() > 0) {
    ...
    private void m11704a(List<C1878d> list, List<Integer> list2, C2819b bVar) {
        ...
        if (this.f8717o != null && this.f8717o.size() != 0) {
            ...
            if (C1712b.m6919c().mo4896a() != null) {
                this.f8714l = C2253z.m9711j(this.f3706a);
                if (this.f8714l != null) {
                    this.f8714l.mo5204a();
                }
                ...
                this.f8725w = this.f8715m.mo5038c(dVar, this.f3707b, new Runnable() {
                    public void run() {
                        if (C2810d.this.f8725w == null) {
                            C2810d.this.f8725w = C2810d.this.f8715m.mo5038c(dVar, null, null);
                        }
                    }
                });
    ...
    private ArrayList<C4262x> m11726o() {
        ...
        this.f8715m = C2253z.m9695c(this.f3706a, a);
        if (this.f8715m != null) {
        ...
        if (str.equals("F-02E") || str.equals("F-04E") || str.equals("ISW13HT")) {
            if (this.f3707b != null) {
                ...
                this.f3707b.postDelayed(new Runnable() {
                    public void run() {
                        if (C2810d.this.f8705c != null) {
                            C2810d.this.f8705c.start();
                        }
                    }
                }, (long) i);
            }
