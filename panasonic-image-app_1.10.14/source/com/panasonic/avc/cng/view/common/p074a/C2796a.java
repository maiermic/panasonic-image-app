...
public class C2796a extends C2798b {
    ...
    public class C2797a extends C2799c {
        public C2797a(C2803d dVar) {
            super(dVar);
        }
        ...
        public void mo1065a() {
            ...
            C2261g.m9763a("CheckFelicaConnection", "CheckFelicaListener.finished()");
            int d = mo6837d();
            if (d != 0) {
    ...
    private static void m11626c() {
        ...
        C2261g.m9763a("CheckFelicaConnection", "-->" + m11624a(stackTraceElement) + stackTraceElement.getMethodName() + "()[" + stackTraceElement.getLineNumber() + "]");
    }
    ...
    private static void m11625a(String str) {
        ...
        C2261g.m9763a("CheckFelicaConnection", "<--" + m11624a(stackTraceElement) + stackTraceElement.getMethodName() + "()[" + stackTraceElement.getLineNumber() + "] ret=" + str);
    }

    public C2796a(Context context, C2803d dVar) {
        super(context, dVar);
    ...
    /* renamed from: a */
    public void mo6827a() {
        C2261g.m9763a("CheckFelicaConnection", "ふぇりかチェック用の切断処理");
        m11626c();
        this.f8659c.mo6838e();
        this.f8659c.mo6836c();
        super.mo6827a();
