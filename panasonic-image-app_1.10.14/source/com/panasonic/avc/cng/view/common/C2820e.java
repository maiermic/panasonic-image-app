...
import com.panasonic.avc.cng.application.RemoteWatchNfcSupportViewModel.C1400e;
...
import com.panasonic.avc.cng.view.cameraconnect.CameraConnectViewModel;
import com.panasonic.avc.cng.view.cameraconnect.CameraConnectViewModel.C2674a;
import com.panasonic.avc.cng.view.geotag.GeoTagViewModel;
...
import com.panasonic.avc.cng.view.liveview.LiveViewNoConnectionViewModel;
...
import com.panasonic.avc.cng.view.setting.MirrorlessStopmotionMovieMakingViewModel;
...
import com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel;
...
import com.panasonic.avc.cng.view.setting.StopMotionViewModel;
...
public class C2820e {
    ...
    /* renamed from: B */
    private static MirrorlessStopmotionMovieMakingViewModel f8738B = null;

    /* renamed from: C */
    private static C5435ab f8739C = null;

    /* renamed from: D */
    private static MirrorlessStopmotionSmartOperationViewModel f8740D = null;

    /* renamed from: E */
    private static CameraConnectViewModel f8741E = null;
    ...
    /* renamed from: f */
    private static LiveViewNoConnectionViewModel f8747f = null;

    /* renamed from: g */
    private static StopMotionViewModel f8748g = null;
    ...
    /* renamed from: j */
    private static ThreeBoxViewModel f8751j = null;
    ...
    /* renamed from: n */
    private static ConnectSettingViewModel f8755n = null;

    /* renamed from: o */
    private static C5511ah f8756o = null;

    /* renamed from: p */
    private static PictureJumpViewModel f8757p = null;
    ...
    /* renamed from: v */
    private static GeoTagViewModel f8763v = null;

    /* renamed from: w */
    private static TouchShareViewModel f8764w = null;
    ...
    public static class C2821a {
        ...
        /* renamed from: b */
        public NfcSupportViewModel f8769b = null;
    }
    ...
    public static class C2822b {
        ...
        /* renamed from: b */
        public RemoteWatchNfcSupportViewModel f8771b = null;
    }

    /* renamed from: a */
    public static void m11776a() {
        if (f8742a != null) {
            ImageAppLog.error("ViewModelStore", "_lumixViewVM != null");
            f8742a.mo3205a();
            f8742a = null;
        }
        if (f8743b != null) {
            ImageAppLog.error("ViewModelStore", "_lumixMirrorlessVM != null");
            f8743b.mo3205a();
            f8743b = null;
        }
        if (f8744c != null) {
            ImageAppLog.error("ViewModelStore", "_lumixMirrorlessStopMotionVM != null");
            f8744c.mo3205a();
            f8744c = null;
        }
        if (f8745d != null) {
            ImageAppLog.error("ViewModelStore", "_lumixStopMotionVM != null");
            f8745d.mo3205a();
            f8745d = null;
        }
        if (f8746e != null) {
            ImageAppLog.error("ViewModelStore", "_lumixBaseVM != null");
            f8746e.mo3205a();
            f8746e = null;
        }
        if (f8747f != null) {
            ImageAppLog.error("ViewModelStore", "_noConnectionViewVM != null");
            f8747f.mo3205a();
            f8747f = null;
        }
        if (f8748g != null) {
            ImageAppLog.error("ViewModelStore", "_smartOperationStopMotionVM != null");
            f8748g.mo3205a();
            f8748g = null;
        }
        if (f8749h != null) {
            ImageAppLog.error("ViewModelStore", "_uploadContentsVM != null");
            f8749h.mo3205a();
            f8749h = null;
        }
        if (f8750i != null) {
            ImageAppLog.error("ViewModelStore", "_picmateVM != null");
            f8750i.mo3205a();
            f8750i = null;
        }
        if (f8751j != null) {
            ImageAppLog.error("ViewModelStore", "_threeBoxVM != null");
            f8751j.mo3205a();
            f8751j = null;
        }
        if (f8752k != null) {
            ImageAppLog.error("ViewModelStore", "_contentPlayerVM != null");
            f8752k.mo3205a();
            f8752k = null;
        }
        if (f8753l != null) {
            ImageAppLog.error("ViewModelStore", "_remoteWatchConnectVM != null");
            f8753l.mo3205a();
            f8753l = null;
        }
        if (f8754m != null) {
            ImageAppLog.error("ViewModelStore", "_registServiceVM != null");
            f8754m.mo3205a();
            f8754m = null;
        }
        if (f8755n != null) {
            ImageAppLog.error("ViewModelStore", "_connectSettingVM != null");
            f8755n.mo3205a();
            f8755n = null;
        }
        if (f8756o != null) {
            ImageAppLog.error("ViewModelStore", "_registEquipmentVM != null");
            f8756o.mo3205a();
            f8756o = null;
        }
        if (f8757p != null) {
            ImageAppLog.error("ViewModelStore", "_pictureJumpVM != null");
            f8757p.mo3205a();
            f8757p = null;
        }
        if (f8758q != null) {
            ImageAppLog.error("ViewModelStore", "_cloudSyncroVM != null");
            f8758q.mo3205a();
            f8758q = null;
        }
        if (f8759r != null) {
            ImageAppLog.error("ViewModelStore", "_picmateUploadVM != null");
            f8759r.mo3205a();
            f8759r = null;
        }
        if (f8760s != null && !f8760s.isEmpty()) {
            ImageAppLog.error("ViewModelStore", "_nfcSupportVMList != empty");
        ...
        if (f8761t != null) {
            ImageAppLog.error("ViewModelStore", "_nfcFirstTouchVM != null");
            f8761t.mo3205a();
            f8761t = null;
        }
        if (f8762u != null && !f8762u.isEmpty()) {
            ImageAppLog.error("ViewModelStore", "_remoteWatchNfcSupportVMList != empty");
        ...
        if (f8763v != null) {
            ImageAppLog.error("ViewModelStore", "_geoTagVM != null");
            f8763v.mo3205a();
            f8763v = null;
        }
        if (f8764w != null) {
            ImageAppLog.error("ViewModelStore", "_touchShareVM != null");
            f8764w.mo3205a();
            f8764w = null;
        }
        if (f8765x != null) {
            ImageAppLog.error("ViewModelStore", "_setupDateTime != null");
            f8765x.mo3205a();
            f8765x = null;
        }
        if (f8766y != null) {
            ImageAppLog.error("ViewModelStore", "_setupConnectSettingVM1 != null");
            f8766y.mo3205a();
            f8766y = null;
        }
        if (f8767z != null) {
            ImageAppLog.error("ViewModelStore", "_setupConnectSettingVM2 != null");
            f8767z.mo3205a();
            f8767z = null;
        }
        if (f8737A != null) {
            ImageAppLog.error("ViewModelStore", "_setupWearbleSettingVM != null");
            f8737A.mo3205a();
            f8737A = null;
        }
        if (f8738B != null) {
            ImageAppLog.error("ViewModelStore", "_mirrorlessStopmotion != null");
            f8738B.mo3205a();
            f8738B = null;
        }
        if (f8739C != null) {
            ImageAppLog.error("ViewModelStore", "_komadoriOneContentPreviewVM != null");
            f8739C.mo3205a();
            f8739C = null;
        }
        if (f8740D != null) {
            ImageAppLog.error("ViewModelStore", "_komadoriSmartOperationVM != null");
            f8740D.mo3205a();
            f8740D = null;
        }
        if (f8741E != null) {
            ImageAppLog.error("ViewModelStore", "_cameraConnectVM != null");
            f8741E.mo3205a();
            f8741E = null;
        }
    }
    ...
    /* renamed from: a */
    public static void m11786a(LiveViewNoConnectionViewModel nVar) {
        f8747f = nVar;
    }

    /* renamed from: a */
    public static LiveViewNoConnectionViewModel m11763a(Context context, Handler handler, C3889c cVar, C2138a aVar, C2141d dVar) {
        LiveViewNoConnectionViewModel nVar = f8747f;
        if (nVar != null) {
    ...
    /* renamed from: a */
    public static void m11798a(StopMotionViewModel axVar) {
        f8748g = axVar;
    }

    /* renamed from: a */
    public static StopMotionViewModel m11770a(Context context, Handler handler, C4255e eVar, C5670c cVar) {
        StopMotionViewModel axVar = f8748g;
        if (axVar != null) {
    ...
    /* renamed from: a */
    public static void m11804a(ThreeBoxViewModel cVar) {
        f8751j = cVar;
    }

    /* renamed from: a */
    public static ThreeBoxViewModel m11775a(Context context, Handler handler, C6007b bVar) {
        ThreeBoxViewModel cVar = f8751j;
        if (cVar != null) {
    ...
    /* renamed from: a */
    public static void m11800a(ConnectSettingViewModel gVar) {
        f8755n = gVar;
    }

    /* renamed from: a */
    public static ConnectSettingViewModel m11771a(Context context, Handler handler, C5718d dVar) {
        ConnectSettingViewModel gVar = f8755n;
        if (gVar != null) {
    ...
    /* renamed from: a */
    public static void m11805a(String str, NfcSupportViewModel cVar) {
        C2821a aVar;
        if (cVar == null) {
    ...
    /* renamed from: a */
    public static NfcSupportViewModel m11754a(String str, Context context, Handler handler, C2207a aVar, C1373e eVar, byte b) {
        C2821a aVar2;
        Iterator it = f8760s.iterator();
        while (true) {
            if (!it.hasNext()) {
    ...
    /* renamed from: a */
    public static void m11806a(String str, RemoteWatchNfcSupportViewModel eVar) {
        C2822b bVar;
        if (eVar == null) {
    ...
    /* renamed from: a */
    public static RemoteWatchNfcSupportViewModel m11755a(String str, Context context, Handler handler, C2242a aVar, C1400e eVar) {
        C2822b bVar;
        Iterator it = f8762u.iterator();
        while (true) {
            if (!it.hasNext()) {
    ...
    /* renamed from: a */
    public static void m11803a(PictureJumpViewModel iVar) {
        f8757p = iVar;
    }

    /* renamed from: a */
    public static PictureJumpViewModel m11774a(Context context, Handler handler, C5973b bVar, C5973b bVar2, C1756a aVar) {
        PictureJumpViewModel iVar = f8757p;
        f8757p = null;
        if (iVar != null) {
    ...
    /* renamed from: a */
    public static void m11780a(GeoTagViewModel bVar) {
        f8763v = bVar;
    }

    /* renamed from: a */
    public static GeoTagViewModel m11758a(Context context, Handler handler, C2857b bVar) {
        GeoTagViewModel bVar2 = f8763v;
        f8763v = null;
        if (bVar2 != null) {
    ...
    /* renamed from: a */
    public static TouchShareViewModel m11757a(Context context, Handler handler, C2819b bVar) {
        TouchShareViewModel dVar = f8764w;
        f8764w = null;
        if (dVar != null) {
    ...
    /* renamed from: a */
    public static void m11779a(TouchShareViewModel dVar) {
        f8764w = dVar;
    }
    ...
    /* renamed from: a */
    public static void m11788a(MirrorlessStopmotionMovieMakingViewModel acVar) {
        f8738B = acVar;
    }

    /* renamed from: a */
    public static MirrorlessStopmotionMovieMakingViewModel m11765a(Context context, Handler handler, C5461b bVar, C5462c cVar) {
        MirrorlessStopmotionMovieMakingViewModel acVar = f8738B;
        f8738B = null;
        if (acVar != null) {
    ...
    /* renamed from: a */
    public static void m11789a(MirrorlessStopmotionSmartOperationViewModel adVar) {
        f8740D = adVar;
    }

    /* renamed from: a */
    public static MirrorlessStopmotionSmartOperationViewModel m11766a(Context context, Handler handler, C4255e eVar, C5918d dVar) {
        MirrorlessStopmotionSmartOperationViewModel adVar = f8740D;
        if (adVar != null) {
    ...
    /* renamed from: a */
    public static void m11777a(CameraConnectViewModel eVar) {
        f8741E = eVar;
    }

    /* renamed from: a */
    public static CameraConnectViewModel m11756a(Context context, Handler handler, C2674a aVar) {
        CameraConnectViewModel eVar = f8741E;
        f8741E = null;
        if (eVar != null) {
