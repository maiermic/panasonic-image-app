...
public class FelicaListener implements C0345l {
    ...
    /* renamed from: b */
    protected NfcWrapper f8671b = null;
    ...
    protected static void m11638b(String str) {
        ImageAppLog.info("FelicaListener", "  " + str);
    }

    /* renamed from: c */
    protected static void m11640c(String str) {
        ImageAppLog.error("FelicaListener", "  " + str);
    }
    ...
    public FelicaListener(NfcWrapper dVar) {
        this.f8671b = dVar;
    }
    ...
    public boolean mo6835b() {
        ...
        try {
            ...
            try {
                ...
                ImageAppLog.debug("FelicaListener", "Felica#activateFelica() succeeded. waiting...");
            } catch (C0346m e2) {
                mVar = e2;
                z = true;
                m11640c("FelicaException:" + mVar);
                ImageAppLog.debug("FelicaListener", "FelicaException:" + mVar);
                m11635a(mVar);
                if (mVar.mo1067a() == 1) {
                }
                ...
                z2 = z;
                m11643i();
                ImageAppLog.debug("FelicaListener", "activateFelica:" + String.valueOf(z2));
                return z2;
            } catch (Exception e3) {
                e = e3;
                m11640c("Exception:" + e);
    ...
    public void mo6836c() {
        m11642h();
        ImageAppLog.debug("FelicaListener", "FeliCaチップの利用終了処理");
        try {
            this.f8672h.mo911a();
    ...
    public int mo6837d() {
        ...
        L_0x0076:
            ...
            goto L_0x001f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.common.p074a.FelicaListener.mo6837d():int");
    }

    /* renamed from: e */
    public void mo6838e() {
        m11642h();
        ImageAppLog.debug("FelicaListener", "");
        try {
            ImageAppLog.debug("FelicaListener", "close呼びます");
            if (this.f8672h != null) {
                this.f8672h.mo919c();
            }
            ImageAppLog.debug("FelicaListener", "close呼びました");
        } catch (C0346m e) {
            ImageAppLog.debug("FelicaListener", "FelicaException");
            if (e.mo1068b() == 5) {
            ...
            ImageAppLog.debug("FelicaListener", "Exception");
            m11640c("Exception:" + e2);
            e2.printStackTrace();
        }
        m11643i();
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:11:0x0038, code lost:
        ...
        com.panasonic.avc.cng.util.ImageAppLog.debug("FelicaListener", "Polling has been cancelled.");
        mo6838e();
        mo6836c();
     */
    /* JADX WARNING: Code restructure failed: missing block: B:16:0x004e, code lost:
        m11636a("Launch a thread for polling FeliCa.");
        new java.lang.Thread(new com.panasonic.avc.cng.view.common.p074a.FelicaListener.C28001(r4)).start();
        m11643i();
     */
    ...
    public void mo1065a() {
        /*
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r2, r3)     // Catch:{ all -> 0x004b }
        ...
        L_0x004e:
            ...
            goto L_0x002e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.common.p074a.FelicaListener.mo1065a():void");
    }
