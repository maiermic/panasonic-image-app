...
public class C6044a extends C5424a {
    ...
    public C6044a(Context context, Handler handler) {
    ...
    public void mo13201g() {
        ...
        synchronized (this.f18413m) {
            this.f18415o = C2280s.m9929a(this.f18412l);
    ...
    public void mo13202h() {
        synchronized (this.f18413m) {
            this.f18417q = new Thread(new Runnable() {
                public void run() {
                    if (!C6044a.this.f18414n.mo4116i()) {
                        C6044a.this.f18414n.mo4106c();
                        try {
                            C6044a.this.m22440b(C6044a.this.f18418r);
                        } catch (C1651j e) {
                            e.printStackTrace();
                        } finally {
                            C6044a.this.f18417q = null;
                        }
                    }
                }
            });
    ...
    public synchronized void m22440b(String str) {
        if (this.f18419s != null) {
            C2261g.m9763a("UsagesViewModel", "upload start");
            this.f18419s.mo5928a();
        }
        int e = this.f18414n.mo4111e(str);
        C2261g.m9763a("UsagesViewModel", "sts:" + e);
        if (this.f18419s != null) {
            C2261g.m9763a("UsagesViewModel", "upload complete");
