...
public class UsagesTransparentActivity extends C1350a implements C2323a {
    ...
    /* renamed from: d */
    public UsagesViewModel f18403d = null;
    /* access modifiers changed from: private */
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.f18403d = new UsagesViewModel(this.f18400a, this.f18401b);
    ...
    public void mo13191a() {
        this.f18403d.mo13199a((C2251a) new C2251a() {
            ...
            public void mo5928a() {
                if (UsagesTransparentActivity.this.f18401b != null) {
                    UsagesTransparentActivity.this.f18401b.post(new Runnable() {
                        public void run() {
                            DialogFactory.m10114a((Activity) UsagesTransparentActivity.this, C2328a.ON_UPLOAD_LOG_WAITING, (Bundle) null);
                        }
                    });
                }
            }
            ...
            public void mo5929a(int i) {
                if (i == 200) {
                    if (UsagesTransparentActivity.this.f18401b != null) {
                        ImageAppLog.debug("UsagesTransparentActivity", "DeleteOK:" + UsagesLogUtil.m9933b(UsagesTransparentActivity.this.f18400a));
                        C1712b.m6918b(UsagesTransparentActivity.this.f18400a);
                        UsagesLogUtil.m9934c(UsagesTransparentActivity.this.f18400a);
                        UsagesTransparentActivity.this.f18401b.post(new Runnable() {
                            public void run() {
                                ...
                                DialogFactory.m10102a((Activity) UsagesTransparentActivity.this, C2328a.ON_UPLOAD_LOG_WAITING);
                    ...
                    if (UsagesTransparentActivity.this.f18401b != null) {
                        UsagesTransparentActivity.this.f18401b.post(new Runnable() {
                            public void run() {
                                DialogFactory.m10102a((Activity) UsagesTransparentActivity.this, C2328a.ON_UPLOAD_LOG_WAITING);
                                DialogFactory.m10114a((Activity) UsagesTransparentActivity.this, C2328a.ON_UPLOAD_LOG_UPLOAD_ERROR, (Bundle) null);
                            }
                        });
                    }
