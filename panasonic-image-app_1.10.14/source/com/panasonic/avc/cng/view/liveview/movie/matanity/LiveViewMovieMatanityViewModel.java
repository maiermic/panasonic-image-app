...
import com.panasonic.avc.cng.core.p040a.MatanityCommand;
...
public class LiveViewMovieMatanityViewModel extends C2291c {
    ...
    /* renamed from: N */
    public MatanityCommand f12034N;
    /* access modifiers changed from: private */
    ...
    public interface C3709a {
        ...
        /* renamed from: a */
        void mo8711a(CameraStatus eVar);
    ...
    private class C3710b implements C2177a {
        ...
        public void mo5767a(C1903f fVar) {
            if (fVar.f5759d != null) {
                LiveViewMovieMatanityViewModel.this.m14749a(fVar.f5759d);
            }
            if (!LiveViewMovieMatanityViewModel.this.f12033M.mo9168b()) {
                fVar.f5758c = null;
            }
            if (fVar.f5756a.f5803a != null) {
                LiveViewMovieMatanityViewModel.this.f12064k.mo3216a(fVar);
            }
        }

        /* renamed from: a */
        public void mo5768a(C1905h hVar) {
            LiveViewMovieMatanityViewModel.this.f12046Z = true;
        }

        /* renamed from: b */
        public void mo5769b() {
            if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                LiveViewMovieMatanityViewModel.this.f12029I.mo8708a();
            }
            LiveViewMovieMatanityViewModel.this.f12046Z = false;
        }

        /* renamed from: c */
        public void mo5770c() {
            if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                LiveViewMovieMatanityViewModel.this.f12029I.mo8712b();
            }
            LiveViewMovieMatanityViewModel.this.f12046Z = true;
        }
        ...
        public void mo5771d() {
            if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                LiveViewMovieMatanityViewModel.this.f12029I.mo8714c();
            }
            LiveViewMovieMatanityViewModel.this.f12046Z = true;
        }
        ...
        /* renamed from: e */
        public void mo5772e() {
            if (LiveViewMovieMatanityViewModel.this.f12049ac) {
                LiveViewMovieMatanityViewModel.this.f12049ac = false;
                final C1892f a = C1712b.m6919c().mo4896a();
                if (a != null) {
                    C1985b a2 = ServiceFactory.m9679a(LiveViewMovieMatanityViewModel.this.f3706a, a);
                    if (a2 != null) {
                        a2.mo5186a("setsetting", "pictmode", "anmast", new C1986a() {
                            ...
                            /* renamed from: b */
                            public void mo5202b() {
                                LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                                    public void run() {
                                        LiveViewMovieMatanityViewModel.this.m14717A();
                                        LiveViewMovieMatanityViewModel.this.m14722D();
                                    }
                                });
                            }
                            ...
                            public void mo5203c() {
                                LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                                    public void run() {
                                        Intent intent;
                                        Activity activity = (Activity) LiveViewMovieMatanityViewModel.this.f3706a;
                                        if (C1879a.m7545b(a, "1.5")) {
                                            intent = new Intent(LiveViewMovieMatanityViewModel.this.f3706a, LiveViewMoviePictureWithFullActivity.class);
                                        } else {
                                            intent = new Intent(LiveViewMovieMatanityViewModel.this.f3706a, LiveViewMoviePictureActivity.class);
                                        }
                                        activity.finish();
        ...
        public void mo5766a(int i) {
            if (i == 2 && LiveViewMovieMatanityViewModel.this.mo8735l() && !LiveViewMovieMatanityViewModel.this.f12042V && !LiveViewMovieMatanityViewModel.this.f12039S && LiveViewMovieMatanityViewModel.this.f12037Q) {
                ImageAppLog.debug("LiveViewMovieMatanityViewModel", "UDP is Time out ==> CapturingUdp ON!");
                LiveViewMovieMatanityViewModel.this.f12039S = true;
                LiveViewMovieMatanityViewModel.this.f12037Q = false;
                ServiceFactory.m9686a(LiveViewMovieMatanityViewModel.this.f12037Q);
                if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                    LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            LiveViewMovieMatanityViewModel.this.m14726F();
                            LiveViewMovieMatanityViewModel.this.m14728G();
                            LiveViewMovieMatanityViewModel.this.m14731H();
                        }
                    });
                }
            }
    ...
    private class C3716c extends Handler {
        ...
        public void m14850b() {
            this.f12113d = false;
            LiveViewMovieMatanityViewModel.this.f12076w.mo3216a("");
        }

        public synchronized void handleMessage(Message message) {
            removeMessages(0);
            if (this.f12113d) {
                LiveViewMovieMatanityViewModel.this.f12076w.mo3216a(m14849b(((System.currentTimeMillis() - this.f12112c) / 1000) + this.f12111b));
    ...
    public LiveViewMovieMatanityViewModel(Context context, Handler handler) {
        super(context, handler);
        m14789z();
        C1892f a = C1712b.m6919c().mo4896a();
        if (a != null) {
            this.f12034N = new MatanityCommand(a.f5682d);
        }
    }
    ...
    public void mo8729d(boolean z) {
        ...
        if (a != null) {
            ...
            this.f12030J = ServiceFactory.m9690b(this.f3706a, a);
    ...
    public void mo8733j() {
        if (!mo8735l() && !mo8736m() && !this.f12042V) {
            ...
            if (this.f12032L != null) {
                this.f12037Q = true;
                ServiceFactory.m9686a(this.f12037Q);
                m14728G();
                m14731H();
                m14726F();
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        synchronized (C1910l.m7679a()) {
                            a = LiveViewMovieMatanityViewModel.this.f12032L.mo3409a();
                        }
                        LiveViewMovieMatanityViewModel.this.f12042V = false;
                        if (LiveViewMovieMatanityViewModel.this.f3707b == null) {
                            ServiceFactory.m9686a(false);
                            return;
                        }
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (a.mo4771a()) {
                                    LiveViewMovieMatanityViewModel.this.f12047aa = LiveViewMovieMatanityViewModel.this.m14720C();
                                    if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                        LiveViewMovieMatanityViewModel.this.f12029I.mo8715d();
                                        return;
                                    }
                                    return;
                                }
                                ...
                                LiveViewMovieMatanityViewModel.this.m14726F();
                                if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                    LiveViewMovieMatanityViewModel.this.f12029I.mo8713b(LiveViewMovieMatanityViewModel.this.m14745a(a));
                                }
                            }
                        });
                        LiveViewMovieMatanityViewModel.this.f3707b.postDelayed(new Runnable() {
                            public void run() {
                                if (!LiveViewMovieMatanityViewModel.this.f12037Q) {
                                    LiveViewMovieMatanityViewModel.this.m14728G();
                                    LiveViewMovieMatanityViewModel.this.m14731H();
                                    LiveViewMovieMatanityViewModel.this.m14726F();
                                }
        ...
        if (this.f12034N != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        c = LiveViewMovieMatanityViewModel.this.f12034N.mo3818c();
                    }
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (!c.mo4771a()) {
                                    if (c.mo4772b().equalsIgnoreCase("err_noremain")) {
                                        if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                            LiveViewMovieMatanityViewModel.this.f12029I.mo8713b(LiveViewMovieMatanityViewModel.this.m14745a(c));
                                        }
                                    } else if (c.mo4772b().equalsIgnoreCase("err_full_data") && LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                        LiveViewMovieMatanityViewModel.this.f12029I.mo8716e();
                                    }
                                }
                            }
                        });
        ...
        if (this.f12034N != null) {
            new Thread(new Runnable() {
                public void run() {
                    final ParseTagHighlightSceneInfo a;
                    synchronized (C1910l.m7679a()) {
                        a = LiveViewMovieMatanityViewModel.this.f12034N.mo3409a();
                    }
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (a.mo4771a() && LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                    LiveViewMovieMatanityViewModel.this.f12029I.mo8717f();
                                }
                            }
                        });
                    }
        ...
        if (this.f12034N != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        b = LiveViewMovieMatanityViewModel.this.f12034N.mo3817b();
                    }
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
            ...
            a2.mo5185a((C1986a) new C1986a() {
                ...
                public void mo5203c() {
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                LiveViewMovieMatanityViewModel.this.f12071r.mo3216a("");
                                LiveViewMovieMatanityViewModel.this.f12070q.mo3216a("");
                                LiveViewMovieMatanityViewModel.this.f12073t.mo3216a("");
                                LiveViewMovieMatanityViewModel.this.f12075v.mo3216a("");
                                LiveViewMovieMatanityViewModel.this.f12046Z = true;
                            }
                        });
                    }
                    ...
                    if (LiveViewMovieMatanityViewModel.this.f3707b != null) {
                        LiveViewMovieMatanityViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                ...
                                if (a != null) {
                                    LiveViewMovieMatanityViewModel.this.f12071r.mo3216a(a.f5569c);
                                } else {
                                    LiveViewMovieMatanityViewModel.this.f12071r.mo3216a("");
                                }
                                ...
                                if (a2 != null) {
                                    LiveViewMovieMatanityViewModel.this.f12070q.mo3216a(a2.f5569c);
                                } else {
                                    LiveViewMovieMatanityViewModel.this.f12070q.mo3216a("");
                                }
                                C1860l a3 = a2.mo5182a("menu_item_id_select_video_media");
                                if (a3 != null) {
                                    LiveViewMovieMatanityViewModel.this.f12073t.mo3216a(a3.f5569c);
                                } else {
                                    LiveViewMovieMatanityViewModel.this.f12073t.mo3216a("");
                                }
                                ...
                                if (a5 != null) {
                                    LiveViewMovieMatanityViewModel.this.f12075v.mo3216a(a5.f5569c);
                                } else {
                                    LiveViewMovieMatanityViewModel.this.f12075v.mo3216a("");
                                }
                                C2028e a6 = ServiceFactory.m9680a(LiveViewMovieMatanityViewModel.this.f3706a, false);
                                if (a6 != null) {
                                    CameraStatus i = a6.mo5285i();
                                    if (i != null) {
                                        LiveViewMovieMatanityViewModel.this.m14754b(i);
                                    }
                                }
                                LiveViewMovieMatanityViewModel.this.f12046Z = true;
                            }
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public void m14754b(CameraStatus eVar) {
        int i;
        int i2 = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public int m14745a(ParseTagHighlightSceneInfo hVar) {
    ...
    public boolean mo6020a(boolean z) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                LiveViewMovieMatanityViewModel.this.mo8732i();
                LiveViewMovieMatanityViewModel.this.f12066m.mo3216a(Boolean.valueOf(false));
                LiveViewMovieMatanityViewModel.this.f12077x.mo3216a(Boolean.valueOf(false));
                LiveViewMovieMatanityViewModel.this.f12078y.mo3216a(Boolean.valueOf(false));
                LiveViewMovieMatanityViewModel.this.f12079z.mo3216a(Boolean.valueOf(false));
                LiveViewMovieMatanityViewModel.this.f12021A.mo3216a(Boolean.valueOf(false));
                LiveViewMovieMatanityViewModel.this.f12022B.mo3216a(Boolean.valueOf(true));
                LiveViewMovieMatanityViewModel.this.f12063j.mo3216a(Integer.valueOf(6));
                LiveViewMovieMatanityViewModel.this.f12059f.mo3216a(Integer.valueOf(0));
                LiveViewMovieMatanityViewModel.this.f12061h.mo3216a("");
                LiveViewMovieMatanityViewModel.this.f12076w.mo3216a("");
                LiveViewMovieMatanityViewModel.this.f12058e.mo3216a("");
                LiveViewMovieMatanityViewModel.this.m14722D();
                LiveViewMovieMatanityViewModel.this.f12035O = false;
                LiveViewMovieMatanityViewModel.this.f12036P = false;
                LiveViewMovieMatanityViewModel.this.f12037Q = false;
                LiveViewMovieMatanityViewModel.this.f12038R = false;
                LiveViewMovieMatanityViewModel.this.f12039S = false;
                LiveViewMovieMatanityViewModel.this.f12040T = false;
                LiveViewMovieMatanityViewModel.this.f12041U = false;
                LiveViewMovieMatanityViewModel.this.f12042V = false;
                LiveViewMovieMatanityViewModel.this.f12046Z = true;
            }
        });
            ...
            if (this.f12046Z) {
                ...
                if (this.f3707b != null) {
                    this.f3707b.post(new Runnable() {
                        public void run() {
                            try {
                                LiveViewMovieMatanityViewModel.this.f12063j.mo3216a(Integer.valueOf(LiveViewMovieMatanityViewModel.this.f12050ad));
                                if (LiveViewMovieMatanityViewModel.this.f12051ae < 0) {
                                    LiveViewMovieMatanityViewModel.this.f12059f.mo3216a(null);
                                    LiveViewMovieMatanityViewModel.this.f12060g.mo3216a(Boolean.valueOf(false));
                                    LiveViewMovieMatanityViewModel.this.f12061h.mo3216a(null);
                                    LiveViewMovieMatanityViewModel.this.f12062i.mo3216a(Boolean.valueOf(false));
                                } else {
                                    LiveViewMovieMatanityViewModel.this.f12059f.mo3216a(Integer.valueOf(LiveViewMovieMatanityViewModel.this.f12051ae));
                                    LiveViewMovieMatanityViewModel.this.f12060g.mo3216a(Boolean.valueOf(LiveViewMovieMatanityViewModel.this.f12057ak));
                                    LiveViewMovieMatanityViewModel.this.f12061h.mo3216a(LiveViewMovieMatanityViewModel.this.f12052af);
                                    LiveViewMovieMatanityViewModel.this.f12062i.mo3216a(Boolean.valueOf(LiveViewMovieMatanityViewModel.this.f12056aj));
                                }
                                CameraStatus i = ServiceFactory.m9680a(LiveViewMovieMatanityViewModel.this.f3706a, true).mo5285i();
                                if (i != null) {
                                    if (LiveViewMovieMatanityViewModel.this.f12055ai) {
                                        LiveViewMovieMatanityViewModel.this.m14754b(i);
                                        LiveViewMovieMatanityViewModel.this.f12055ai = false;
                                        String str = (String) LiveViewMovieMatanityViewModel.this.f12071r.mo3217b();
                                        if (str != null && str.equalsIgnoreCase("sd") && !LiveViewMovieMatanityViewModel.this.f12044X && LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                            LiveViewMovieMatanityViewModel.this.f12029I.mo8718g();
                                        }
                                    }
                                    LiveViewMovieMatanityViewModel.this.f12072s.mo3216a(Boolean.valueOf(i.mo4706n()));
                                    LiveViewMovieMatanityViewModel.this.f12074u.mo3216a(Boolean.valueOf(i.mo4706n()));
                                }
                                if (LiveViewMovieMatanityViewModel.this.f12029I != null) {
                                    try {
                                        LiveViewMovieMatanityViewModel.this.f12029I.mo8711a(i);
