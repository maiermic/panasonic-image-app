...
public class LiveViewNoConnectionViewModel extends C1342a {
    ...
    private class C3884a implements C2138a {
        ...
        public void mo5668a(boolean z) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleConnected");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5668a(z);
            }
        }

        /* renamed from: a */
        public void mo5662a(int i) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleDisconnected");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5662a(i);
            }
        }

        /* renamed from: d */
        public void mo5672d() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleConnectError");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5672d();
            }
        }

        /* renamed from: a */
        public void mo5663a(BluetoothDevice bluetoothDevice, String str, String str2, String str3) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleScanResult");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5663a(bluetoothDevice, str, str2, str3);
            }
        }

        /* renamed from: a */
        public void mo5667a(UUID uuid, int i, Bundle bundle) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleReadEnd");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5667a(uuid, i, bundle);
            }
        }

        /* renamed from: a */
        public void mo5666a(UUID uuid, int i) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleWriteEnd");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5666a(uuid, i);
            }
        }

        /* renamed from: a */
        public void mo5664a(Bundle bundle, String str) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleNotification");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5664a(bundle, str);
            }
        }

        /* renamed from: b */
        public void mo5669b() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleConnectStart");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5669b();
            }
        }

        /* renamed from: a */
        public void mo5661a() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleScanStart");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5661a();
            }
        }

        /* renamed from: c */
        public void mo5671c() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleConnectTimeOut");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5671c();
            }
        }

        /* renamed from: a */
        public void mo5665a(String str) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleCopyStatus");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5665a(str);
            }
        }

        /* renamed from: b */
        public void mo5670b(boolean z) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleNotificationEnable");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5670b(z);
            }
        }

        /* renamed from: e */
        public void mo5673e() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleServicePrepared");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5673e();
            }
        }

        /* renamed from: f */
        public void mo5674f() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onBleScanResultError");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5674f();
            }
        }

        /* renamed from: g */
        public void mo5675g() {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onAutoSendAcctrlDone");
            if (LiveViewNoConnectionViewModel.this.f12784g != null) {
                LiveViewNoConnectionViewModel.this.f12784g.mo5675g();
            }
        }
    }
    ...
    private class C3885b implements C2031c {
        ...
        public void mo5337a(CameraStatus eVar) {
            if (CameraStatus.m7190a(eVar)) {
                if (LiveViewNoConnectionViewModel.this.f3707b == null) {
                }
                return;
            }
            final int b = CameraStatus.m7191b(eVar);
            if (LiveViewNoConnectionViewModel.this.f3707b != null) {
                LiveViewNoConnectionViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        C1712b.m6919c().mo4897a(null);
                        if (LiveViewNoConnectionViewModel.this.f12780c != null) {
                            LiveViewNoConnectionViewModel.this.f12780c.mo7125a(b);
                        }
                    }
                });
            }
        ...
        public void mo5335a() {
            if (LiveViewNoConnectionViewModel.this.f3707b != null) {
                LiveViewNoConnectionViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (LiveViewNoConnectionViewModel.this.f12780c != null) {
                            LiveViewNoConnectionViewModel.this.f12780c.mo7124a();
                        }
                    }
                });
            }
        ...
        public void mo5336a(final C1699h hVar) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    if (LiveViewNoConnectionViewModel.this.f12780c != null) {
                        LiveViewNoConnectionViewModel.this.f12780c.mo7126a(hVar);
                    }
                }
            }).start();
        }
        ...
        public void mo9128b(C1699h hVar) {
            ImageAppLog.info("LiveViewNoConnectionViewModel", String.format("Warning(%d:%d), Processing(%d:%d)", new Object[]{Integer.valueOf(hVar.mo4316a()), Integer.valueOf(hVar.mo4317a(hVar.mo4316a() - 1)), Integer.valueOf(hVar.mo4318b()), Integer.valueOf(hVar.mo4319b(hVar.mo4318b() - 1))}));
            int a = hVar.mo4316a();
            if (a > 0) {
                ...
                if (!(aVar == C2328a.ON_NONE || LiveViewNoConnectionViewModel.this.f12780c == null)) {
                    LiveViewNoConnectionViewModel.this.f12780c.mo7127a(aVar);
                }
            }
            int b = hVar.mo4318b();
            if (b > 0) {
    ...
    private class C3890d implements C2141d {
        ...
        /* renamed from: a */
        public void mo5608a() {
            if (LiveViewNoConnectionViewModel.this.f12785h != null) {
                LiveViewNoConnectionViewModel.this.f12785h.mo5608a();
            }
        }

        /* renamed from: a */
        public void mo5609a(int i, C2649a aVar) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onConnected");
            if (LiveViewNoConnectionViewModel.this.f12785h != null) {
                LiveViewNoConnectionViewModel.this.f12785h.mo5609a(i, aVar);
            }
        }

        /* renamed from: a */
        public void mo5610a(int i, boolean z) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onWifiEnableStatus");
            if (LiveViewNoConnectionViewModel.this.f12785h != null) {
                LiveViewNoConnectionViewModel.this.f12785h.mo5610a(i, z);
            }
        }

        /* renamed from: a */
        public void mo5611a(boolean z, int i, boolean z2) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onSetWifiEnableResult");
            if (LiveViewNoConnectionViewModel.this.f12785h != null) {
                LiveViewNoConnectionViewModel.this.f12785h.mo5611a(z, i, z2);
            }
        }

        /* renamed from: a */
        public void mo5612a(boolean z, C1892f fVar, boolean z2, int i) {
            ImageAppLog.debug("LiveViewNoConnectionViewModel", "onFinishConnectCamera");
            if (LiveViewNoConnectionViewModel.this.f12785h != null) {
                LiveViewNoConnectionViewModel.this.f12785h.mo5612a(z, fVar, z2, i);
            }
        }
    }
    ...
    public LiveViewNoConnectionViewModel(Context context, Handler handler, C3889c cVar, C2138a aVar, C2141d dVar) {
    ...
    private void m15555h() {
        this.f12781d = ServiceFactory.m9680a(this.f3706a, true);
