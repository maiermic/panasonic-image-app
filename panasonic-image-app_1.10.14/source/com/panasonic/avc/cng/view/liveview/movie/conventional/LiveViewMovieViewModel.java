...
public class LiveViewMovieViewModel extends C2291c {
    ...
    public interface C3598a {
        ...
        /* renamed from: a */
        void mo8235a(CameraStatus eVar);
    ...
    private class C3599b implements C2177a {
        ...
        public void mo5767a(C1903f fVar) {
            if (fVar.f5759d != null) {
                LiveViewMovieViewModel.this.m14096a(fVar);
            }
            if (!LiveViewMovieViewModel.this.f11523by.mo9168b() && !LiveViewMovieViewModel.this.f11488bP && !LiveViewMovieViewModel.this.f11489bQ) {
                fVar.f5758c = null;
            }
            if (LiveViewMovieViewModel.this.f11532ch) {
                fVar.f5758c = null;
            }
            if (fVar.f5756a.f5803a != null) {
                LiveViewMovieViewModel.this.f11548k.mo3216a(fVar);
            }
        }

        /* renamed from: a */
        public void mo5768a(C1905h hVar) {
            LiveViewMovieViewModel.this.f11490bR = true;
            if (LiveViewMovieViewModel.this.f11519bu != null) {
                LiveViewMovieViewModel.this.f11519bu.mo8236a(hVar);
            }
        }
        ...
        public void mo5769b() {
            if (LiveViewMovieViewModel.this.f11519bu != null) {
                LiveViewMovieViewModel.this.f11519bu.mo8232a();
            }
            LiveViewMovieViewModel.this.f11490bR = false;
        }

        /* renamed from: c */
        public void mo5770c() {
            if (LiveViewMovieViewModel.this.f11519bu != null) {
                LiveViewMovieViewModel.this.f11519bu.mo8240b();
            }
            LiveViewMovieViewModel.this.f11490bR = true;
        }
        ...
        public void mo5771d() {
            if (LiveViewMovieViewModel.this.f11519bu != null) {
                LiveViewMovieViewModel.this.f11519bu.mo8243c();
            }
            LiveViewMovieViewModel.this.f11490bR = true;
        }
        ...
        /* renamed from: e */
        public void mo5772e() {
            LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    LiveViewMovieViewModel.this.m14086Y();
                    LiveViewMovieViewModel.this.m14082W();
                }
            });
        }
        ...
        public void mo5766a(int i) {
            if (i == 2 && LiveViewMovieViewModel.this.mo8414l() && !LiveViewMovieViewModel.this.f11482bJ && !LiveViewMovieViewModel.this.f11478bF && LiveViewMovieViewModel.this.f11476bD) {
                ImageAppLog.debug("LiveViewMovieViewModel", "UDP is Time out ==> CapturingUdp ON!");
                LiveViewMovieViewModel.this.f11478bF = true;
                LiveViewMovieViewModel.this.f11476bD = false;
                LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        LiveViewMovieViewModel.this.m14088Z();
                        LiveViewMovieViewModel.this.m14126aa();
                        LiveViewMovieViewModel.this.m14128ab();
                    }
                });
            }
            if (LiveViewMovieViewModel.this.f11519bu != null) {
                LiveViewMovieViewModel.this.f11519bu.mo8244c(i);
            }
        }
    }
    ...
    private class C3602c extends Handler {
        ...
        public void m14309b() {
            this.f11644d = false;
            LiveViewMovieViewModel.this.f11560w.mo3216a("");
        }

        public synchronized void handleMessage(Message message) {
            removeMessages(0);
            if (this.f11644d) {
                LiveViewMovieViewModel.this.f11560w.mo3216a(m14308b(((System.currentTimeMillis() - this.f11643c) / 1000) + this.f11642b));
    ...
    public LiveViewMovieViewModel(Context context, Handler handler) {
    ...
    public void mo8403c(boolean z) {
        ...
        if (a != null) {
            ...
            this.f11473bA = new ZoomCommand(a.f5682d);
            this.f11520bv = ServiceFactory.m9690b(this.f3706a, a);
    ...
    public void mo8410h() {
        ...
        if (this.f11520bv != null) {
            ...
            ImageAppLog.error("TEST", " isDeviceDisconnected : " + z);
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        synchronized (C1910l.m7679a()) {
                            a = LiveViewMovieViewModel.this.f11522bx.mo3409a();
                        }
                        LiveViewMovieViewModel.this.f11482bJ = false;
                        LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (a.mo4771a()) {
                                    LiveViewMovieViewModel.this.f11492bT = LiveViewMovieViewModel.this.m14080V();
                                    return;
                                }
                                LiveViewMovieViewModel.this.f11476bD = false;
                                LiveViewMovieViewModel.this.m14126aa();
                                ...
                                LiveViewMovieViewModel.this.m14088Z();
                                if (LiveViewMovieViewModel.this.f11519bu != null) {
                                    LiveViewMovieViewModel.this.f11519bu.mo8241b(LiveViewMovieViewModel.this.m14154b(a));
                                }
                            }
                        });
                        LiveViewMovieViewModel.this.mo3208a(new Runnable() {
                            public void run() {
                                if (!LiveViewMovieViewModel.this.f11476bD) {
                                    LiveViewMovieViewModel.this.m14126aa();
                                    LiveViewMovieViewModel.this.m14128ab();
                                    LiveViewMovieViewModel.this.m14088Z();
                                }
        ...
        if (this.f11522bx == null) {
            ...
            if (mo8413k()) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        synchronized (C1910l.m7679a()) {
                            f = LiveViewMovieViewModel.this.f11522bx.mo3501f();
                        }
                        LiveViewMovieViewModel.this.f11481bI = false;
                        LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (f.mo4771a()) {
                                    LiveViewMovieViewModel.this.f11492bT = LiveViewMovieViewModel.this.m14078U();
                                    LiveViewMovieViewModel.this.f11411Q.mo3216a(Boolean.valueOf(!LiveViewMovieViewModel.this.f11496bX));
                                }
                            }
                        });
                    }
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        e = LiveViewMovieViewModel.this.f11522bx.mo3500e();
                    }
                    LiveViewMovieViewModel.this.f11481bI = false;
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            boolean z = false;
                            if (e.mo4771a()) {
                                C1344c<Boolean> cVar = LiveViewMovieViewModel.this.f11411Q;
                                if (!LiveViewMovieViewModel.this.f11496bX) {
                                    z = true;
                                }
                                cVar.mo3216a(Boolean.valueOf(z));
                                return;
                            }
                            LiveViewMovieViewModel.this.f11474bB = false;
                            LiveViewMovieViewModel.this.m14088Z();
                            LiveViewMovieViewModel.this.m14128ab();
                            LiveViewMovieViewModel.this.m14126aa();
                            if (LiveViewMovieViewModel.this.f11519bu != null) {
                                LiveViewMovieViewModel.this.f11519bu.mo8233a(LiveViewMovieViewModel.this.m14089a(e));
                            }
                        }
                    });
                }
        ...
        if (a2 != null) {
            a2.mo5185a((C1986a) new C1986a() {
                ...
                public void mo5203c() {
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            LiveViewMovieViewModel.this.f11555r.mo3216a("");
                            LiveViewMovieViewModel.this.f11554q.mo3216a("");
                            LiveViewMovieViewModel.this.f11557t.mo3216a("");
                            LiveViewMovieViewModel.this.f11559v.mo3216a("");
                            LiveViewMovieViewModel.this.f11490bR = true;
                        }
                    });
                }
                    ...
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        ...
                        public void run() {
                            /*
                                ...
                                r1 = 1
                                r2 = 0
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f$33 r0 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.C357833.this
                                ...
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f$33 r0 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.C357833.this
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f r0 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.this
                            ...
                            L_0x003a:
                                ...
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f$33 r3 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.C357833.this
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f r3 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.this
                            ...
                            L_0x01ec:
                                ...
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f$33 r1 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.C357833.this
                                com.panasonic.avc.cng.view.liveview.movie.conventional.f r1 = com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.this
                            ...
                            L_0x02b8:
                                ...
                                goto L_0x00a8
                            */
                            throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.liveview.movie.conventional.LiveViewMovieViewModel.C357833.C35802.run():void");
                        }
                    });
                }
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public void m14157b(CameraStatus eVar) {
        int i;
        int i2 = 1;
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public int m14089a(ParseTagHighlightSceneInfo hVar) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public int m14154b(ParseTagHighlightSceneInfo hVar) {
        String b = hVar.mo4772b();
        if (b.equalsIgnoreCase("err_critical") || b.equalsIgnoreCase("err_param") || b.equalsIgnoreCase("err_system_error")) {
            return 3;
        }
        ...
        if (a != null) {
            a.mo5185a((C1986a) new C1986a() {
                ...
                public void mo5203c() {
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            LiveViewMovieViewModel.this.f11411Q.mo3216a(Boolean.valueOf(true));
                        }
                    });
                }
    ...
    public void m14088Z() {
        ...
        String d = C2266l.m9827d(ServiceFactory.m9679a(this.f3706a, a2));
                ...
                new Thread(new Runnable() {
                    public void run() {
                        synchronized (C1910l.m7679a()) {
                            ...
                            if (LiveViewMovieViewModel.this.f11519bu != null) {
                                LiveViewMovieViewModel.this.f11519bu.mo8249e(l);
                            }
                        }
                    }
                }).start();
                ...
                new Thread(new Runnable() {
                    public void run() {
                        synchronized (C1910l.m7679a()) {
                            ...
                            if (LiveViewMovieViewModel.this.f11519bu != null) {
                                LiveViewMovieViewModel.this.f11519bu.mo8247d(j);
                            }
                        }
                    }
                }).start();
    ...
    public boolean mo6020a(boolean z) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                LiveViewMovieViewModel.this.mo8410h();
                if (LiveViewMovieViewModel.this.f11519bu != null) {
                    LiveViewMovieViewModel.this.f11519bu.mo8246d();
                }
                LiveViewMovieViewModel.this.f11550m.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11561x.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11563z.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11395A.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11397C.mo3216a(Boolean.valueOf(true));
                if (LiveViewMovieViewModel.this.f3706a != null) {
                    boolean z = PreferenceManager.getDefaultSharedPreferences(LiveViewMovieViewModel.this.f3706a).getBoolean("menu_item_id_fullscr_preview", false);
                    Configuration configuration = LiveViewMovieViewModel.this.f3706a.getResources().getConfiguration();
                    if (z && configuration.orientation == 2) {
                        LiveViewMovieViewModel.this.f11500bb.mo3216a(Boolean.valueOf(false));
                        LiveViewMovieViewModel.this.f11501bc.mo3216a(Boolean.valueOf(true));
                    }
                }
                LiveViewMovieViewModel.this.f11547j.mo3216a(Integer.valueOf(6));
                LiveViewMovieViewModel.this.f11543f.mo3216a(Integer.valueOf(0));
                LiveViewMovieViewModel.this.f11545h.mo3216a("");
                LiveViewMovieViewModel.this.f11560w.mo3216a("");
                LiveViewMovieViewModel.this.f11542e.mo3216a("");
                LiveViewMovieViewModel.this.f11505bg.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11507bi.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.f11510bl.mo3216a(Boolean.valueOf(false));
                LiveViewMovieViewModel.this.m14082W();
                LiveViewMovieViewModel.this.f11474bB = false;
                LiveViewMovieViewModel.this.f11475bC = false;
                LiveViewMovieViewModel.this.f11476bD = false;
                LiveViewMovieViewModel.this.f11477bE = false;
                LiveViewMovieViewModel.this.f11478bF = false;
                LiveViewMovieViewModel.this.f11479bG = false;
                LiveViewMovieViewModel.this.f11480bH = false;
                LiveViewMovieViewModel.this.f11481bI = false;
                LiveViewMovieViewModel.this.f11482bJ = false;
                LiveViewMovieViewModel.this.f11490bR = true;
            }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        c = LiveViewMovieViewModel.this.f11524bz.mo3464c(str);
                    }
                    if (!c.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "setposition Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null && this.f3706a != null) {
            new Thread(new Runnable() {
                public void run() {
                    String d;
                    synchronized (C1910l.m7679a()) {
                        d = LiveViewMovieViewModel.this.f11524bz.mo3465d();
                    }
                    LiveViewMovieViewModel.this.f11498bZ = new ParseTagPositionInfo().mo4631a(d);
                    LiveViewMovieViewModel.this.f11526cb.clear();
                    if (LiveViewMovieViewModel.this.f11498bZ == null || LiveViewMovieViewModel.this.f11498bZ.mo4630a() == null) {
                        LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (LiveViewMovieViewModel.this.f3706a != null) {
                                    LiveViewMovieViewModel.this.f11412R.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11414T.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11416V.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11418X.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11420Z.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11448ab.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11415U.mo3216a(Boolean.valueOf(false));
                                    LiveViewMovieViewModel.this.f11417W.mo3216a(Boolean.valueOf(false));
                                    LiveViewMovieViewModel.this.f11419Y.mo3216a(Boolean.valueOf(false));
                                    LiveViewMovieViewModel.this.f11447aa.mo3216a(Boolean.valueOf(false));
                                    LiveViewMovieViewModel.this.f11449ac.mo3216a(Boolean.valueOf(false));
                                }
                            }
                        });
                    } else {
                        LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (LiveViewMovieViewModel.this.f3706a != null) {
                                    ...
                                    LiveViewMovieViewModel.this.f11420Z.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11448ab.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11415U.mo3216a(Boolean.valueOf(((String) LiveViewMovieViewModel.this.f11498bZ.mo4630a().get(0)).equalsIgnoreCase("set")));
                                    LiveViewMovieViewModel.this.f11417W.mo3216a(Boolean.valueOf(((String) LiveViewMovieViewModel.this.f11498bZ.mo4630a().get(1)).equalsIgnoreCase("set")));
                                    LiveViewMovieViewModel.this.f11419Y.mo3216a(Boolean.valueOf(((String) LiveViewMovieViewModel.this.f11498bZ.mo4630a().get(2)).equalsIgnoreCase("set")));
                                    LiveViewMovieViewModel.this.f11447aa.mo3216a(Boolean.valueOf(((String) LiveViewMovieViewModel.this.f11498bZ.mo4630a().get(3)).equalsIgnoreCase("set")));
                                    LiveViewMovieViewModel.this.f11449ac.mo3216a(Boolean.valueOf(((String) LiveViewMovieViewModel.this.f11498bZ.mo4630a().get(4)).equalsIgnoreCase("set")));
                                    if (((Boolean) LiveViewMovieViewModel.this.f11415U.mo3217b()).booleanValue()) {
                                        LiveViewMovieViewModel.this.f11526cb.add("pos1");
                                    }
                                    if (((Boolean) LiveViewMovieViewModel.this.f11417W.mo3217b()).booleanValue()) {
                                        LiveViewMovieViewModel.this.f11526cb.add("pos2");
                                    }
                                    if (((Boolean) LiveViewMovieViewModel.this.f11419Y.mo3217b()).booleanValue()) {
                                        LiveViewMovieViewModel.this.f11526cb.add("pos3");
                                    }
                                    if (((Boolean) LiveViewMovieViewModel.this.f11447aa.mo3217b()).booleanValue()) {
                                        LiveViewMovieViewModel.this.f11526cb.add("pos4");
                                    }
                                    if (((Boolean) LiveViewMovieViewModel.this.f11449ac.mo3217b()).booleanValue()) {
                                        LiveViewMovieViewModel.this.f11526cb.add("pos5");
                                    }
                                    if (LiveViewMovieViewModel.this.f11519bu != null) {
                                        LiveViewMovieViewModel.this.f11519bu.mo8248e();
                                    }
                                }
                            }
                        });
        ...
        if (this.f11524bz != null && this.f3706a != null && z) {
            new Thread(new Runnable() {
                public void run() {
                    String e;
                    synchronized (C1910l.m7679a()) {
                        e = LiveViewMovieViewModel.this.f11524bz.mo3466e();
                    }
                    LiveViewMovieViewModel.this.f11525ca = new ParseTagRoundInfo().mo4633a(e);
                    if (LiveViewMovieViewModel.this.f11525ca != null && LiveViewMovieViewModel.this.f11525ca.f5346b != null) {
                        LiveViewMovieViewModel.this.f11527cc.clear();
                        for (int i = 0; i < LiveViewMovieViewModel.this.f11525ca.f5346b.size(); i++) {
                            if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("pos1")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(1));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("pos2")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(2));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("pos3")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(3));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("pos4")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(4));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("pos5")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(5));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("home")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(0));
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i)).equalsIgnoreCase("skip")) {
                                LiveViewMovieViewModel.this.f11527cc.add(Byte.valueOf(-2));
                            }
                        }
                        LiveViewMovieViewModel.this.m14130ac();
                    }
                }
            }).start();
        }
            ...
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    ...
                    while (true) {
                        int i2 = i;
                        if (i2 < 6) {
                            if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("home")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_home).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("pos1")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos1).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("pos2")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos2).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("pos3")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos3).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("pos4")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos4).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("pos5")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_pos5).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            } else if (((String) LiveViewMovieViewModel.this.f11525ca.f5346b.get(i2)).equalsIgnoreCase("skip")) {
                                if (i2 == 0) {
                                    LiveViewMovieViewModel.this.f11422aB.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11423aC.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 1) {
                                    LiveViewMovieViewModel.this.f11424aD.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11425aE.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 2) {
                                    LiveViewMovieViewModel.this.f11426aF.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11427aG.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 3) {
                                    LiveViewMovieViewModel.this.f11428aH.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11429aI.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 4) {
                                    LiveViewMovieViewModel.this.f11430aJ.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11431aK.mo3216a(Boolean.valueOf(true));
                                } else if (i2 == 5) {
                                    LiveViewMovieViewModel.this.f11432aL.mo3216a(LiveViewMovieViewModel.this.f3706a.getText(R.string.pantilter_preset_skip).toString());
                                    LiveViewMovieViewModel.this.f11433aM.mo3216a(Boolean.valueOf(true));
                                }
                            }
                            i = i2 + 1;
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        k = LiveViewMovieViewModel.this.f11524bz.mo3472k(str);
                    }
                    if (!k.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "presetstart Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        f = LiveViewMovieViewModel.this.f11524bz.mo3467f();
                    }
                    if (!f.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "presetstop Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        g = LiveViewMovieViewModel.this.f11524bz.mo3468g();
                    }
                    if (!g.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "roundstart Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        i = LiveViewMovieViewModel.this.f11524bz.mo3470i();
                    }
                    if (!i.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "roundpause Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        h = LiveViewMovieViewModel.this.f11524bz.mo3469h();
                    }
                    if (!h.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "roundstop Error");
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        j = LiveViewMovieViewModel.this.f11524bz.mo3471j();
                    }
                    if (!j.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "delrounddata Error");
                    } else {
                        LiveViewMovieViewModel.this.mo8406e(true);
                    }
                }
            }).start();
        }
        ...
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        b = LiveViewMovieViewModel.this.f11524bz.mo3461b(ajVar.mo3518b().length);
                    }
                    if (b != null && b.mo4771a() && b.mo4771a()) {
                        LiveViewMovieViewModel.this.f11524bz.mo3459a(ajVar.mo3518b());
                    }
                }
            }).start();
        }
        ...
        if (CameraStatus.m7190a(eVar)) {
            if (this.f11490bR) {
                ...
                if (!defaultSharedPreferences.getBoolean("HighTemperature", false)) {
                    ...
                    if (C.equalsIgnoreCase("high")) {
                        ...
                        this.f3707b.post(new Runnable() {
                            public void run() {
                                LiveViewMovieViewModel.this.f11519bu.mo8238a("high");
                            }
                        });
                        ...
                        this.f3707b.post(new Runnable() {
                            public void run() {
                                LiveViewMovieViewModel.this.f11519bu.mo8238a("assert");
                            }
                        });
                    }
                }
                ...
                if (this.f11519bu != null) {
                    this.f3707b.post(new Runnable() {
                        public void run() {
                            LiveViewMovieViewModel.this.f11519bu.mo8242b(E);
                        }
                    });
                }
                ...
                mo3207a((Runnable) new Runnable() {
                    public void run() {
                        boolean z = false;
                        try {
                            LiveViewMovieViewModel.this.f11547j.mo3216a(Integer.valueOf(LiveViewMovieViewModel.this.f11534cj));
                            if (LiveViewMovieViewModel.this.f11533ci == 2) {
                                z = ((String) LiveViewMovieViewModel.this.f11555r.mo3217b()).equalsIgnoreCase("sd");
                            } else if (LiveViewMovieViewModel.this.f11533ci == 1) {
                                z = ((String) LiveViewMovieViewModel.this.f11557t.mo3217b()).equalsIgnoreCase("sd");
                            }
                            if (LiveViewMovieViewModel.this.f11535ck >= 0) {
                                LiveViewMovieViewModel.this.f11543f.mo3216a(Integer.valueOf(LiveViewMovieViewModel.this.f11535ck));
                            } else {
                                LiveViewMovieViewModel.this.f11543f.mo3216a(null);
                            }
                            LiveViewMovieViewModel.this.f11544g.mo3216a(Boolean.valueOf(LiveViewMovieViewModel.this.f11541cq));
                            if (!z || LiveViewMovieViewModel.this.f11537cm) {
                                LiveViewMovieViewModel.this.f11545h.mo3216a(LiveViewMovieViewModel.this.f11536cl);
                                LiveViewMovieViewModel.this.f11546i.mo3216a(Boolean.valueOf(LiveViewMovieViewModel.this.f11540cp));
                            } else {
                                LiveViewMovieViewModel.this.f11545h.mo3216a(null);
                                LiveViewMovieViewModel.this.f11546i.mo3216a(Boolean.valueOf(false));
                            }
                            CameraStatus i = ServiceFactory.m9680a(LiveViewMovieViewModel.this.f3706a, true).mo5285i();
                            if (i != null) {
                                if (LiveViewMovieViewModel.this.f11539co) {
                                    LiveViewMovieViewModel.this.m14157b(i);
                                    LiveViewMovieViewModel.this.f11539co = false;
                                }
                                LiveViewMovieViewModel.this.f11556s.mo3216a(Boolean.valueOf(i.mo4706n()));
                                LiveViewMovieViewModel.this.f11558u.mo3216a(Boolean.valueOf(i.mo4706n()));
                                if (!Y.equalsIgnoreCase("none")) {
                                    if (Y.equalsIgnoreCase("sd")) {
                                        LiveViewMovieViewModel.this.f11557t.mo3216a("sd");
                                    } else if (Y.equalsIgnoreCase("mem")) {
                                        LiveViewMovieViewModel.this.f11557t.mo3216a("mem");
                                    }
                                }
                            }
                            if (LiveViewMovieViewModel.this.f11519bu != null) {
                                try {
                                    LiveViewMovieViewModel.this.f11519bu.mo8235a(i);
            ...
            if (this.f11528cd == null) {
                ...
                this.f11528cd.schedule(new TimerTask() {
                    public void run() {
                        LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                LiveViewMovieViewModel.this.mo8379I();
                                LiveViewMovieViewModel.this.f11500bb.mo3216a(Boolean.valueOf(false));
                                LiveViewMovieViewModel.this.f11501bc.mo3216a(Boolean.valueOf(false));
                            }
                        });
                    }
                }, 5000);
    ...
    public void mo8381K() {
        if (this.f11524bz != null) {
            new Thread(new Runnable() {
                public void run() {
                    synchronized (C1910l.m7679a()) {
                        LiveViewMovieViewModel.this.f11524bz.mo3463c();
                    }
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                        }
            ...
            if ((((Boolean) this.f11508bj.mo3217b()).booleanValue() && str.equalsIgnoreCase("wide_slowzoom")) || (((Boolean) this.f11511bm.mo3217b()).booleanValue() && str.equalsIgnoreCase("tele_slowzoom"))) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ParseTagHighlightSceneInfo c;
                        synchronized (C1910l.m7679a()) {
                            c = LiveViewMovieViewModel.this.f11473bA.mo3654c();
                        }
                        if (!c.mo4771a()) {
                            ImageAppLog.error("LiveViewMovieViewModel", "StopSlowZoom Error");
                        }
                    }
                }).start();
                ...
                new Thread(new Runnable() {
                    public void run() {
                        synchronized (C1910l.m7679a()) {
                            if (!LiveViewMovieViewModel.this.f11473bA.mo3655c(str).mo4771a()) {
                                ImageAppLog.error("LiveViewMovieViewModel", "StartSlowZoom Error");
                            }
                        }
                    }
                }).start();
    ...
    public void mo8382L() {
        if (this.f11522bx != null) {
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    LiveViewMovieViewModel.this.f11512bn.mo3216a(Boolean.valueOf(false));
                }
            });
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        i = LiveViewMovieViewModel.this.f11522bx.mo3504i();
                    }
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            String O = i.mo4770O();
                            String charSequence = LiveViewMovieViewModel.this.f3706a.getText(R.string.remain_marking_number).toString();
                            if (i.mo4771a()) {
                                LiveViewMovieViewModel.this.f11516br.mo3216a(Integer.valueOf(-1));
                                LiveViewMovieViewModel.this.f11514bp.mo3216a(Boolean.valueOf(true));
                                LiveViewMovieViewModel.this.f11517bs.mo3216a(Boolean.valueOf(true));
                                if (O != null && !O.equalsIgnoreCase("")) {
                                    LiveViewMovieViewModel.this.f11515bq.mo3216a(String.format(charSequence, new Object[]{Integer.valueOf(O)}));
                                }
                                LiveViewMovieViewModel.this.mo8384N();
                                return;
                            }
                            ImageAppLog.error("LiveViewMovieViewModel", "Marking Error");
                            LiveViewMovieViewModel.this.f11516br.mo3216a(Integer.valueOf(-65536));
                            LiveViewMovieViewModel.this.f11514bp.mo3216a(Boolean.valueOf(true));
                            LiveViewMovieViewModel.this.f11517bs.mo3216a(Boolean.valueOf(false));
                            LiveViewMovieViewModel.this.f11515bq.mo3216a(String.format(charSequence, new Object[]{Integer.valueOf("0")}));
                            LiveViewMovieViewModel.this.mo8387Q();
                        }
                    });
                }
            }).start();
        ...
        if (this.f11473bA != null) {
            new Thread(new Runnable() {
                public void run() {
                    ParseTagHighlightSceneInfo k;
                    synchronized (C1910l.m7679a()) {
                        k = LiveViewMovieViewModel.this.f11473bA.mo3657k(str);
                    }
                    if (!k.mo4771a()) {
                        ImageAppLog.error("LiveViewMovieViewModel", "StopSlowZoom Error");
                    }
    ...
    public void mo8383M() {
        if (this.f11473bA != null) {
            new Thread(new Runnable() {
                public void run() {
                    synchronized (C1910l.m7679a()) {
                        C1870t d = LiveViewMovieViewModel.this.f11473bA.mo3656d();
                        if (d.mo4831a() && LiveViewMovieViewModel.this.f11519bu != null) {
                            LiveViewMovieViewModel.this.f11519bu.mo8245c(d.mo4833c());
                        }
                    }
                }
            }).start();
    ...
    public void mo8384N() {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                LiveViewMovieViewModel.this.f11518bt.mo3216a(Boolean.valueOf(true));
                LiveViewMovieViewModel.this.f11512bn.mo3216a(Boolean.valueOf(false));
            }
        });
        if (this.f11529ce == null) {
            ...
            this.f11529ce.schedule(new TimerTask() {
                public void run() {
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            LiveViewMovieViewModel.this.mo8385O();
                            LiveViewMovieViewModel.this.f11518bt.mo3216a(Boolean.valueOf(false));
                            LiveViewMovieViewModel.this.f11512bn.mo3216a(Boolean.valueOf(true));
                        }
                    });
                }
            }, 4000);
                ...
                public void run() {
                    LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            LiveViewMovieViewModel.this.mo3207a((Runnable) new Runnable() {
                                public void run() {
                                    if (LiveViewMovieViewModel.this.f11531cg % 2 == 0) {
                                        LiveViewMovieViewModel.this.f11518bt.mo3216a(Boolean.valueOf(true));
                                        LiveViewMovieViewModel.this.f11517bs.mo3216a(Boolean.valueOf(false));
                                        LiveViewMovieViewModel.this.f11514bp.mo3216a(Boolean.valueOf(true));
                                    } else if (LiveViewMovieViewModel.this.f11531cg % 2 == 1) {
                                        LiveViewMovieViewModel.this.f11518bt.mo3216a(Boolean.valueOf(true));
                                        LiveViewMovieViewModel.this.f11517bs.mo3216a(Boolean.valueOf(false));
                                        LiveViewMovieViewModel.this.f11514bp.mo3216a(Boolean.valueOf(false));
                                    }
                                    LiveViewMovieViewModel.this.f11531cg = LiveViewMovieViewModel.this.f11531cg + 1;
                                    if (LiveViewMovieViewModel.this.f11531cg >= 10) {
                                        LiveViewMovieViewModel.this.mo8388R();
                                        LiveViewMovieViewModel.this.f11518bt.mo3216a(Boolean.valueOf(false));
                                        LiveViewMovieViewModel.this.f11512bn.mo3216a(Boolean.valueOf(true));
                                        LiveViewMovieViewModel.this.f11531cg = 0;
                                    }
                                }
                            });
                        }
