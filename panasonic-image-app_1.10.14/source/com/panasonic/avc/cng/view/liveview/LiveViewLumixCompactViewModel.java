...
public class LiveViewLumixCompactViewModel extends C2994e {
    ...
    private abstract class C3160a implements C3115e {
        ...
        /* renamed from: a */
        public void mo7582a() {
            if (!LiveViewLumixCompactViewModel.this.f9503n.mo3409a().mo4771a()) {
                ImageAppLog.error("LiveViewLumixCompactViewModel", "MF assist position setting error.");
            }
        }
        ...
        public void mo7628g(int i, int i2) {
            if (C1879a.m7545b(C1712b.m6919c().mo4896a(), "1.2") && LiveViewLumixCompactViewModel.this.mo7417by() == 3 && !LiveViewLumixCompactViewModel.this.mo7256B()) {
                synchronized (LiveViewLumixCompactViewModel.this.f9177am) {
                    if (!LiveViewLumixCompactViewModel.this.f9189ay.equalsIgnoreCase("off") && LiveViewLumixCompactViewModel.this.f9189ay.length() > 0) {
                        LiveViewLumixCompactViewModel.this.mo7410br();
                    }
                    if (C3132i.f9745a.intValue() <= LiveViewLumixCompactViewModel.this.f9182ar.intValue() && LiveViewLumixCompactViewModel.this.f9182ar.intValue() <= C3132i.f9747c.intValue()) {
                        LiveViewLumixCompactViewModel.this.mo7443d(true, i, i2);
                    }
                }
            }
        }
    ...
    public LiveViewLumixCompactViewModel(Context context, Handler handler, C3116f fVar) {
                ...
                if (iArr != null) {
                    ...
                    if (z) {
                        mo3207a((Runnable) new Runnable() {
                            public void run() {
                                LiveViewLumixCompactViewModel.this.mo7310aD();
                            }
                        });
                    }
                }
    ...
    private void m12846b(com.panasonic.avc.cng.model.C1897j.C1903f r12) {
        ...
        L_0x02a8:
            ...
            goto L_0x00a0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.liveview.LiveViewLumixCompactViewModel.m12846b(com.panasonic.avc.cng.model.j$f):void");
    }
    ...
    public boolean mo7465m() {
        ...
        L_0x004d:
            ...
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.liveview.LiveViewLumixCompactViewModel.mo7465m():boolean");
    }
    ...
    public boolean mo7467n() {
        ...
        L_0x0041:
            ...
            goto L_0x001e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.liveview.LiveViewLumixCompactViewModel.mo7467n():boolean");
    }
    ...
    public C3115e mo7370bD() {
        return new C3160a() {
            ...
            public void mo7590b(final int i, final int i2) {
                boolean z = false;
                int by = LiveViewLumixCompactViewModel.this.mo7417by();
                if (!LiveViewLumixCompactViewModel.this.mo7263I()) {
                    if (by == 3) {
                        if (!LiveViewLumixCompactViewModel.this.mo7256B()) {
                            synchronized (LiveViewLumixCompactViewModel.this.f9177am) {
                                if (!LiveViewLumixCompactViewModel.this.f9189ay.equalsIgnoreCase("off") && LiveViewLumixCompactViewModel.this.f9189ay.length() > 0) {
                                    LiveViewLumixCompactViewModel.this.mo7410br();
                                }
                    ...
                    } else if (LiveViewLumixCompactViewModel.this.mo7418bz() != 5) {
                        z = true;
                    } else if (!LiveViewLumixCompactViewModel.this.mo7260F()) {
                        if (LiveViewLumixCompactViewModel.this.mo7262H() || LiveViewLumixCompactViewModel.this.mo7263I()) {
                            z = true;
                        } else {
                            if (!LiveViewLumixCompactViewModel.this.f9189ay.equalsIgnoreCase("off") && LiveViewLumixCompactViewModel.this.f9189ay.length() > 0) {
                                LiveViewLumixCompactViewModel.this.mo7410br();
                            ...
                            synchronized (LiveViewLumixCompactViewModel.this.f9177am) {
                                LiveViewLumixCompactViewModel.this.mo7423c(true, i, i2);
                            }
                        }
                    }
                }
                if (z) {
                    synchronized (LiveViewLumixCompactViewModel.this.f9177am) {
                        new Thread(new Runnable() {
                            public void run() {
                                if (LiveViewLumixCompactViewModel.this.f9491gu) {
                                    LiveViewLumixCompactViewModel.this.f9504o.mo3798b(i, i2);
                                } else {
                                    LiveViewLumixCompactViewModel.this.f9504o.mo3795a(i, i2);
                                }
                            }
                        }).start();
                    }
    ...
    public C3115e mo7371bE() {
        return new C3160a() {
            ...
            public void mo7583a(int i, int i2) {
                synchronized (LiveViewLumixCompactViewModel.this.f9177am) {
                    LiveViewLumixCompactViewModel.this.mo7440d(i, i2);
                }
            }
    ...
    public C3115e mo7372bF() {
        return new C3160a() {
            ...
            /* renamed from: a */
            public void mo7583a(int i, int i2) {
                if (LiveViewLumixCompactViewModel.this.f9243c.mo7094a(new Point(i, i2), C3270b.MANUAL_FOCUS)) {
                    LiveViewLumixCompactViewModel.this.mo7361b(i, i2);
                }
            }
    ...
    public C3115e mo7373bG() {
        return new C3160a() {
            ...
            /* renamed from: a */
            public void mo7583a(int i, int i2) {
                if (LiveViewLumixCompactViewModel.this.f9243c.mo7094a(new Point(i, i2), C3270b.PIN_POINT)) {
                    LiveViewLumixCompactViewModel.this.mo7420c(i, i2);
                }
            }
