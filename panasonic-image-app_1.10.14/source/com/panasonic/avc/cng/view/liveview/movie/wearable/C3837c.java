...
public class C3837c extends C2291c {
    ...
    private class C3875a extends Thread {
        ...
        /* access modifiers changed from: private */
        /* renamed from: a */
        public C1853h m15517a() {
            if (this.f12769a == null) {
                this.f12769a = new C1853h((byte[]) null);
            }
            return this.f12769a;
        }
        ...
        public void run() {
            ...
            if (a != null) {
                C2028e a2 = C2253z.m9680a(C3837c.this.f3706a, true);
    ...
    private class C3877c implements C2177a {
        ...
        public void mo5767a(C1903f fVar) {
            if (fVar.f5759d != null) {
                C3837c.this.m15382a(fVar.f5759d);
            }
            fVar.f5758c = null;
            if (!C1879a.m7545b(C1712b.m6919c().mo4896a(), "1.3")) {
                if ((C3837c.this.f12636aE && C3837c.this.mo9068r()) || (C3837c.this.f12693bj && !C3837c.this.f12694bk)) {
                    C3837c.this.f12705o.mo3216a(fVar);
                }
        ...
        public void mo5768a(C1905h hVar) {
            C3837c.this.f12642aK = true;
            if (hVar.f5785a == 3 && hVar.f5786b == -1) {
                C3837c.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (C3837c.this.f3706a == null) {
                            C2261g.m9766b("LiveViewWearableViewModel", "context is null.");
                            return;
                        }
                        Activity activity = (Activity) C3837c.this.f3706a;
                        Intent intent = null;
                        if (C3837c.this.f12643aL == 2) {
                            C2261g.m9766b("LiveViewWearableViewModel", "OnNotifyStatus:ModeChange Error return Movie");
                            intent = new Intent(C3837c.this.f3706a, LiveViewWearableVideoActivity.class);
                        } else if (C3837c.this.f12643aL == 1) {
                            C2261g.m9766b("LiveViewWearableViewModel", "OnNotifyStatus:ModeChange Error return Picture");
                            intent = new Intent(C3837c.this.f3706a, LiveViewWearablePictureActivity.class);
                        }
                        activity.finish();
        ...
        /* renamed from: b */
        public void mo5769b() {
            if (C3837c.this.f12673ap != null) {
                C3837c.this.f12673ap.mo9013a();
            }
            C3837c.this.f12642aK = false;
        }

        /* renamed from: c */
        public void mo5770c() {
            if (C3837c.this.f12673ap != null) {
                C3837c.this.f12673ap.mo9016b();
            }
            C3837c.this.f12642aK = true;
        }
        ...
        public void mo5766a(int i) {
            if (i == 2 && C3837c.this.mo9069s() && !C3837c.this.f12633aB && !C3837c.this.f12683az && C3837c.this.f12682ay) {
                C2261g.m9763a("LiveViewWearableViewModel", "UDP is Time out ==> CapturingUdp ON!");
                C3837c.this.f12683az = true;
                C3837c.this.f12682ay = false;
                ...
                C3837c.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (!C1879a.m7545b(a, "1.3") && !C1879a.m7545b(a, "1.6")) {
                            C3837c.this.m15368V();
                            C3837c.this.m15367U();
                        } else if (C3837c.this.f12643aL == 2) {
                            C3837c.this.m15375Y();
                        } else if (C3837c.this.f12643aL == 1) {
                            C3837c.this.m15372X();
                        }
    ...
    private class C3881d extends Handler {
        ...
        public void m15543b(long j) {
            ...
            if (C1879a.m7547c(C1712b.m6919c().mo4896a(), "1.2")) {
                if (C3837c.this.m15388a((String) C3837c.this.f12713w.mo3217b())) {
                    if (j2 < 2695 && j2 > j + 5) {
                        this.f12777b = j;
        ...
        public synchronized void handleMessage(Message message) {
            removeMessages(0);
            if (this.f12779d) {
                C3837c.this.f12714x.mo3216a(m15546c(((System.currentTimeMillis() - this.f12778c) / 1000) + this.f12777b));
    ...
    public C3837c(Context context, Handler handler) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        synchronized (C1910l.m7679a()) {
                            a = C3837c.this.f12676as.mo3409a();
                        }
                        C3837c.this.f12633aB = false;
                        final C1892f a2 = C1712b.m6919c().mo4896a();
                        C3837c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (!((String) C3837c.this.f12613H.mo3217b()).equalsIgnoreCase("off")) {
                                    C3837c.this.f12682ay = false;
                                }
                                if (a.mo4771a()) {
                                    ...
                                    C3837c.this.mo9036G();
                                    C3837c.this.f12644aM = C3837c.this.mo9035F();
                                    if (C3837c.this.f3706a != null) {
                                        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(C3837c.this.f3706a);
                                ...
                                C3837c.this.mo9036G();
                                if (C3837c.this.f12673ap != null) {
                                    C3837c.this.f12673ap.mo9017b(C3837c.this.m15389b(a));
                                }
                            }
                        });
                        C3837c.this.mo3208a(new Runnable() {
                            public void run() {
                                if (!C3837c.this.f12682ay) {
                                    if (!C1879a.m7545b(a2, "1.3") && !C1879a.m7545b(a2, "1.6")) {
                                        C3837c.this.m15368V();
                                        C3837c.this.m15367U();
                                    } else if (C3837c.this.f12643aL == 2) {
        ...
        if (this.f12676as == null) {
            ...
            if (mo9068r() || this.f12635aD) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        final C1853h f;
                        synchronized (C1910l.m7679a()) {
                            f = C3837c.this.f12676as.mo3501f();
                        }
                        C3837c.this.f12681ax = false;
                        C3837c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (f.mo4771a()) {
                                    C3837c.this.f12644aM = C3837c.this.mo9034E();
                                    if (C3837c.this.f3706a != null) {
                                        SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(C3837c.this.f3706a);
                                        Editor edit = defaultSharedPreferences.edit();
                                ...
                                C3837c.this.f12715y.mo3216a(Boolean.valueOf(C3837c.this.f12638aG));
                                if (C3837c.this.f12673ap != null) {
                                    C3837c.this.f12673ap.mo9014a(C3837c.this.m15378a(f));
                                }
                            }
                        });
                    }
            ...
            new Thread(new Runnable() {
                public void run() {
                    final C1853h e;
                    synchronized (C1910l.m7679a()) {
                        e = C3837c.this.f12676as.mo3500e();
                    }
                    C3837c.this.f12681ax = false;
                    final C1892f a = C1712b.m6919c().mo4896a();
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            ...
                            C3837c.this.mo9036G();
                            if (C3837c.this.f12673ap != null) {
                                C3837c.this.f12673ap.mo9014a(C3837c.this.m15378a(e));
                            }
                        }
                    });
                }
    ...
    public void mo9075y() {
        ...
        if (a != null && C1879a.m7547c(a, "1.6")) {
            C2331d.m10114a((Activity) this.f3706a, C2328a.ON_PROGRESS, (Bundle) null);
        }
    }
    ...
    public void mo9076z() {
        ...
        if (a != null && C1879a.m7547c(a, "1.6")) {
            new Timer().schedule(new TimerTask() {
                public void run() {
                    C2331d.m10100a((Activity) C3837c.this.f3706a);
                }
            }, 1000);
        }
    }
    ...
    public void mo9030A() {
        if (this.f12677at != null) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    C3837c.this.f12677at.mo3652b("standard");
                    C3837c.this.f12646aO = C3837c.this.f12677at.mo3653b();
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            C1892f a = C1712b.m6919c().mo4896a();
                            if (C1879a.m7545b(a, "1.3") || C1879a.m7545b(a, "1.6")) {
                                C3837c.this.m15363S();
                                if (C3837c.this.f12643aL == 2) {
                                    C3837c.this.f12712v.mo3216a(C3837c.this.m15393b(C3837c.this.f12647aP));
                                } else {
                                    C3837c.this.f12712v.mo3216a("");
                                }
                            } else {
                                C3837c.this.f12712v.mo3216a(C3837c.this.m15398c(C3837c.this.f12647aP));
                            }
                            C3837c.this.f12620O.mo3216a(Boolean.valueOf(C3837c.this.f12648aQ));
                            C3837c.this.mo9036G();
                            C3837c.this.mo9076z();
                        }
                    });
    ...
    public void mo9031B() {
        if (this.f12677at != null) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    C3837c.this.f12677at.mo3652b("wide");
                    C3837c.this.f12646aO = C3837c.this.f12677at.mo3653b();
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            C1892f a = C1712b.m6919c().mo4896a();
        ...
        if (this.f12676as != null) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    final C1853h g;
                    synchronized (C1910l.m7679a()) {
                        C3837c.this.f12640aI = true;
                        g = C3837c.this.f12676as.mo3502g();
                    }
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            if (g.mo4771a()) {
        ...
        if (this.f12676as != null) {
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        C3837c.this.f12640aI = true;
                        h = C3837c.this.f12676as.mo3503h();
                    }
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            if (h.mo4771a()) {
            ...
            a2.mo5185a((C1986a) new C1986a() {
                ...
                public void mo5203c() {
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            C3837c.this.f12712v.mo3216a("");
                            C3837c.this.f12713w.mo3216a("");
                            C3837c.this.f12609D.mo3216a("");
                            C3837c.this.f12610E.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12611F.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12612G.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12613H.mo3216a("off");
                            C3837c.this.f12614I.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12615J.mo3216a("off");
                            C3837c.this.f12616K.mo3216a("off");
                            C3837c.this.f12617L.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12618M.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12619N.mo3216a("off");
                            C3837c.this.f12620O.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12642aK = true;
                        }
                    });
                }
                    ...
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            ...
                            if (a == null || a.f5569c == null) {
                                C3837c.this.f12713w.mo3216a("");
                                C3837c.this.f12628W.mo3216a("");
                                C3837c.this.f12636aE = false;
                                C3837c.this.f12637aF = false;
                            } else {
                                ...
                                if (C1879a.m7545b(a3, "1.3") || C1879a.m7545b(a3, "1.6")) {
                                    if (C3837c.this.f12643aL == 2) {
                                        C3837c.this.f12713w.mo3216a("");
                                        if (a2 != null) {
                                            C3837c.this.f12712v.mo3216a(C3837c.this.m15393b(a2.f5569c));
                                        }
                                    } else {
                                        C3837c.this.f12713w.mo3216a(a.f5569c);
                                        C3837c.this.f12712v.mo3216a("");
                                    }
                                    if (!(a2 == null || a2.f5569c == null)) {
                                        C3837c.this.f12647aP = a2.f5569c;
                                    }
                                } else {
                                    C3837c.this.f12713w.mo3216a(a.f5569c);
                                    C3837c.this.f12712v.mo3216a(C3837c.this.m15398c(C3837c.this.f12647aP));
                                ...
                                C3837c.this.f12628W.mo3216a("");
                                C3837c.this.f12636aE = C3837c.this.m15388a((String) C3837c.this.f12713w.mo3217b());
                                C3837c.this.f12637aF = C3837c.this.m15408d((String) C3837c.this.f12713w.mo3217b());
                                if (C3837c.this.f12636aE) {
                                    C3837c.this.f12636aE = true;
                                    C1846e i = C2253z.m9680a(C3837c.this.f3706a, true).mo5285i();
                                    if (i != null && i.mo4705m()) {
                                        C3837c.this.f12680aw = true;
                                    }
                                    C3837c.this.m15367U();
                                }
                            }
                            ...
                            if (a9 == null || a9.f5569c == null) {
                                ...
                                C3837c.this.f12613H.mo3216a(a9.f5569c);
                                C3837c.this.f12614I.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12615J.mo3216a(a9.f5569c);
                            } else if (C3837c.this.f12643aL == 2) {
                                C3837c.this.f12613H.mo3216a(a9.f5569c);
                                C3837c.this.f12614I.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12615J.mo3216a(a9.f5569c);
                            ...
                            if (a10 == null || a10.f5569c == null) {
                                ...
                                C3837c.this.f12616K.mo3216a(a10.f5569c);
                                C3837c.this.f12617L.mo3216a(Boolean.valueOf(true));
                            } else if (C3837c.this.f12643aL == 2) {
                                C3837c.this.f12616K.mo3216a(a10.f5569c);
                                C3837c.this.f12617L.mo3216a(Boolean.valueOf(true));
                            } else {
                            ...
                            if (a11 == null || a11.f5569c == null || !a11.f5569c.equalsIgnoreCase("on")) {
                                ...
                                C3837c.this.f12618M.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12661ad.mo3216a(Boolean.valueOf(false));
                            }
                            ...
                            if (a12 == null || a12.f5569c == null || !a12.f5569c.equalsIgnoreCase("off")) {
                                ...
                                if (C3837c.this.f12643aL == 2) {
                                    ...
                                    C3837c.this.f12661ad.mo3216a(Boolean.valueOf(true));
                                }
                            }
                            ...
                            if (a13 == null || a13.f5569c == null) {
                                ...
                                C3837c.this.f12619N.mo3216a(a13.f5569c);
                            }
                            C1860l a14 = a2.mo5182a("menu_item_id_correct_cam_shake");
                            if (a14 == null || a14.f5569c == null || !a14.f5569c.equalsIgnoreCase("on")) {
                                C3837c.this.f12620O.mo3216a(Boolean.valueOf(false));
                            } else {
                                C3837c.this.f12620O.mo3216a(Boolean.valueOf(true));
                            }
                            C2028e a15 = C2253z.m9680a(C3837c.this.f3706a, false);
                            if (a15 != null) {
                                C1846e i2 = a15.mo5285i();
                                if (i2 != null && C3837c.this.f12687bd) {
                                    C3837c.this.m15399c(i2);
                                    C3837c.this.f12687bd = false;
                                }
                            }
                            C3837c.this.f12642aK = true;
                            C3837c.this.mo9036G();
    ...
    /* access modifiers changed from: private */
    /* renamed from: c */
    public void m15399c(C1846e eVar) {
        int i = 2;
        int i2 = 1;
        if (!eVar.mo4706n()) {
            this.f12639aH = false;
    ...
    /* access modifiers changed from: private */
    /* renamed from: a */
    public int m15378a(C1853h hVar) {
    ...
    /* access modifiers changed from: private */
    /* renamed from: b */
    public int m15389b(C1853h hVar) {
        String b = hVar.mo4772b();
        if (b.equalsIgnoreCase("err_critical") || b.equalsIgnoreCase("err_param") || b.equalsIgnoreCase("err_system_error")) {
            return 3;
        }
    ...
    public void m15367U() {
            ...
            if (a2 != null && !C1879a.m7545b(a2, "1.3") && !C1879a.m7545b(a2, "1.6")) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        if (C3837c.this.mo9068r() && C3837c.this.m15388a((String) C3837c.this.f12713w.mo3217b())) {
                            C1897j jVar = new C1897j();
                            jVar.getClass();
                            C3837c.this.f12705o.mo3216a(new C1903f(jVar.mo4913a(null, 0), null, null, null, null));
                            if (!C3837c.this.f12680aw && C3837c.this.f12678au) {
                                C3837c.this.f12680aw = true;
                                C3837c.this.f12678au = false;
                            }
                        }
        ...
        } else if (C1846e.m7190a(C2253z.m9680a(this.f3706a, false).mo5285i())) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        if (a != null) {
                            ...
                            if (a2 == null) {
                                a2 = C2253z.m9680a(C3837c.this.f3706a, false).mo5285i();
                            }
                            if (a2 != null) {
                                j = C3837c.this.f12645aN.m15536a(a2.mo4714v(), a2.mo4715w(), a2.mo4716x());
                            }
                        }
                        C3837c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                C3837c.this.f12645aN.m15539a(j);
                            }
                        });
                    }
                }).start();
    ...
    public void m15368V() {
        ...
        if (mo9061k()) {
            ...
            this.f3707b.postDelayed(new Runnable() {
                public void run() {
                    C3837c.this.f12716z.mo3216a(Boolean.valueOf(z2));
                }
            }, 500);
        }
        m15377Z();
    ...
    /* renamed from: b */
    public void mo9048b(C1846e eVar) {
    ...
    public void mo6018a(final C1846e eVar) {
        if (this.f12642aK) {
            ...
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    try {
                        C3837c.this.f12704n.mo3216a(Integer.valueOf(C3837c.this.f12656aY));
                        C3837c.this.f12703m.mo3216a(Integer.valueOf(C3837c.this.f12655aX));
                        if (C3837c.this.f12657aZ == -2 || !C3837c.this.f12685bb) {
                            C3837c.this.f12696f.mo3216a(null);
                            C3837c.this.f12697g.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12699i.mo3216a("");
                            C3837c.this.f12701k.mo3216a(null);
                            C3837c.this.f12702l.mo3216a(Boolean.valueOf(false));
                            C3837c.this.f12660ac.mo3216a(Integer.valueOf(0));
                            C3837c.this.f12665ah.mo3216a(null);
                            C3837c.this.f12666ai.mo3216a(Boolean.valueOf(false));
                        } else {
                            C1892f a = C1712b.m6919c().mo4896a();
                            if (!C1879a.m7545b(a, "1.3") && !C1879a.m7545b(a, "1.6")) {
                                C3837c.this.f12696f.mo3216a(Integer.valueOf(C3837c.this.f12657aZ));
                                C3837c.this.f12697g.mo3216a(Boolean.valueOf(C3837c.this.f12689bf));
                                C3837c.this.f12699i.mo3216a("sd");
                                C3837c.this.f12701k.mo3216a(C3837c.this.f12684ba);
                                C3837c.this.f12702l.mo3216a(Boolean.valueOf(C3837c.this.f12688be));
                            } else if (C3837c.this.f12643aL == 2) {
                                C3837c.this.f12665ah.mo3216a(String.valueOf(C3837c.this.f12657aZ));
                                C3837c.this.f12666ai.mo3216a(Boolean.valueOf(C3837c.this.f12689bf));
                            } else {
                                C3837c.this.f12665ah.mo3216a(C3837c.this.f12684ba);
                                C3837c.this.f12666ai.mo3216a(Boolean.valueOf(C3837c.this.f12688be));
                            }
                        }
                        C1846e i = C2253z.m9680a(C3837c.this.f3706a, false).mo5285i();
                        if (i != null) {
                            if (C3837c.this.f12687bd) {
                                C3837c.this.m15399c(i);
                                C3837c.this.f12687bd = false;
                            } else if (i.mo4706n() && i.mo4702j().equalsIgnoreCase("write_enable") && !C3837c.this.mo9068r() && !C3837c.this.mo9069s() && !C3837c.this.mo9071u() && !C3837c.this.mo9070t() && !((Boolean) C3837c.this.f12715y.mo3217b()).booleanValue() && !((Boolean) C3837c.this.f12716z.mo3217b()).booleanValue()) {
                                C3837c.this.m15399c(i);
                            }
                            C3837c.this.f12700j.mo3216a(Boolean.valueOf(i.mo4706n()));
                            C1892f a2 = C1712b.m6919c().mo4896a();
                            if (C1879a.m7545b(a2, "1.3") || C1879a.m7545b(a2, "1.6")) {
                                C3837c.this.f12664ag.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12669al.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12667aj.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12668ak.mo3216a(Integer.valueOf(-1));
                            } else if (i.mo4702j().equalsIgnoreCase("card_error") || !C3837c.this.f12685bb) {
                                C3837c.this.f12664ag.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12669al.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12670am.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12671an.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12698h.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12663af.mo3216a(Boolean.valueOf(false));
                            } else {
                                C3837c.this.f12664ag.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12669al.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12670am.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12671an.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12698h.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12663af.mo3216a(Boolean.valueOf(true));
                                C3837c.this.f12662ae.mo3216a(Integer.valueOf(-1));
                                C3837c.this.f12668ak.mo3216a(Integer.valueOf(-1));
                            }
                            C3837c.this.m15410e(eVar);
                            C3837c.this.m15370W();
                            if (i.mo4702j().equalsIgnoreCase("card_error")) {
                                C3837c.this.f12630Y.mo3216a(Boolean.valueOf(false));
                                C3837c.this.f12631Z.mo3216a(Boolean.valueOf(false));
                                C3837c.this.mo9039J();
                            }
                            if (!C3837c.this.mo9060j() || C3837c.this.f12643aL != 1) {
                                C3837c.this.f12672ao.mo3216a("");
                            } else {
                                C3837c.this.f12672ao.mo3216a(C3837c.this.f3706a.getResources().getString(R.string.rec_delay));
                            }
                            if (i.mo4666O()) {
                                C3837c.this.f12612G.mo3216a(Boolean.valueOf(true));
                            } else {
                                C3837c.this.f12612G.mo3216a(Boolean.valueOf(false));
                            }
                            if (C1879a.m7545b(a2, "1.6")) {
                                C3837c.this.f12693bj = eVar.mo4705m();
                                C3837c.this.f12694bk = eVar.mo4703k();
                                if (!C3837c.this.f12693bj && !C3837c.this.f12694bk) {
                                    C3837c.this.mo9064n();
                                    if (C3837c.this.f3706a != null) {
                                        if (((String) C3837c.this.f12628W.mo3217b()).equalsIgnoreCase(C3837c.this.f3706a.getText(R.string.msg_warning_rec_high_temperature).toString())) {
                                            C3837c.this.f12628W.mo3216a("");
                                        }
                                    }
                                } else if (C3837c.this.f12693bj && !C3837c.this.f12694bk) {
                                    C1897j jVar = new C1897j();
                                    jVar.getClass();
                                    C3837c.this.f12705o.mo3216a(new C1903f(jVar.mo4913a(null, 0), null, null, null, null));
                                    String charSequence = C3837c.this.f3706a.getText(R.string.msg_warning_rec_high_temperature).toString();
                                    if (!((String) C3837c.this.f12628W.mo3217b()).equalsIgnoreCase(charSequence)) {
                                        C3837c.this.f12628W.mo3216a(charSequence);
                                    }
                                } else if (C3837c.this.f3706a != null) {
                                    if (((String) C3837c.this.f12628W.mo3217b()).equalsIgnoreCase(C3837c.this.f3706a.getText(R.string.msg_warning_rec_high_temperature).toString())) {
                                        C3837c.this.f12628W.mo3216a("");
                                    }
                                }
    ...
    public boolean mo6020a(boolean z) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                C3837c.this.mo9065o();
                if (C3837c.this.f12673ap != null) {
                    C3837c.this.f12715y.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12716z.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12606A.mo3216a(Boolean.valueOf(true));
                    C3837c.this.f12621P.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12622Q.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12626U.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12625T.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12703m.mo3216a(Integer.valueOf(6));
                    C3837c.this.f12704n.mo3216a(Integer.valueOf(0));
                    C3837c.this.f12696f.mo3216a(null);
                    C3837c.this.f12699i.mo3216a("");
                    C3837c.this.f12701k.mo3216a("");
                    C3837c.this.f12714x.mo3216a("");
                    C3837c.this.f12695e.mo3216a("");
                    C3837c.this.f12672ao.mo3216a("");
                    C3837c.this.f12630Y.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12631Z.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12664ag.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12669al.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12667aj.mo3216a(Boolean.valueOf(false));
                    C3837c.this.f12665ah.mo3216a("");
                    C3837c.this.f12666ai.mo3216a(Boolean.valueOf(false));
                    C3837c.this.m15363S();
                }
                C3837c.this.f12678au = false;
                C3837c.this.f12679av = false;
                C3837c.this.f12682ay = false;
                C3837c.this.f12680aw = false;
                C3837c.this.f12683az = false;
                C3837c.this.f12632aA = false;
                C3837c.this.f12681ax = false;
                C3837c.this.f12633aB = false;
                C3837c.this.f12634aC = false;
                C3837c.this.f12642aK = true;
            }
        });
    ...
    /* renamed from: d */
    private String m15403d(C1846e eVar) {
        String str = "";
        if (eVar.mo4692d() < 0 || eVar.mo4694e() < 0) {
            return str;
        }
            ...
            this.f12649aR.schedule(new TimerTask() {
                public void run() {
                    C3837c.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            C3837c.this.mo9038I();
                            C3837c.this.f12629X.mo3216a(Boolean.valueOf(false));
                        }
                    });
                }
            }, 5000);
    ...
    /* access modifiers changed from: private */
    /* renamed from: e */
    public void m15410e(C1846e eVar) {
        if (mo9059i()) {
            ...
            if (a2 != null && !C1879a.m7545b(a2, "1.3") && !C1879a.m7545b(a2, "1.6")) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        if ((C3837c.this.mo9068r() && C3837c.this.m15388a((String) C3837c.this.f12713w.mo3217b())) || (C3837c.this.f12693bj && !C3837c.this.f12694bk)) {
                            C1897j jVar = new C1897j();
                            jVar.getClass();
                            C3837c.this.f12705o.mo3216a(new C1903f(jVar.mo4913a(null, 0), null, null, null, null));
                            if (!C3837c.this.f12680aw && C3837c.this.f12678au) {
                ...
                new Thread(new Runnable() {
                    public void run() {
                        ...
                        if (a != null) {
                            ...
                            if (!(a2 == null || C3837c.this.f12645aN == null)) {
                                j = C3837c.this.f12645aN.m15536a(a2.mo4714v(), a2.mo4715w(), a2.mo4716x());
                            }
                        }
                        C3837c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (C3837c.this.f12645aN != null) {
                                    C3837c.this.f12645aN.m15539a(j);
                                }
                            }
                        });
