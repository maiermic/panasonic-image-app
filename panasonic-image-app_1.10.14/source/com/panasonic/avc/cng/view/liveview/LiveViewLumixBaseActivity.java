...
public abstract class LiveViewLumixBaseActivity extends C2946c {
    ...
    protected class C2983a implements C3116f {
        ...
        public void mo7086a(int i) {
            if (i == 1) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_REMAIN_ZERO, (Bundle) null);
            } else if (i == 4) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, LiveViewLumixBaseActivity.this.mo7009h(), (Bundle) null);
            } else if (i == 5) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_BUSY_CMD_REC, (Bundle) null);
            } else if (i == 6) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_HIGH_TEMP_REJECT_MOVIE, (Bundle) null);
            } else if (i == 7) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_BACKUP_REC_SD_DIFFER, (Bundle) null);
            } else if (i == 8) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_REC_CREATE_FOLDER, (Bundle) null);
            } else if (i == 9) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_WIFI_CONNECTING_REC, (Bundle) null);
            } else if (i == 10) {
                DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_BUSY_CMD_REC, (Bundle) null);
            }
            LiveViewLumixBaseActivity.this.mo7015a(true);
        }
        ...
        public void mo7099c(int i) {
            switch (i) {
                case 2:
                    DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_DISCONNECT_BY_HIGH_TEMP_FINISH, (Bundle) null);
                    break;
                case 3:
                    DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_DISCONNECT_BATTERY_LOW_FINISH, (Bundle) null);
                    break;
                default:
                    Intent intent = new Intent(LiveViewLumixBaseActivity.this._context, LiveViewNoConnectionActivity.class);
                    intent.putExtra("ShowDisconnectMSG", true);
                    LiveViewLumixBaseActivity.this.startActivity(intent);
                    LiveViewLumixBaseActivity.this.overridePendingTransition(0, 0);
                    LiveViewLumixBaseActivity.this.finish();
                    break;
            }
            ((Activity) LiveViewLumixBaseActivity.this._context).closeOptionsMenu();
        }

        /* renamed from: a */
        public void mo7085a() {
            Intent b = C1347a.m5308b(LiveViewLumixBaseActivity.this._context, LiveViewLumixBaseActivity.this.f9045c);
            if (b != null) {
                LiveViewLumixBaseActivity.this.finish();
                LiveViewLumixBaseActivity.this.startActivity(b);
            }
        }
        ...
        public void mo7087a(int i, int i2) {
            String str = null;
            if (i2 == 2) {
                str = LiveViewLumixBaseActivity.this.getString(R.string.cmn_msg_sd_unset);
            } else if (i2 == 3) {
                str = LiveViewLumixBaseActivity.this.getString(R.string.rec_msg_sd_lock);
            }
            if (LiveViewLumixBaseActivity.this.f9043a != null) {
                LiveViewLumixBaseActivity.this.f9043a.mo7421c(str);
            }
        }
        ...
        public void mo7240a(int i, int i2, boolean z) {
            ...
            if (i == 3) {
                ...
                str = LiveViewLumixBaseActivity.this.getString(R.string.rec_msg_need_to_extend_lens);
            } else {
                str = null;
            }
            if (LiveViewLumixBaseActivity.this.f9043a != null) {
                if (LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b() != null && ((String) LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b()).equalsIgnoreCase(LiveViewLumixBaseActivity.this.getText(R.string.msg_focus_select_change_focus_mode).toString())) {
                    str = LiveViewLumixBaseActivity.this.getString(R.string.msg_focus_select_change_focus_mode);
                } else if (LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b() != null && ((String) LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b()).equalsIgnoreCase(LiveViewLumixBaseActivity.this.getText(R.string.msg_focus_select_change_pint_position).toString())) {
                    str = LiveViewLumixBaseActivity.this.getString(R.string.msg_focus_select_change_pint_position);
                } else if (LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b() != null && ((String) LiveViewLumixBaseActivity.this.f9043a.f9363eN.mo3217b()).equalsIgnoreCase(LiveViewLumixBaseActivity.this.getText(R.string.bracket_shooted_suspended_unable_recharge).toString())) {
                    str = LiveViewLumixBaseActivity.this.getString(R.string.bracket_shooted_suspended_unable_recharge);
                } else if (LiveViewLumixBaseActivity.this.f9043a.mo7427cc()) {
                    return;
                }
                if (!z) {
                    LiveViewLumixBaseActivity.this.f9043a.mo7421c(str);
        ...
        /* renamed from: b */
        public void mo7095b() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_PROGRESS, (Bundle) null);
                    }
                });
            }
        }
        ...
        public void mo7098c() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10100a((Activity) LiveViewLumixBaseActivity.this);
                    }
                });
            }
        }
        ...
        public void mo7100d() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10100a((Activity) LiveViewLumixBaseActivity.this);
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_DISCONNECT_FINISH, (Bundle) null);
                    }
                });
            }
        }
        ...
        public void mo7101e() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_SHOOT_MODE_CHANGED, (Bundle) null);
                    }
                });
            }
        }
        ...
        public void mo7102f() {
            if (LiveViewLumixBaseActivity.this.f9043a != null) {
                LiveViewLumixBaseActivity.this.f9043a.mo7442d(false);
            }
        }
        ...
        public void mo7089a(final C2328a aVar) {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, aVar, (Bundle) null);
                    }
                });
            }
        }
        ...
        public void mo7088a(C1699h hVar) {
            LiveViewLumixBaseActivity.this.DmsBase_OnNotifySubscribe(hVar);
        }

        /* renamed from: a */
        public void mo7092a(boolean z, boolean z2) {
            if (LiveViewLumixBaseActivity.this.f9043a != null && LiveViewLumixBaseActivity.this.f9048f != null && z) {
                LiveViewLumixBaseActivity.this.f9048f.mo9143a(LiveViewLumixBaseActivity.this, LiveViewLumixBaseActivity.this.mo7007f(), LiveViewLumixBaseActivity.this.f9046d, LiveViewLumixBaseActivity.this.f9043a);
            }
        }

        /* renamed from: a */
        public void mo7090a(Boolean bool, Boolean bool2, Boolean bool3) {
            if (LiveViewLumixBaseActivity.this.f9048f != null) {
                LiveViewLumixBaseActivity.this.f9048f.mo9144a((Activity) LiveViewLumixBaseActivity.this, bool, LiveViewLumixBaseActivity.this.f9046d);
            }
        }
        ...
        public void mo7091a(String str) {
            Intent intent;
            if (("manual".equalsIgnoreCase(str) || "auto".equalsIgnoreCase(str) || "pause".equalsIgnoreCase(str)) && !LiveViewLumixBaseActivity.this.f9059s) {
                if (((Activity) LiveViewLumixBaseActivity.this._context).getLocalClassName().equalsIgnoreCase("com.panasonic.avc.cng.view.liveview.LiveViewLumixGHFullscreenActivity")) {
                    LiveViewLumixBaseActivity.this.f9052j = true;
                }
                if (!LiveViewLumixBaseActivity.this.f9052j) {
                    LiveViewLumixBaseActivity.this.f9052j = true;
                    LiveViewLumixBaseActivity.this.f9043a.mo7476s();
                    if (C1879a.m7547c(C1712b.m6919c().mo4896a(), "1.1")) {
                        intent = new Intent(LiveViewLumixBaseActivity.this._context, LiveViewStopmotionActivity.class);
                    } else {
                        intent = new Intent(LiveViewLumixBaseActivity.this._context, LiveViewMirrorlessStopmotionActivity.class);
                    }
                    intent.putExtra("StopMotionObjectIDKey", "0");
                    LiveViewLumixBaseActivity.this.startActivityForResult(intent, 7);
                    return;
                }
                return;
            }
            LiveViewLumixBaseActivity.this.f9052j = false;
        }
        ...
        /* renamed from: g */
        public void mo7103g() {
            if (LiveViewLumixBaseActivity.this.f9060t != null) {
                LiveViewLumixBaseActivity.this.f9060t.cancel();
                LiveViewLumixBaseActivity.this.f9060t = null;
            }
            LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                public void run() {
                    LiveViewLumixBaseActivity.this.f9043a.mo7421c(LiveViewLumixBaseActivity.this.getText(R.string.rec_msg_only_sdi_rec).toString());
                }
            });
            LiveViewLumixBaseActivity.this.f9060t = new Timer(true);
            LiveViewLumixBaseActivity.this.f9060t.schedule(new TimerTask() {
                public void run() {
                    LiveViewLumixBaseActivity.this.f9060t.cancel();
                    LiveViewLumixBaseActivity.this.f9060t = null;
                    LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                        public void run() {
                            LiveViewLumixBaseActivity.this.f9043a.mo7421c((String) null);
                        }
                    });
                }
            }, 3000);
        ...
        public void mo7093a(int[] iArr) {
            if (C1879a.m7548d(C1712b.m6919c().mo4896a())) {
                ImageAppLog.info("LiveViewLumixBaseActivity", "" + iArr[9]);
                boolean z = 69 <= iArr[9] && iArr[9] <= 72;
                LiveViewLumixBaseActivity.this.ShowCameraControlBusyDialog(z, z);
            }
        }
        ...
        public void mo7241h() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_PHOTO_MARKING_MAX, (Bundle) null);
                    }
                });
            }
        }
        ...
        public void mo7242i() {
            boolean z;
            if (LiveViewLumixBaseActivity.this.f9043a != null) {
                C1985b a = ServiceFactory.m9679a(LiveViewLumixBaseActivity.this._context, C1712b.m6919c().mo4896a());
                if (a != null) {
                    z = a.mo5200l();
                } else {
                    z = false;
                }
                if (z && !LiveViewLumixBaseActivity.this.f9043a.mo7430cf().equalsIgnoreCase("off") && !LiveViewLumixBaseActivity.this.f9043a.mo7323aQ()) {
                    LiveViewLumixBaseActivity.this.f9043a.mo7450g("current");
                }
                if (a != null) {
                    a.mo5188a(false);
                }
        ...
        public void mo7243j() {
            if (LiveViewLumixBaseActivity.this._handler != null) {
                LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                    public void run() {
                        DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_ERROR_FOCUS, (Bundle) null);
                    }
                });
            }
        }
        ...
        /* renamed from: k */
        public void mo7244k() {
            if (LiveViewLumixBaseActivity.this.f9043a != null && LiveViewLumixBaseActivity.this.f9054l) {
                LiveViewLumixBaseActivity.this.f9043a.mo7454h("start");
                LiveViewLumixBaseActivity.this.f9054l = false;
            }
        }
    }
    ...
    /* access modifiers changed from: protected */
    /* renamed from: a */
    public abstract C2994e mo7004a(LiveViewLumixBaseActivity dVar, Handler handler, C2983a aVar);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (!this.f9053k) {
            ...
            this.f9045c = new C1349a() {
                /* renamed from: a */
                public void mo3228a() {
                    DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_NEED_LUMIX_LINK, (Bundle) null);
                }
            };
        ...
        if (C2266l.m9818b()) {
            ...
            if (i != R.string.setup_jump_rec_off) {
                ...
                this.f9062v.mo5985a((C2278a) new C2278a() {
                    /* renamed from: a */
                    public void mo5988a() {
                        if (LiveViewLumixBaseActivity.this.f9043a != null && !LiveViewLumixBaseActivity.this.f9043a.mo7311aE() && !LiveViewLumixBaseActivity.this.f9043a.mo7317aK() && !LiveViewLumixBaseActivity.this.f9043a.mo7437cm()) {
                            int i = PreferenceManager.getDefaultSharedPreferences(LiveViewLumixBaseActivity.this._context).getInt("menu_item_id_jump_rec_string", R.string.setup_jump_rec_off);
                            if (((Boolean) LiveViewLumixBaseActivity.this.f9043a.f9214bX.mo3217b()).booleanValue() && i != R.string.setup_jump_rec_off) {
                                if (LiveViewLumixBaseActivity.this.f9043a.mo7335ac()) {
                                    LiveViewLumixBaseActivity.this.f9043a.mo7366b(false, 0, 0);
                                    LiveViewLumixBaseActivity.this.f9043a.mo7448f(false);
                                    return;
                                }
                                LiveViewLumixBaseActivity.this.f9043a.mo7484w();
                            }
                        }
                    }
                });
    ...
    public void mo6889b() {
                ...
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        switch (motionEvent.getAction() & 255) {
                            case 0:
                                LiveViewLumixBaseActivity.this.f9043a.mo7345am();
                                break;
                            case 1:
                            case 3:
                                LiveViewLumixBaseActivity.this.f9043a.mo7346an();
                                break;
                        }
                    }
                    return false;
            ...
            imageButton2.setOnTouchListener(new OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        switch (motionEvent.getAction() & 255) {
                            case 0:
                                LiveViewLumixBaseActivity.this.f9043a.mo7344al();
                                break;
                            case 1:
                            case 3:
                                LiveViewLumixBaseActivity.this.f9043a.mo7346an();
        ...
        if (imageButton3 != null) {
            imageButton3.setOnTouchListener(new OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        LiveViewLumixBaseActivity.this.f9043a.mo7360b(motionEvent.getAction() & 255);
                        switch (motionEvent.getAction() & 255) {
                            case 0:
                                C1892f a = C1712b.m6919c().mo4896a();
                                if (a == null || a.f5688j != 65540) {
                                    LiveViewLumixBaseActivity.this.f9043a.mo7425ca();
                                } else if (!LiveViewLumixBaseActivity.this.f9043a.mo7315aI()) {
                                    LiveViewLumixBaseActivity.this.f9043a.mo7392bZ();
                                }
                                LiveViewLumixBaseActivity.this.f9043a.mo7348ap();
                                break;
                            case 1:
                            case 3:
                                LiveViewLumixBaseActivity.this.f9043a.mo7351as();
                                break;
                        }
                    }
                    return false;
            ...
            imageButton3.setOnLongClickListener(new OnLongClickListener() {
                public boolean onLongClick(View view) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        LiveViewLumixBaseActivity.this.f9043a.mo7347ao();
                    }
                    return false;
                }
            });
        ...
        if (imageButton4 != null) {
                    ...
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        ...
                        switch (motionEvent.getAction() & 255) {
                            case 0:
                                ...
                                LiveViewLumixBaseActivity.this.f9043a.mo7350ar();
                                break;
                            case 1:
                            case 3:
                                LiveViewLumixBaseActivity.this.f9043a.mo7351as();
            ...
            imageButton4.setOnLongClickListener(new OnLongClickListener() {
                public boolean onLongClick(View view) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        LiveViewLumixBaseActivity.this.f9043a.mo7349aq();
                    }
                    return false;
                }
            });
    ...
    public void onClickOffButton(View view) {
        if (view != null && view.getId() == R.id.SlideMenuControlView_btn_3) {
            ImageAppLog.m9760a(3158034, "");
        } else if (view != null && view.getId() == R.id.TouchCancelButton) {
            ImageAppLog.m9760a(3158038, "");
        }
        if (this.f9043a != null) {
            this.f9043a.mo7486x();
        }
        ...
        if (twoStateImageButton != null) {
            ...
            twoStateImageButton.setOnTouchListener(new OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    switch (motionEvent.getAction() & 255) {
                        case 1:
                            if (LiveViewLumixBaseActivity.this.f9043a != null && LiveViewLumixBaseActivity.this.mo7019s()) {
                                LiveViewLumixBaseActivity.this.f9043a.mo7308aB();
                                break;
                            }
                    }
                    return false;
    ...
    public void mo7181m() {
        ...
        if (imageButton != null) {
            imageButton.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null && LiveViewLumixBaseActivity.this.mo7019s()) {
                        LiveViewLumixBaseActivity.this.onClickAeOffButton(view);
                    }
                }
            });
        }
        ...
        if (twoStateImageButton != null) {
            ...
            twoStateImageButton.setOnClickListener(new OnClickListener() {
                public void onClick(View view) {
                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                        LiveViewLumixBaseActivity.this.onClickTouchAeButton(null);
                    }
                }
            });
        }
        ...
        if (imageButton2 != null) {
            imageButton2.setOnTouchListener(new OnTouchListener() {
                public boolean onTouch(View view, MotionEvent motionEvent) {
                    ...
                    switch (motionEvent.getAction() & 255) {
                        case 1:
                            if (!(LiveViewLumixBaseActivity.this.f9043a == null || LiveViewLumixBaseActivity.this.f9043a.f9291cv == null || LiveViewLumixBaseActivity.this.f9043a.f9293cx == null || LiveViewLumixBaseActivity.this.f9043a.f9294cy == null)) {
                                LiveViewLumixBaseActivity.this.f9043a.f9291cv.mo3216a(Boolean.FALSE);
                                LiveViewLumixBaseActivity.this.f9043a.f9293cx.mo3216a(Boolean.FALSE);
                                LiveViewLumixBaseActivity.this.f9043a.f9294cy.mo3216a(Boolean.FALSE);
                                viewGroup.setPadding(0, 0, 0, 0);
                                if (LiveViewLumixBaseActivity.this.getResources().getConfiguration().orientation == 2) {
                                ...
                                translateAnimation.setAnimationListener(new AnimationListener() {
                                    ...
                                    public void onAnimationEnd(Animation animation) {
                                        LiveViewLumixBaseActivity.this.f9043a.f9291cv.mo3216a(Boolean.TRUE);
                                        LiveViewLumixBaseActivity.this.f9043a.mo7367bA();
                                    }
                                });
                                ...
                                LiveViewLumixBaseActivity.this.f9043a.f9290cu.mo3216a(Boolean.FALSE);
                                break;
                            }
                    }
                    return false;
                    ...
                    switch (motionEvent.getAction() & 255) {
                        case 1:
                            ...
                            translateAnimation.setAnimationListener(new AnimationListener() {
                                ...
                                public void onAnimationEnd(Animation animation) {
                                    LiveViewLumixBaseActivity.this.f9043a.f9290cu.mo3216a(Boolean.TRUE);
                                    LiveViewLumixBaseActivity.this.f9043a.mo7367bA();
                                }
                            });
                            AnimationSet animationSet = new AnimationSet(true);
    ...
    public void OnClickRec(View view) {
        ...
        if (this.f9043a.mo7433ci()) {
            ImageAppLog.error("LiveViewLumixBaseActivity", "Menu Running return");
        } else if (this.f9043a.mo7453h() == 0 || this.f9043a.mo7453h() == 2) {
            ImageAppLog.error("LiveViewLumixBaseActivity", "フォーカスボタン押下中はキャンセル");
            ...
            if (a != null) {
                ...
                if (this.f9043a.mo7277W()) {
                    ...
                    a2.mo5185a((C1986a) new C1986a() {
                        ...
                        public void mo5202b() {
                            if (LiveViewLumixBaseActivity.this.f9043a != null) {
                                LiveViewLumixBaseActivity.this.f9043a.mo7455h(false);
                            }
                            LiveViewLumixBaseActivity.this._handler.post(new Runnable() {
                                public void run() {
                                    DialogFactory.m10100a((Activity) LiveViewLumixBaseActivity.this);
                                    if (LiveViewLumixBaseActivity.this.f9046d.mo12306h()) {
                                        LiveViewLumixBaseActivity.this.startActivityForResult(new Intent(LiveViewLumixBaseActivity.this, RecursiveSettingActivity.class), 7);
                                        LiveViewLumixBaseActivity.this.overridePendingTransition(0, 0);
                                        return;
                                    }
                                    LiveViewLumixBaseActivity.this.mo7211q();
                                    if (LiveViewLumixBaseActivity.this.f9043a != null) {
                                        LiveViewLumixBaseActivity.this.f9043a.mo7489y(false);
                                    }
                                }
                            });
                        }
    ...
    public void OnClickLiveView(View view) {
        ...
        ImageAppLog.verbose("LiveViewLumixBaseActivity", "OnClickLiveView");
    }
    ...
    public void mo7211q() {
        ...
        DialogFactory.m10115a((Activity) this, aVar, (Bundle) null, (C2325c) new C2325c() {
            ...
            public void mo6131a() {
                C5559l lVar;
                LiveViewLumixBaseActivity dVar = LiveViewLumixBaseActivity.this;
                if (LiveViewLumixBaseActivity.this.f9046d.mo12301c()) {
                    C5541am amVar = LiveViewLumixBaseActivity.this.f9046d;
                    amVar.getClass();
                ...
                dVar.f9055m = lVar;
                if (LiveViewLumixBaseActivity.this.f9055m == null || LiveViewLumixBaseActivity.this.f9055m.f17218c == null || LiveViewLumixBaseActivity.this.f9055m.f17218c.length <= 0) {
                    LiveViewLumixBaseActivity.this.f9056n = null;
                } else {
                    LiveViewLumixBaseActivity.this.f9056n = new ArrayAdapter(LiveViewLumixBaseActivity.this._context, 17367043, LiveViewLumixBaseActivity.this.f9055m.f17218c);
                }
                DialogFactory.m10110a((Activity) LiveViewLumixBaseActivity.this, aVar, (int) R.id.qMenuListView, (ListAdapter) LiveViewLumixBaseActivity.this.f9056n);
                DialogFactory.m10107a((Activity) LiveViewLumixBaseActivity.this, aVar, (int) R.id.qMenuListView, (OnItemClickListener) new OnItemClickListener() {
                    public void onItemClick(AdapterView<?> adapterView, View view, int i, long j) {
                        DialogFactory.m10100a((Activity) LiveViewLumixBaseActivity.this);
                        if (LiveViewLumixBaseActivity.this.f9055m != null) {
                            LiveViewLumixBaseActivity.this.f9055m.mo12318a(LiveViewLumixBaseActivity.this._context, i);
                        }
                    }
                });
            }
    ...
    private void mo7020t() {
        ...
        DialogFactory.m10114a((Activity) this, C2328a.ON_SELECT_JUMP_SNAP_SETTING, bundle);
    }
        ...
        switch (i) {
            ...
            case HTTPcJni.JNI_CFG_HTTPC_MAX_HEAD /*16*/:
                ...
                if (this.f9043a != null) {
                    ...
                    if (DialogFactory.m10125b((Activity) this, C2328a.ON_CONNECT_CAMERA_BUSY)) {
                        DialogFactory.m10100a((Activity) this);
                    }
                    if (this.f9043a.mo7400bh()) {
                        this._handler.post(new Runnable() {
                            public void run() {
                                LiveViewLumixBaseActivity.this.f9043a.mo7457i(false);
                            }
                        });
                    } else if (this.f9043a.mo7387bU()) {
                        this._handler.post(new Runnable() {
                            public void run() {
                                LiveViewLumixBaseActivity.this.f9043a.mo7309aC();
                                LiveViewLumixBaseActivity.this.f9043a.mo7431cg();
                            }
                        });
                    }
                    this.f9059s = false;
                    ...
                    if (!this.f9043a.mo7400bh()) {
                        if (this.f9043a.mo7378bL() && this.f9043a.mo7379bM()) {
                            this._handler.post(new Runnable() {
                                public void run() {
                                    LiveViewLumixBaseActivity.this.f9043a.mo7408bp();
                                }
                            });
                        }
                        this._handler.post(new Runnable() {
                            public void run() {
                                LiveViewLumixBaseActivity.this.f9043a.mo7482v();
                            }
                        });
                    }
                    if (!this.f9043a.mo7400bh()) {
                        ...
                        if (this.f9043a != null) {
                            if (!this.f9043a.mo7479t()) {
                                this._handler.post(new Runnable() {
                                    public void run() {
                                        LiveViewLumixBaseActivity.this.f9043a.mo7422c(false);
                                        LiveViewLumixBaseActivity.this.f9043a.mo7472q();
                                        LiveViewLumixBaseActivity.this.f9043a.mo7458j(true);
                                    }
                                });
                            } else {
                        ...
                        if (i == 16 && !bU) {
                            ImageAppLog.error("LiveViewLumixBaseActivity", "スマホ優先モードでcurmenu取得");
                            C1985b a = ServiceFactory.m9679a(this._context, C1712b.m6919c().mo4896a());
                            if (a != null) {
        ...
        switch (aVar) {
            case ON_SELECT_JUMP_SNAP_SETTING:
                ...
                if (!defaultSharedPreferences.getBoolean("JumpRecSettingsFirstCheck", false) && R.string.setup_jump_rec_off != a) {
                    this._handler.post(new Runnable() {
                        public void run() {
                            DialogFactory.m10114a((Activity) LiveViewLumixBaseActivity.this, C2328a.ON_JUMPREC_WARNNING, (Bundle) null);
                        }
                    });
