...
public class C2666e extends C1342a implements C2752a {
    ...
    private class C2675b implements C2018b {
        ...
        public void mo5296a(final int i, final String str) {
            C2666e.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C2666e.this.f8275d != null) {
                        C2666e.this.f8275d.mo6350a(i, str);
                    }
                }
            });
        }
        ...
        public void mo5297a(boolean z, C1892f fVar, boolean z2, int i) {
            ...
            C2666e.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C2666e.this.f8275d != null) {
                        C2666e.this.f8275d.mo6358a(z3, fVar2, z4, i2);
                    }
                }
            });
        }
    ...
    public C2666e(Context context, Handler handler, C2674a aVar) {
    ...
    public void mo6594a(final int i, final boolean z) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6351a(i, z);
                }
            }
        });
    }
    ...
    public void mo6598a(final boolean z, final int i, final boolean z2) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6356a(z, i, z2);
                }
            }
        });
    }
    ...
    public void mo6597a(final List<C2649a> list) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6353a(list);
                }
            }
        });
    }
    ...
    public void mo6596a(C2649a aVar, int i, boolean z, boolean z2) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6352a(aVar2, i2, z3, z4);
                }
            }
        });
    }
    ...
    public boolean mo6599a(C1892f fVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6355a(true);
                }
            }
        });
        ...
        while (true) {
            ...
            if (this.f8279h) {
                ...
                if (aoVar.mo3546a(3, 10) == null) {
                    C2261g.m9769c("CameraConnectViewModel", "CameraStatus is null.");
                }
                mo6600b(1000);
            }
        }
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (C2666e.this.f8275d != null) {
                    C2666e.this.f8275d.mo6355a(false);
                }
            }
        });
        return booleanValue;
