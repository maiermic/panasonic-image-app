...
public class C2754l {
        ...
        if (this.f8524b != null) {
            ...
            while (i >= 0) {
                try {
                    ...
                    C2261g.m9769c("WifiUtil", "getConnectionInfo() Exception");
                    m11352a(100);
                    i--;
                }
            }
        ...
        if (z) {
            try {
                ...
                if (this.f8524b.startScan()) {
                    C2261g.m9763a("WifiUtil", "<-----スキャン開始");
                } else {
                    C2261g.m9763a("WifiUtil", "-----スキャン開始失敗");
                }
                if (countDownLatch.await(10, TimeUnit.SECONDS)) {
                    C2261g.m9763a("WifiUtil", "      スキャン完了----->");
                } else {
                    C2261g.m9763a("WifiUtil", "      スキャンタイムアウト----->");
                }
    ...
    public boolean mo6747b(WifiConfiguration wifiConfiguration) {
        ...
        WifiInfo b = mo6743b();
        C2261g.m9769c("WifiUtil", "指定APに接続しているかチェック" + b.getSSID());
        if (b.getIpAddress() == 0) {
            C2261g.m9769c("WifiUtil", "IPアドレスなし " + b.getSSID());
            return false;
        } else if (mo6739a(wifiConfiguration)) {
            C2261g.m9769c("WifiUtil", "指定APに繋がっている " + b.getSSID());
            return false;
        } else {
            C2261g.m9769c("WifiUtil", "指定APに繋がっていない " + b.getSSID());
            return true;
        }
    }
    ...
    public boolean mo6740a(WifiConfiguration wifiConfiguration, boolean z) {
        ...
        C2261g.m9763a("WifiUtil", String.format("Wifi.EnableNetwork() : SSID = %s, NetworkID = %d", new Object[]{wifiConfiguration.SSID, Integer.valueOf(wifiConfiguration.networkId)}));
    ...
    public void mo6737a(C2649a aVar) {
        if (aVar != null) {
            ...
            if (b != null) {
                C2261g.m9763a("WifiUtil", String.format("Wifi.DisableNetwork() : SSID = %s, NetworkID = %d", new Object[]{b.SSID, Integer.valueOf(b.networkId)}));
                if (this.f8524b != null) {
