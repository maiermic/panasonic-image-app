...
public class GuidanceMenuViewModel extends C2291c implements C2752a {

    /* renamed from: f */
    public static final String f8333f = GuidanceMenuViewModel.class.getSimpleName();
    ...
    private class C2730a implements C2138a {
        ...
        public void mo5668a(boolean z) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleConnected");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5668a(z);
            }
        }

        /* renamed from: a */
        public void mo5662a(int i) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleDisconnected");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5662a(i);
            }
        }

        /* renamed from: a */
        public void mo5663a(BluetoothDevice bluetoothDevice, String str, String str2, String str3) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleScanResult");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5663a(bluetoothDevice, str, str2, str3);
            }
        }

        /* renamed from: a */
        public void mo5667a(UUID uuid, int i, Bundle bundle) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleReadEnd");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5667a(uuid, i, bundle);
            }
        }

        /* renamed from: a */
        public void mo5666a(UUID uuid, int i) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleWriteEnd");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5666a(uuid, i);
            }
        }

        /* renamed from: a */
        public void mo5664a(Bundle bundle, String str) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleNotification");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5664a(bundle, str);
            }
        }

        /* renamed from: d */
        public void mo5672d() {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleConnectError");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5672d();
            }
        }
        ...
        public void mo5669b() {
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5669b();
            }
        }
        ...
        public void mo5661a() {
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5661a();
            }
        }
        ...
        public void mo5671c() {
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5671c();
            }
        }

        /* renamed from: a */
        public void mo5665a(String str) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleCopyStatus");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5665a(str);
            }
        }

        /* renamed from: b */
        public void mo5670b(boolean z) {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleNotificationEnable");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5670b(z);
            }
        }

        /* renamed from: e */
        public void mo5673e() {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleServicePrepared");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5673e();
            }
        }

        /* renamed from: f */
        public void mo5674f() {
            ImageAppLog.debug("GuidanceMenuViewModel", "onBleScanResultError");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5674f();
            }
        }

        /* renamed from: g */
        public void mo5675g() {
            ImageAppLog.debug("GuidanceMenuViewModel", "onAutoSendAcctrlDone");
            if (GuidanceMenuViewModel.this.f8342I != null) {
                GuidanceMenuViewModel.this.f8342I.mo5675g();
            }
        }
    }
    ...
    public class C2731b implements C2018b {
        ...
        public void mo5296a(final int i, final String str) {
            GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (GuidanceMenuViewModel.this.f8334A != null) {
                        GuidanceMenuViewModel.this.f8334A.mo6350a(i, str);
                    }
                }
            });
        }
        ...
        public void mo5297a(boolean z, C1892f fVar, boolean z2, int i) {
            ...
            GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (GuidanceMenuViewModel.this.f8334A != null) {
                        GuidanceMenuViewModel.this.f8334A.mo6358a(z3, fVar2, z4, i2);
                    }
                }
            });
        }
    ...
    public GuidanceMenuViewModel(Context context, Handler handler, C2674a aVar, C2138a aVar2) {
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("startWiFiCheck") {
            ...
            public void mo6585a() {
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6349a();
                        }
                    }
                });
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6713j();
                }
            }
        });
    }
    ...
    public void mo6645l() {
        if (this.f8338E == null) {
            this.f8338E = new Thread(new Runnable() {
                public void run() {
                    if (GuidanceMenuViewModel.this.f8339F.mo6591b() > 0) {
                        if (GuidanceMenuViewModel.this.f8335B != null) {
                            GuidanceMenuViewModel.this.f8335B.mo6710g();
                        }
                        GuidanceMenuViewModel.this.f8339F.mo6589a();
                        GuidanceMenuViewModel.this.f8335B.mo6711h();
                    }
                    GuidanceMenuViewModel.this.f8338E = null;
                }
            }, "stopAction");
            this.f8338E.start();
        }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("setWifiEnable") {
            ...
            public void mo6585a() {
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6359b();
                        }
                    }
                });
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6703a(z);
                }
            }
        });
    }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("updateAccessPointList") {
            ...
            public void mo6585a() {
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6361c();
                        }
                    }
                });
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6704a(z, z2);
                }
            }
        });
    }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("connectAccessPoint1") {
            ...
            public void mo6585a() {
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6363d();
                        }
                    }
                });
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6700a(aVar2, z3, z4, i2);
                }
            }
        });
    }
    ...
    public void mo6630a(String str, String str2, boolean z, int i) {
        ImageAppLog.error("GuidanceMenuViewModel", "connectAccessPoint isBTWakeup:" + z);
        C2028e a = ServiceFactory.m9680a(this.f3706a, false);
        if (a != null) {
            a.mo5283g();
        }
        if (z) {
            ServiceFactory.m9688b(this.f3706a, false).mo5326c();
        }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("connectAccessPoint2") {
            ...
            public void mo6585a() {
                ...
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6702a(str3, str4, z2, i2);
                }
            }
        });
    }
    ...
    public void mo6629a(final String str, final String str2) {
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("connectAccessPointForNFC") {
            ...
            public void mo6585a() {
                ...
                if (GuidanceMenuViewModel.this.f8335B != null) {
                    GuidanceMenuViewModel.this.f8335B.mo6701a(str, str2);
                }
            }
        });
    }
    ...
    public void mo6632a(boolean z, int i, int i2, String str, boolean z2) {
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("searchCamera") {
            ...
            public void mo6585a() {
                ...
                ConnectivityManager connectivityManager = (ConnectivityManager) GuidanceMenuViewModel.this.f3706a.getSystemService("connectivity");
                if (VERSION.SDK_INT >= 23) {
                    ...
                    while (true) {
                        ...
                        if (networkInfo != null && networkInfo.getType() == 1) {
                            ...
                            ServiceFactory.m9689b(GuidanceMenuViewModel.this.f3706a, true, GuidanceMenuViewModel.this.f3707b).mo5330g();
                            break;
                        }
                        i2++;
                    }
                ...
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6366f();
                        }
                    }
                });
                if (ServiceFactory.m9699d()) {
                    eVar = ServiceFactory.m9680a(GuidanceMenuViewModel.this.f3706a, true);
                } else {
                    ...
                    synchronized (obj) {
                        GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                synchronized (obj) {
                                    ServiceFactory.m9680a(GuidanceMenuViewModel.this.f3706a, true);
                                    obj.notifyAll();
                                }
                            }
                        });
                        ...
                        a = ServiceFactory.m9680a(GuidanceMenuViewModel.this.f3706a, true);
                    }
                    eVar = a;
                }
                GuidanceMenuViewModel.this.f8344K = false;
                if (GuidanceMenuViewModel.this.f3706a != null) {
                    int i3 = PreferenceManager.getDefaultSharedPreferences(GuidanceMenuViewModel.this.f3706a).getInt("AccessPointSettingPortNum", -1);
                    eVar.mo5261a("");
                    boolean z4 = false;
                    int i4 = 0;
                    int i5 = 0;
                    ...
                    boolean z5 = false;
                    while (true) {
                        synchronized (GuidanceMenuViewModel.this.f8337D) {
                            if (!GuidanceMenuViewModel.this.f8343J) {
                                if (i3 == -1) {
                                    ...
                                    if (!GuidanceMenuViewModel.this.f8343J) {
                                        ...
                                        if (i4 >= 0 && i5 >= i4 / 2) {
                                            ...
                                            if (i5 != 2 || !z4 || z5) {
                                                ...
                                                ServiceFactory.m9688b(GuidanceMenuViewModel.this.f3706a, true).mo5329f();
                                                z = true;
                                                z2 = z4;
                                                i = i5;
                                            }
                                        ...
                                        if (GuidanceMenuViewModel.this.f8341H != null && GuidanceMenuViewModel.this.f8341H.mo5649k() && GuidanceMenuViewModel.this.f8341H.mo5645g() && !GuidanceMenuViewModel.this.f8341H.mo5651m()) {
                                            z4 = z2;
                                            break;
                                        }
                                        if (i4 == 0) {
                                            GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                                                public void run() {
                                                    if (GuidanceMenuViewModel.this.f8334A != null) {
                                                        GuidanceMenuViewModel.this.f8344K = true;
                                                        GuidanceMenuViewModel.this.f8334A.mo6360b(GuidanceMenuViewModel.this.f8344K);
                                                    }
                                                }
                                            });
                                        }
                                        GuidanceMenuViewModel.this.m11182b(1000);
                                        i5 = i + 1;
                                        i4++;
                                        z4 = z2;
                                        z5 = z;
                                        ...
                                        GuidanceMenuViewModel.this.f8343J = false;
                                        list = a2;
                                        z3 = true;
                                        break;
                                    }
                    ...
                    if (GuidanceMenuViewModel.this.f8344K) {
                        GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (GuidanceMenuViewModel.this.f8334A == null) {
                                    return;
                                }
                                if (GuidanceMenuViewModel.this.f8341H == null) {
                                    GuidanceMenuViewModel.this.f8344K = false;
                                    GuidanceMenuViewModel.this.f8334A.mo6360b(GuidanceMenuViewModel.this.f8344K);
                                } else if (!GuidanceMenuViewModel.this.f8341H.mo5649k() || !GuidanceMenuViewModel.this.f8341H.mo5645g()) {
                                    GuidanceMenuViewModel.this.f8344K = false;
                                    GuidanceMenuViewModel.this.f8334A.mo6360b(GuidanceMenuViewModel.this.f8344K);
                                }
                            }
                    ...
                    GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                        public void run() {
                            if (GuidanceMenuViewModel.this.f8334A != null) {
                                GuidanceMenuViewModel.this.f8334A.mo6354a(list, z3, z4);
                            }
                        }
                    });
                }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("connectCamera") {
            ...
            public void mo6585a() {
                /*
                    ...
                    r0 = 1
                    r1 = 0
                    com.panasonic.avc.cng.view.cameraconnect.i r2 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this
                    java.lang.Object r3 = r2.f8337D
                    monitor-enter(r3)
                    com.panasonic.avc.cng.view.cameraconnect.i r2 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x0071 }
                ...
                L_0x001b:
                    ...
                    com.panasonic.avc.cng.model.service.e r4 = com.panasonic.avc.cng.model.service.ServiceFactory.m9680a(r2, r0)
                    r4.mo5283g()
                ...
                L_0x004e:
                    ...
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this
                    ...
                    monitor-enter(r1)
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x0074 }
                ...
                L_0x0077:
                    ...
                    com.panasonic.avc.cng.model.f r2 = r3
                    com.panasonic.avc.cng.view.cameraconnect.i r5 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this
                    ...
                    java.lang.Object r1 = r0.f8337D
                    monitor-enter(r1)
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x00a5 }
                ...
                L_0x0162:
                    ...
                    com.panasonic.avc.cng.view.cameraconnect.i r4 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this
                ...
                L_0x0195:
                    com.panasonic.avc.cng.view.cameraconnect.i r1 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this
                ...
                L_0x019f:
                    ...
                    java.lang.Object r1 = r0.f8337D
                    monitor-enter(r1)
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x01b7 }
                ...
                L_0x01ba:
                    ...
                    java.lang.Object r1 = r0.f8337D
                    monitor-enter(r1)
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x01eb }
                ...
                L_0x020a:
                    ...
                    goto L_0x001b
                */
                throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.C271624.mo6585a():void");
            }
        });
    }
        ...
        this.f8339F.mo6590a((C2664a) new C2664a("waitApConnect") {
            ...
            public void mo6585a() {
                ...
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6368h();
                        }
                    }
                });
                ConnectivityManager connectivityManager = (ConnectivityManager) GuidanceMenuViewModel.this.f3706a.getSystemService("connectivity");
                ...
                while (true) {
                    ...
                    ImageAppLog.info("GuidanceMenuViewModel", "waitApConnect waiting...");
                    NetworkInfo activeNetworkInfo = connectivityManager.getActiveNetworkInfo();
                    if (activeNetworkInfo != null && activeNetworkInfo.isConnected()) {
                        ImageAppLog.info("GuidanceMenuViewModel", "Ap connected!!!");
                        GuidanceMenuViewModel.this.m11182b((long) (DlnaWrapper.f4978a * 1000));
                        break;
                    }
                    GuidanceMenuViewModel.this.m11182b((long) 1000);
                    synchronized (GuidanceMenuViewModel.this.f8337D) {
                        if (GuidanceMenuViewModel.this.f8343J) {
                            GuidanceMenuViewModel.this.f8343J = false;
                        }
                ...
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6369i();
                        }
                    }
                });
            }
    ...
    public C1912n mo6634b(final C1892f fVar) {
        ...
        Thread thread = new Thread(new Runnable() {
            public void run() {
                GuidanceMenuViewModel.this.f8340G = new C1501d(fVar.f5682d).mo3700c();
            }
        });
        thread.start();
        try {
    ...
    public void mo6625a(final C1892f fVar, final C1912n nVar) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6370j();
                }
            }
        });
        new Thread(new Runnable() {
            public void run() {
                ...
                GuidanceMenuViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (GuidanceMenuViewModel.this.f8334A != null) {
                            GuidanceMenuViewModel.this.f8334A.mo6357a(a, fVar);
                        }
                    }
                });
            }
    ...
    public void mo6635b(final C1892f fVar, C1912n nVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6357a(true, fVar);
                }
            }
        });
    }
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    ...
                    GuidanceMenuViewModel.this.f8334A.mo6351a(i, z);
                }
            }
        });
    }
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    ...
                    GuidanceMenuViewModel.this.f8334A.mo6356a(z, i, z);
                }
            }
        });
    }
    ...
    public void mo6597a(final List<C2649a> list) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6353a(list);
                }
            }
        });
    }
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    ...
                    GuidanceMenuViewModel.this.f8334A.mo6352a(aVar2, i2, z, z4);
                }
            }
        });
    }
    ...
    public void mo6601e(final boolean z) {
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6362c(z);
                }
            }
        });
    }
    ...
    public boolean m11186c(C1892f fVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6355a(true);
                }
            }
        });
        ...
        while (true) {
            ...
            if (this.f8343J) {
                ...
                if (aoVar.mo3546a(3, 10) == null) {
                    ImageAppLog.error("GuidanceMenuViewModel", "CameraStatus is null.");
                }
                m11182b(1000);
            }
        }
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (GuidanceMenuViewModel.this.f8334A != null) {
                    GuidanceMenuViewModel.this.f8334A.mo6355a(false);
                }
            }
        });
        return booleanValue;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                /*
                    ...
                    com.panasonic.avc.cng.view.cameraconnect.i r3 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x005d }
                ...
                L_0x0025:
                    ...
                    com.panasonic.avc.cng.util.ImageAppLog.warning(r0, r2)     // Catch:{ all -> 0x005d }
                    com.panasonic.avc.cng.view.cameraconnect.i r0 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x005d }
                ...
                L_0x0060:
                    ...
                    java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x005d }
                    com.panasonic.avc.cng.util.ImageAppLog.warning(r3, r2)     // Catch:{ all -> 0x005d }
                    com.panasonic.avc.cng.view.cameraconnect.i r2 = com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.this     // Catch:{ all -> 0x005d }
                ...
                L_0x008a:
                    ...
                    com.panasonic.avc.cng.model.service.b r0 = com.panasonic.avc.cng.model.service.ServiceFactory.m9679a(r2, r0)     // Catch:{ all -> 0x005d }
                ...
                L_0x00a1:
                    ...
                    goto L_0x0024
                */
                throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.cameraconnect.GuidanceMenuViewModel.C269416.run():void");
            }
        }).start();
    }
