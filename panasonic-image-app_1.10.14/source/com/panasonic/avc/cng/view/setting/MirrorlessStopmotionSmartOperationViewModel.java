...
public class MirrorlessStopmotionSmartOperationViewModel extends C1342a {
    ...
    /* renamed from: k */
    private BrowserViewModel f17007k;
    ...
    private class C5467a implements C2031c {
        ...
        public void mo5337a(CameraStatus eVar) {
            ImageAppLog.debug("MirrorlessStopmotionSmartOperationViewModel", "OnGetState");
            if (CameraStatus.m7190a(eVar)) {
                SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(MirrorlessStopmotionSmartOperationViewModel.this.f3706a);
                if (!defaultSharedPreferences.getBoolean("HighTemperature", false)) {
                    ...
                    if (C.equalsIgnoreCase("high")) {
                        ...
                        edit.commit();
                        MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11702a("high");
                            }
                        });
                        ...
                        MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11702a("assert");
                            }
                        });
                    }
                }
                ...
                if (MirrorlessStopmotionSmartOperationViewModel.this.f3707b != null) {
                    MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            try {
                                MirrorlessStopmotionSmartOperationViewModel.this.f17002f.mo3216a(Integer.valueOf(C5467a.this.f17024c));
                                MirrorlessStopmotionSmartOperationViewModel.this.f17001e.mo3216a(Integer.valueOf(C5467a.this.f17023b));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
                    ...
                    if (!(a == null || a.f5691m == null || !a.f5691m.mo4754z())) {
                        ...
                        if (!(((!MirrorlessStopmotionSmartOperationViewModel.this.f17019w.equals("sd1") || !X.equals("sd2")) && (!MirrorlessStopmotionSmartOperationViewModel.this.f17019w.equals("sd2") || !X.equals("sd1"))) || MirrorlessStopmotionSmartOperationViewModel.this.f17006j == null || MirrorlessStopmotionSmartOperationViewModel.this.f3707b == null)) {
                            MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                                public void run() {
                                    MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11706d();
                                }
                            });
                        }
                        if (!(!X.equals("none") || MirrorlessStopmotionSmartOperationViewModel.this.f17006j == null || MirrorlessStopmotionSmartOperationViewModel.this.f3707b == null)) {
                            MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                                public void run() {
                                    MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11706d();
                                }
                        ...
                        MirrorlessStopmotionSmartOperationViewModel.this.f17019w = eVar.mo4675X();
                    }
                    MirrorlessStopmotionSmartOperationViewModel.this.f17018v = eVar.mo4706n();
                }
            } else if (MirrorlessStopmotionSmartOperationViewModel.this.f17006j == null || MirrorlessStopmotionSmartOperationViewModel.this.f3707b == null) {
                MirrorlessStopmotionSmartOperationViewModel.this.mo12163m();
            } else {
                final int b = CameraStatus.m7191b(eVar);
                MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11703a(true, b);
                    }
                });
            }
        }
        ...
        public void mo5335a() {
            if (MirrorlessStopmotionSmartOperationViewModel.this.f3707b != null) {
                MirrorlessStopmotionSmartOperationViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (MirrorlessStopmotionSmartOperationViewModel.this.f17006j != null) {
                            MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11700a();
                        }
                    }
                });
            }
        ...
        public void mo5336a(final C1699h hVar) {
            new Thread(new Runnable() {
                public void run() {
                    MirrorlessStopmotionSmartOperationViewModel.this.f17006j.mo11701a(hVar);
                }
            }).start();
        }
    }

    public MirrorlessStopmotionSmartOperationViewModel(Context context, Handler handler, C4255e eVar, C5918d dVar, String str) {
    ...
    private void m20469t() {
        ...
        this.f17007k = new BrowserViewModel(this.f3706a, this.f3707b, this.f17008l);
        ...
        this.f17013q = ServiceFactory.m9680a(this.f3706a, true);
        ...
        if (!this.f17015s) {
            ...
            this.f17016t = new Thread(new Runnable() {
                /* JADX WARNING: Code restructure failed: missing block: B:14:0x0047, code lost:
                    if (com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.m20451a(r4.f17020a) == null) goto L_?;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:15:0x0049, code lost:
                    com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.m20451a(r4.f17020a).mo11705c();
                 */
                ...
                public void run() {
                    /*
                        ...
                        com.panasonic.avc.cng.view.setting.ad r1 = com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.this
                    ...
                    L_0x001b:
                        ...
                        com.panasonic.avc.cng.view.setting.ad r2 = com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.this     // Catch:{ all -> 0x0053 }
                        android.content.Context r2 = r2.f3706a     // Catch:{ all -> 0x0053 }
                        com.panasonic.avc.cng.model.service.b r0 = com.panasonic.avc.cng.model.service.ServiceFactory.m9679a(r2, r0)     // Catch:{ all -> 0x0053 }
                    ...
                    L_0x0038:
                        ...
                        monitor-exit(r1)     // Catch:{ all -> 0x0053 }
                        com.panasonic.avc.cng.view.setting.ad r0 = com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.this
                    ...
                    L_0x0053:
                        ...
                        throw r0
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.MirrorlessStopmotionSmartOperationViewModel.C54651.run():void");
                }
            });
            this.f17016t.start();
            return false;
    ...
    /* renamed from: k */
    public BrowserViewModel mo12161k() {
        return this.f17007k;
    }
    ...
    public void mo12147a(boolean z) {
        if (this.f17009m != null) {
            this.f17009m.mo10232a(false, (BrowserViewModel) null);
        }
