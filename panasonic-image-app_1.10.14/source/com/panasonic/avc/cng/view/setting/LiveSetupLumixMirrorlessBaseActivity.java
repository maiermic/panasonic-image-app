...
public class LiveSetupLumixMirrorlessBaseActivity extends C2946c {
    ...
    public class C5807b implements C3337d {
        ...
        public void mo7086a(int i) {
            if (i == 1) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ERROR_REMAIN_ZERO, (Bundle) null);
            }
        }
        ...
        public void mo7099c(int i) {
            if (LiveSetupLumixMirrorlessBaseActivity.this._resultBundle != null) {
                LiveSetupLumixMirrorlessBaseActivity.this._resultBundle.putBoolean("DeviceDisconnectedKey", true);
                LiveSetupLumixMirrorlessBaseActivity.this.f17844v = true;
            }
            switch (i) {
                case 2:
                    DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_DISCONNECT_BY_HIGH_TEMP_FINISH, (Bundle) null);
                    break;
                case 3:
                    DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_DISCONNECT_BATTERY_LOW_FINISH, (Bundle) null);
                    break;
                default:
                    DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_DISCONNECT_FINISH, (Bundle) null);
                    break;
            }
            ((Activity) LiveSetupLumixMirrorlessBaseActivity.this._context).closeOptionsMenu();
        }
        ...
        public void mo7087a(int i, int i2) {
            if (i == 2) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ERROR_SD_UNSET_MOVIE, (Bundle) null);
            } else if (i == 3) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ERROR_SD_LOCK_MOVIE, (Bundle) null);
            } else if (i2 == 2) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ERROR_SD_UNSET_PICTURE, (Bundle) null);
            } else if (i2 == 3) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ERROR_SD_LOCK_PICTURE, (Bundle) null);
            }
        }

        /* renamed from: b */
        public void mo7095b() {
            LiveSetupLumixMirrorlessBaseActivity.this._handler.post(new Runnable() {
                public void run() {
                    DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_PROGRESS, (Bundle) null);
                }
            });
        }
        ...
        public void mo7098c() {
            LiveSetupLumixMirrorlessBaseActivity.this._handler.post(new Runnable() {
                public void run() {
                    DialogFactory.m10100a((Activity) LiveSetupLumixMirrorlessBaseActivity.this);
                }
            });
        }
        ...
        public void mo7101e() {
            LiveSetupLumixMirrorlessBaseActivity.this._handler.post(new Runnable() {
                public void run() {
                    DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_SHOOT_MODE_CHANGED, (Bundle) null);
                }
            });
        }
        ...
        public void mo7088a(C1699h hVar) {
            LiveSetupLumixMirrorlessBaseActivity.this.DmsBase_OnNotifySubscribe(hVar);
        }
        ...
        public void mo7097b(String str) {
            if (str.equalsIgnoreCase("high")) {
                ...
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_ASEERT_TEMP_FINISH, (Bundle) null);
            }
        }
    ...
    protected class C5822e implements C5806a {
        ...
        public void mo7035c_() {
            if (LiveSetupLumixMirrorlessBaseActivity.this.f17829e != null) {
                LiveSetupLumixMirrorlessBaseActivity.this.f17829e.mo7035c_();
            }
            LiveSetupLumixMirrorlessBaseActivity.this.mo11485h();
        }
        ...
        public void mo12732a(boolean z) {
            if (LiveSetupLumixMirrorlessBaseActivity.this.f17829e != null) {
                LiveSetupLumixMirrorlessBaseActivity.this.f17829e.mo7033b();
            }
            if (z) {
                DialogFactory.m10114a((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_PROGRESS, (Bundle) null);
            }
            LiveSetupLumixMirrorlessBaseActivity.this.mo11480a(false);
        }

        /* renamed from: c */
        public void mo7034c() {
            if (LiveSetupLumixMirrorlessBaseActivity.this.f17829e != null) {
                LiveSetupLumixMirrorlessBaseActivity.this.f17829e.mo7034c();
            }
            LiveSetupLumixMirrorlessBaseActivity.this.mo11480a(true);
            if (DialogFactory.m10125b((Activity) LiveSetupLumixMirrorlessBaseActivity.this, C2328a.ON_PROGRESS)) {
                DialogFactory.m10100a((Activity) LiveSetupLumixMirrorlessBaseActivity.this);
            }
            if (LiveSetupLumixMirrorlessBaseActivity.this._resultBundle != null) {
                LiveSetupLumixMirrorlessBaseActivity.this._resultBundle.putBoolean("ContentsUpdateKey", true);
            }
        }
    ...
    private void m21501d(android.os.Bundle r6) {
        ...
        L_0x0041:
            ...
            goto L_0x0028
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.LiveSetupLumixMirrorlessBaseActivity.m21501d(android.os.Bundle):void");
    }
    ...
    public void OnClickLiveView(View view) {
        ...
        ImageAppLog.verbose("LiveSetupLumixMirrorlessBaseActivity", "OnClickLiveView");
    }
