...
import com.panasonic.avc.cng.view.liveview.C3145g;
...
public class C5766n extends C2946c {
    ...
    public class C5769b implements C3405c {
        ...
        public void mo6989a(int i) {
            if (i == 1) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_ERROR_REMAIN_ZERO, (Bundle) null);
            }
        }
        ...
        public void mo6996c(int i) {
            if (C5766n.this._resultBundle != null) {
                C5766n.this._resultBundle.putBoolean("DeviceDisconnectedKey", true);
                C5766n.this.f17722s = true;
            }
            switch (i) {
                case 2:
                    C2331d.m10114a((Activity) C5766n.this, C2328a.ON_DISCONNECT_BY_HIGH_TEMP_FINISH, (Bundle) null);
                    break;
                case 3:
                    C2331d.m10114a((Activity) C5766n.this, C2328a.ON_DISCONNECT_BATTERY_LOW_FINISH, (Bundle) null);
                    break;
                default:
                    C2331d.m10114a((Activity) C5766n.this, C2328a.ON_DISCONNECT_FINISH, (Bundle) null);
                    break;
            }
            ((Activity) C5766n.this._context).closeOptionsMenu();
        }
        ...
        public void mo6990a(int i, int i2) {
            if (i == 2) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_ERROR_SD_UNSET_MOVIE, (Bundle) null);
            } else if (i == 3) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_ERROR_SD_LOCK_MOVIE, (Bundle) null);
            } else if (i2 == 2) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_ERROR_SD_UNSET_PICTURE, (Bundle) null);
            } else if (i2 == 3) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_ERROR_SD_LOCK_PICTURE, (Bundle) null);
            }
        }

        /* renamed from: b */
        public void mo6993b() {
            C5766n.this._handler.post(new Runnable() {
                public void run() {
                    C2331d.m10114a((Activity) C5766n.this, C2328a.ON_PROGRESS, (Bundle) null);
                }
            });
        }
        ...
        public void mo6995c() {
            C5766n.this._handler.post(new Runnable() {
                public void run() {
                    C2331d.m10100a((Activity) C5766n.this);
                }
            });
        }
        ...
        public void mo6998e() {
            C5766n.this._handler.post(new Runnable() {
                public void run() {
                    C2331d.m10114a((Activity) C5766n.this, C2328a.ON_SHOOT_MODE_CHANGED, (Bundle) null);
                }
            });
        }
        ...
        public void mo6991a(C1699h hVar) {
            C5766n.this.DmsBase_OnNotifySubscribe(hVar);
        }
    }
    ...
    protected class C5779d implements C5768a {
        ...
        public void mo7035c_() {
            if (C5766n.this.f17710e != null) {
                C5766n.this.f17710e.mo7035c_();
            }
            C5766n.this.mo11532h();
        }
        ...
        public void mo12651a(boolean z) {
            if (C5766n.this.f17710e != null) {
                C5766n.this.f17710e.mo7033b();
            }
            if (z) {
                C2331d.m10114a((Activity) C5766n.this, C2328a.ON_PROGRESS, (Bundle) null);
            }
            C5766n.this.mo11527a(false);
        }

        /* renamed from: c */
        public void mo7034c() {
            if (C5766n.this.f17710e != null) {
                C5766n.this.f17710e.mo7034c();
            }
            C5766n.this.mo11527a(true);
            C2331d.m10100a((Activity) C5766n.this);
            if (C5766n.this._resultBundle != null) {
                C5766n.this._resultBundle.putBoolean("ContentsUpdateKey", true);
            }
        }
    ...
    private void m21353d(android.os.Bundle r6) {
        ...
        L_0x0041:
            ...
            goto L_0x0028
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.C5766n.m21353d(android.os.Bundle):void");
    }
    ...
    private void m21354e(Bundle bundle) {
        ...
        if (true == C2820e.m11815d()) {
            ...
            if (this.f17714i == null) {
                this.f17714i = new C3145g(this, this._handler, this.f17716k);
    ...
    public void OnClickLiveView(View view) {
        ...
        C2261g.m9770d("LiveSetupSliderBarActivity", "OnClickLiveView");
    }
