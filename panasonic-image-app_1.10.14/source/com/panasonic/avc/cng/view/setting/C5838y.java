...
public class C5838y extends C3501e {
    ...
    public C5838y(Context context, Handler handler, C5845b bVar) {
        ...
        if (C1712b.m6919c() != null) {
            ...
            if (this.f17922ae != null) {
                this.f17923af = C2253z.m9679a(this.f3706a, this.f17922ae);
            }
        }
    }
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (a == null) {
                            C2261g.m9769c("LiveSetupMovieWhiteBalanceViewModel", "Cmd() is null....");
                        }
                    }
                    if (new C1853h(a).mo4771a()) {
                        C5838y.this.f17923af.mo5185a((C1986a) new C1986a() {
                            /* renamed from: a */
                            public void mo5201a() {
                            }
                            ...
                            /* renamed from: b */
                            public void mo5202b() {
                                if (C5838y.this.f17924ag != null && C5838y.this.f3707b != null && str2.equalsIgnoreCase("var") && str3 == null) {
                                    C5838y.this.f3707b.post(new Runnable() {
                                        public void run() {
                                            C5838y.this.f17924ag.mo11549b();
                                        }
                                    });
                                }
                            }
        ...
        if (C1712b.m6919c().mo4896a() != null) {
            new Thread(new Runnable() {
                public void run() {
                    ...
                    C5838y.this.f17925ah = new C1870t(a, str).mo4833c();
                    if (new C1853h(a).mo4771a() && C5838y.this.f17924ag != null && C5838y.this.f3707b != null) {
                        C5838y.this.f3707b.post(new Runnable() {
                            public void run() {
                                C5838y.this.f17924ag.mo11548a();
                            }
                        });
                    }
                }
