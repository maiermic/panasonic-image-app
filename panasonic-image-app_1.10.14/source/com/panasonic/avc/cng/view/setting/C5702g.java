...
import com.panasonic.avc.cng.model.C1893g;
...
public class C5702g extends C1342a {
    ...
    protected class C5705a implements Runnable {
        ...
        public void run() {
            this.f17614b = false;
            C5702g.this.m21215a((C4932c) new C4932c() {
                /* renamed from: b */
                public void mo11414b() {
                    C2261g.m9763a("★ConnectSettingViewModel", "OnFind");
                    if (!C5705a.this.f17614b && C5702g.this.f3707b != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (C5702g.this.f17587c != null) {
                                    C2261g.m9763a("★ConnectSettingActivity", "dismiss.CameraSearching");
                                    C5702g.this.f17587c.mo11411b(C2328a.CameraSearching);
                                    C5702g.this.f17587c.mo11405a(-1);
                                }
                            }
                        });
                    }
                ...
                public void mo11413a() {
                    C2261g.m9763a("★ConnectSettingViewModel", "OnNone");
                    if (!C5705a.this.f17614b && C5702g.this.f3707b != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (C5702g.this.f17587c != null) {
                                    C2261g.m9763a("★ConnectSettingActivity", "dismiss.CameraSearching");
                                    C5702g.this.f17587c.mo11411b(C2328a.CameraSearching);
                                    C5702g.this.f17587c.mo11408a(C2328a.WiFiFailed);
                                }
                            }
                        });
                    }
    ...
    protected class C5709b implements C4934e, Runnable {
        ...
        public void run() {
            ...
            try {
                C1892f fVar = (C1892f) C5702g.this.f17603s.get(C5702g.this.f17602r);
                C1893g c = C1712b.m6919c();
                C2028e a = C2253z.m9680a(C5702g.this.f3706a, true);
                a.mo5283g();
                if (fVar == null || a.mo5271a(fVar, C5702g.this.f17588d, false)) {
                    str = a.mo5262a(fVar);
                    if (this.f17619b) {
                        z = true;
                    ...
                    } else if (C5702g.this.f3707b != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                this.mo11418a();
                            }
        ...
        public void mo11419b() {
            if (C5702g.this.f17587c != null) {
                C5702g.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5702g.this.f17587c != null) {
                            C5702g.this.f17587c.mo11411b(C2328a.CameraConnecting);
                            C5702g.this.f17587c.mo11408a(C2328a.WiFiFailed);
                        }
                    }
                });
            ...
            if (C5702g.this.f17587c != null) {
                C5702g.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5702g.this.f17587c != null) {
                            C5702g.this.f17587c.mo11411b(C2328a.CameraConnecting);
                            C5702g.this.f17587c.mo11410b(0);
                        }
                    }
                });
            }
            ...
            if (C5702g.this.f17587c != null) {
                C5702g.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5702g.this.f17587c != null) {
                            C5702g.this.f17587c.mo11411b(C2328a.CameraConnecting);
                            C5702g.this.f17587c.mo11408a(C2328a.WiFiFailedAlreadyConnected);
                        }
                    }
                });
            }
            ...
            if (C5702g.this.f17587c != null) {
                C5702g.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5702g.this.f17587c != null) {
                            C5702g.this.f17587c.mo11411b(C2328a.CameraConnecting);
                            C5702g.this.f17587c.mo11408a(C2328a.ON_NETWORK_SHOW_WIFI_PASSWORD);
                        }
                    }
                });
            }
    ...
    private class C5719e implements C2018b {
        ...
        public void mo5296a(final int i, final String str) {
            C5702g.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C5702g.this.f17587c != null) {
                        C5702g.this.f17587c.mo11407a(i, str);
                    }
                }
            });
        }
        ...
        public void mo5297a(boolean z, C1892f fVar, boolean z2, int i) {
            ...
            C5702g.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C5702g.this.f17587c != null) {
                        C5702g.this.f17587c.mo11409a(z3, fVar2, z4, i2);
                    }
                }
            });
        }
    ...
    protected class C5722f implements Runnable {
        ...
        public void run() {
            this.f17641b = false;
            C5702g.this.m21217a((C4934e) new C4934e() {
                /* renamed from: b */
                public void mo11419b() {
                    if (!C5722f.this.f17641b && C5702g.this.f17587c != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                C5702g.this.f17587c.mo11411b(C2328a.DIALOG_ID_PIC_WifiConnecting);
                                C5702g.this.f17587c.mo11411b(C2328a.ON_NETWORK_SHOW_WIFI_LIST);
                                C5702g.this.f17587c.mo11408a(C2328a.WiFiFailed);
                            }
                        });
                    }
                ...
                public void mo11420c() {
                    if (!C5722f.this.f17641b) {
                        ...
                        } else if (C5702g.this.f17587c != null) {
                            C5702g.this.f3707b.post(new Runnable() {
                                public void run() {
                                    C5702g.this.f17587c.mo11411b(C2328a.DIALOG_ID_PIC_WifiConnecting);
                                    C5702g.this.mo12533b(C5702g.this.f17605u);
                                }
                            });
                        }
                    }
    ...
    protected class C5728g implements Runnable {
        ...
        public void run() {
            this.f17648b = false;
            C5702g.this.m21223b((C4934e) new C4934e() {
                /* renamed from: c */
                public void mo11420c() {
                    if (!C5728g.this.f17648b && C5702g.this.f17587c != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                C5702g.this.f17587c.mo11411b(C2328a.DIALOG_ID_PIC_WifiConnecting);
                                if (!C5702g.this.f17601q) {
                                    C5702g.this.f17587c.mo11411b(C2328a.ON_NETWORK_SHOW_WIFI_PASSWORD);
                                    C5702g.this.f17587c.mo11411b(C2328a.ON_NETWORK_SHOW_WIFI_LIST);
                                }
                                C5702g.this.f17587c.mo11408a(C2328a.WiFiFailed);
                            }
    ...
    protected class C5733h implements Runnable {
        ...
        public void run() {
            this.f17654b = false;
            C5702g.this.m21216a((C4933d) new C4933d() {
                /* renamed from: a */
                public void mo11415a() {
                    if (!C5733h.this.f17654b && C5702g.this.f3707b != null) {
                        C5702g.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (C5702g.this.f17587c != null) {
                                    C5702g.this.f17587c.mo11411b(C2328a.ON_PROGRESS);
                                    C5702g.this.f17587c.mo11408a(C2328a.ON_NETWORK_SHOW_WIFI_LIST);
                                }
                            }
                        });
                    }
    ...
    private class C5738i implements C2045b {
        ...
        public void mo5348a(int i) {
            C2261g.m9763a("WifiDirect", "WifiStateListener: onStateReady");
        }

        /* renamed from: a */
        public void mo5349a(int i, int i2) {
            if (C5702g.this.f17587c != null) {
                C2261g.m9763a("WifiDirect", "WifiStateListener: onStateChanged");
                C5702g.this.f17587c.mo11406a(i, i2);
            }
        }
    }

    public C5702g(Context context, Handler handler, C5718d dVar) {
    ...
    public void mo12528a(Activity activity, C5718d dVar) {
        ...
        this.f17584B = C2253z.m9680a(this.f3706a, true);
    ...
    public void mo12535d() {
        C2046c a = C2253z.m9688b(this.f3706a, true).mo5319a(0);
        if (a == null) {
            m21235k();
        } else if (a.mo5350a()) {
            mo12537f();
        } else if (new C2020c().mo5309b(this.f3706a)) {
            C2261g.m9763a("ConnectSettingViewModel", "ShowWifiSearchingDialog");
            mo12536e();
    ...
    private void m21235k() {
        ...
        new Thread(new Runnable() {
            public void run() {
                C2043f b = C2253z.m9688b(C5702g.this.f3706a, true);
                for (int i = 0; i < 100 && b.mo5319a(0) == null; i++) {
                    try {
                        Thread.sleep(200);
                    } catch (Exception e) {
                    }
                    if (C5702g.this.f17610z) {
                        break;
                    }
                }
                if (!C5702g.this.f17610z && C5702g.this.f3707b != null) {
                    C5702g.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (!C5702g.this.f17610z) {
                                C5702g.this.f17587c.mo11411b(C2328a.ON_PROGRESS);
                                C5702g.this.mo12535d();
                            }
                        }
                    });
                }
    ...
    public void m21216a(C4933d dVar) {
        boolean z;
        int i = 0;
        C2046c a = C2253z.m9688b(this.f3706a, true).mo5319a(5);
        if (a == null || !a.mo5350a()) {
            z = false;
        } else {
            z = true;
        ...
        if (!z || this.f17606v) {
            ...
            if (this.f17600p == null) {
                ...
                C2261g.m9763a("★WifiConnectDialog:", "ResultList.size=" + String.valueOf(this.f17600p.size()));
            }
            if (dVar == null) {
                return;
            }
            ...
            C2261g.m9763a("WifiDirect", "Skip EnableWifiList");
            dVar.mo11416a(1);
        }
    }
    ...
    public void m21215a(C4932c cVar) {
        ...
        if (this.f17603s == null) {
            ...
            C2261g.m9763a("★CameraSearch:", "DeviceList.size=" + String.valueOf(this.f17603s.size()));
        }
        if (this.f17607w) {
            this.f17607w = false;
    ...
    public void m21217a(C4934e eVar) {
        ...
        if (a == 0) {
            ...
            while (!z && !this.f17608x) {
                ...
                if (this.f17604t != null) {
                    ...
                    C2261g.m9763a(str, String.format(str2, objArr));
                    z = a2;
                } else {
                    z = a2;
                }
        ...
        if (this.f17608x) {
            ...
            if (a == 0) {
                C2261g.m9763a("★ConnectSettingViewModel", "WiFiConnect_success");
                eVar.mo11418a();
            } else if (a == 2) {
                C2261g.m9763a("★ConnectSettingViewModel", "WiFiConnect_unknown");
                eVar.mo11420c();
            } else {
                C2261g.m9763a("★ConnectSettingViewModel", "WiFiConnect_error");
                eVar.mo11419b();
            }
        }
    }
        ...
        if (this.f17609y) {
            ...
            if (i4 == 0) {
                ...
                while (!z && i5 <= 90000 && !this.f17608x) {
                    ...
                    C2261g.m9763a("WiFiUtility", "ConnectWiFi:not connected yet time:" + String.valueOf(i5));
                    if (!z) {
                        i5 += 500;
                        mo12532b(500);
                    }
