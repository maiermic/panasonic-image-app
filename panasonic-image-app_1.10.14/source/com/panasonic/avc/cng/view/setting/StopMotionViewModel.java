...
public class StopMotionViewModel extends C1342a {
    ...
    /* renamed from: h */
    public BrowserViewModel f17507h;
    ...
    private class C5661a implements C5461b {
        ...
        public void mo11635a(int i, final C5463d dVar) {
            if (i == 2 && StopMotionViewModel.this.f3707b != null) {
                StopMotionViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        Intent intent;
                        if (true == dVar.mo12141b()) {
                            if (StopMotionViewModel.this.f17507h != null) {
                                if (C1879a.m7545b(C1712b.m6919c().mo4896a(), "1.1")) {
                                    intent = new Intent(StopMotionViewModel.this.f3706a, LiveViewStopmotionActivity.class);
                                } else {
                                    intent = new Intent(StopMotionViewModel.this.f3706a, LiveViewMirrorlessStopmotionActivity.class);
                                }
                                if (intent != null) {
                                    intent.putExtra("StopMotionObjectIDKey", ((C1833c) ((C4262x) StopMotionViewModel.this.f17507h.mo9961d().get(StopMotionViewModel.this.f17515p)).mo10029c()).f5298b);
                                    intent.putExtra("StopMotionAutoOnKey", StopMotionViewModel.this.f17516q);
                                    intent.putExtra("StopMotionSetting_Key", "maintain");
                                    ((Activity) StopMotionViewModel.this.f3706a).startActivityForResult(intent, 7);
                                }
                            }
                        } else if (true == dVar.mo12142c()) {
                            StopMotionViewModel.this.f17506g.mo11732d();
                        }
                    }
                });
            }
    ...
    private class C5663b implements C2031c {
        ...
        public void mo5337a(CameraStatus eVar) {
            ImageAppLog.debug("StopMotionViewModel", "OnGetState");
            if (CameraStatus.m7190a(eVar)) {
                String C = eVar.mo4654C();
                if (C.equalsIgnoreCase("high")) {
                    StopMotionViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            StopMotionViewModel.this.f17506g.mo11729a("high");
                        }
                    });
                }
                SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(StopMotionViewModel.this.f3706a);
                if (!defaultSharedPreferences.getBoolean("HighTemperature", false) && C.equalsIgnoreCase("assert")) {
                    ...
                    StopMotionViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            StopMotionViewModel.this.f17506g.mo11729a("assert");
                        }
                    });
                }
                this.f17523b = eVar.mo4678a();
                this.f17524c = eVar.mo4688b();
                if (StopMotionViewModel.this.f3707b != null) {
                    StopMotionViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            try {
                                StopMotionViewModel.this.f17503d.mo3216a(Integer.valueOf(C5663b.this.f17524c));
                                StopMotionViewModel.this.f17502c.mo3216a(Integer.valueOf(C5663b.this.f17523b));
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                        }
            ...
            if (StopMotionViewModel.this.f17506g == null || StopMotionViewModel.this.f3707b == null) {
                StopMotionViewModel.this.mo12488m();
                return;
            }
            final int b = CameraStatus.m7191b(eVar);
            StopMotionViewModel.this.f3707b.post(new Runnable() {
                public void run() {
                    StopMotionViewModel.this.f17506g.mo11727a(b);
                }
            });
        }
        ...
        public void mo5335a() {
            if (StopMotionViewModel.this.f3707b != null) {
                StopMotionViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (StopMotionViewModel.this.f17506g != null) {
                            StopMotionViewModel.this.f17506g.mo11726a();
                        }
                    }
                });
            }
        ...
        public void mo5336a(final C1699h hVar) {
            new Thread(new Runnable() {
                public void run() {
                    StopMotionViewModel.this.f17506g.mo11728a(hVar);
                }
            }).start();
        }
    }
    ...
    public StopMotionViewModel(Context context, Handler handler, C4255e eVar, C5670c cVar) {
    ...
    private void m21118p() {
        this.f17507h = new BrowserViewModel(this.f3706a, this.f3707b, this.f17508i);
        this.f17507h.mo9947a(10);
        this.f17510k = ServiceFactory.m9680a(this.f3706a, true);
        ...
        this.f17513n = false;
        this.f17514o = null;
        MirrorlessStopmotionMovieMakingViewModel a = C2820e.m11765a(this.f3706a, this.f3707b, (C5461b) null, (C5462c) null);
        if (a != null) {
        ...
        if (C1712b.m6919c().mo4896a() == null) {
            ...
            this.f17514o = new Thread(new Runnable() {
                /* JADX WARNING: Code restructure failed: missing block: B:17:0x0055, code lost:
                    if (com.panasonic.avc.cng.view.setting.StopMotionViewModel.m21101a(r4.f17517a) == null) goto L_?;
                 */
                /* JADX WARNING: Code restructure failed: missing block: B:18:0x0057, code lost:
                    com.panasonic.avc.cng.view.setting.StopMotionViewModel.m21101a(r4.f17517a).mo11731c();
                 */
                ...
                public void run() {
                    /*
                        ...
                        com.panasonic.avc.cng.view.setting.ax r1 = com.panasonic.avc.cng.view.setting.StopMotionViewModel.this
                    ...
                    L_0x001b:
                        ...
                        com.panasonic.avc.cng.util.ImageAppLog.warning(r2, r3)     // Catch:{ all -> 0x0061 }
                    L_0x0038:
                        com.panasonic.avc.cng.view.setting.ax r2 = com.panasonic.avc.cng.view.setting.StopMotionViewModel.this     // Catch:{ all -> 0x0061 }
                        android.content.Context r2 = r2.f3706a     // Catch:{ all -> 0x0061 }
                        com.panasonic.avc.cng.model.service.b r0 = com.panasonic.avc.cng.model.service.ServiceFactory.m9679a(r2, r0)     // Catch:{ all -> 0x0061 }
                    ...
                    L_0x0046:
                        ...
                        monitor-exit(r1)     // Catch:{ all -> 0x0061 }
                        com.panasonic.avc.cng.view.setting.ax r0 = com.panasonic.avc.cng.view.setting.StopMotionViewModel.this
                    ...
                    L_0x0064:
                        ...
                        goto L_0x0045
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.StopMotionViewModel.C56591.run():void");
                }
            });
            this.f17514o.start();
            return false;
    ...
    /* renamed from: k */
    public BrowserViewModel mo12486k() {
        return this.f17507h;
    }
    ...
    public void mo12477b(int i) {
        this.f17515p = i;
        MirrorlessStopmotionMovieMakingViewModel a = C2820e.m11765a(this.f3706a, this.f3707b, (C5461b) new C5661a(), (C5462c) null);
