...
public class C5446ac extends C1342a {
    ...
    private class C5456a implements C2195a {
        ...
        public void mo5819a(final C2187b bVar) {
            if (bVar.mo5811a()) {
                C5446ac.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5446ac.this.f16973k != null) {
                            C5446ac.this.f16973k.mo11643b();
                        }
                    }
                });
                ...
                C5446ac.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (C5446ac.this.f16973k != null) {
                            C5446ac.this.f16973k.mo11642a(bVar.mo5812b());
                        }
                    }
                });
            }
        ...
        public void mo5818a(int i) {
            C5446ac.this.f16976n = i;
            C5446ac.this.f3707b.post(new Runnable() {
                public void run() {
                    if (C5446ac.this.f16973k != null) {
                        C5446ac.this.f16973k.mo11641a(C5446ac.this.f16976n);
                    }
                }
            });
            C2261g.m9771e("MirrorlessStopmotionMovieMakingViewModel", String.format("progress = %d", new Object[]{Integer.valueOf(C5446ac.this.f16976n)}));
        }
    }
    ...
    public C5446ac(Context context, Handler handler, C5461b bVar) {
        super(context, handler);
        m20392b(context, handler, bVar, null);
        m20413w();
    }

    public C5446ac(Context context, Handler handler, C5461b bVar, C5462c cVar) {
        super(context, handler);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                /*
                    ...
                    if (r0 == 0) goto L_0x003f
                    com.panasonic.avc.cng.view.setting.ac r2 = com.panasonic.avc.cng.view.setting.C5446ac.this
                    r2.f16966d = r0
                    r0 = 1
                    com.panasonic.avc.cng.view.setting.ac r2 = com.panasonic.avc.cng.view.setting.C5446ac.this
                    r2.mo12106a(r1)
                L_0x0023:
                    ...
                    r2.post(r3)
                L_0x0039:
                    com.panasonic.avc.cng.view.setting.ac r0 = com.panasonic.avc.cng.view.setting.C5446ac.this
                    r0.f16972j = r1
                    return
                L_0x003f:
                    r0 = r1
                    goto L_0x0023
                */
                throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.C5446ac.C54471.run():void");
            }
        }).start();
        return true;
    }
            ...
            public void run() {
                ...
                if (a != null) {
                    ...
                    if (true == z) {
                        ...
                        if (p != null) {
                            C5446ac.this.f16967e = p;
                            C5446ac.this.m20412v();
                        } else {
                            z2 = false;
                        }
                    } else {
                ...
                if (C5446ac.this.f3707b != null) {
                    C5446ac.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (C5446ac.this.f16965c != null) {
                                C5446ac.this.f16965c.mo11635a(1, new C5463d(z2));
                            }
                        }
                    });
                }
                C5446ac.this.f16972j = false;
            }
        }).start();
        return true;
    }
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                if (a != null) {
                    ...
                    aVar.mo5000a(C5446ac.this.f16966d.mo5001a());
                    aVar.mo4998a(C5446ac.this.f16966d.mo5004c());
                    aVar.mo5003b(C5446ac.this.f16966d.mo5005d());
                    C1853h a2 = aqVar.mo3570a(aVar);
                    if (a2.mo4771a()) {
                        i = 0;
                    } else {
                ...
                if (C5446ac.this.f3707b != null) {
                    C5446ac.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (C5446ac.this.f16965c != null) {
                                C5446ac.this.f16965c.mo11635a(2, new C5463d(i));
                            }
                        }
                    });
                }
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                if (a != null) {
                    ...
                    bVar.mo5008a(C5446ac.this.f16967e.mo5006a());
                    bVar.mo5007a(C5446ac.this.f16967e.mo5009b());
                    bVar.mo5010b(C5446ac.this.f16967e.mo5011c());
                    if (true == aqVar.mo3571a(bVar)) {
                        int q = aqVar.mo3575q();
                        if (q >= 0) {
                            C5446ac.this.f16968f = q;
                        } else {
                ...
                if (C5446ac.this.f3707b != null) {
                    C5446ac.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (C5446ac.this.f16965c != null) {
                                C5446ac.this.f16965c.mo11635a(6, new C5463d(str));
                            }
                        }
                    });
                }
    ...
    private void m20413w() {
        this.f16974l = C2253z.m9722q(this.f3706a);
    ...
    public boolean mo12125q() {
        ...
        C2261g.m9770d("MirrorlessStopmotionMovieMakingViewModel", "MirrorlessStopmotionMovieMakingExecute");
        if (this.f3707b != null) {
            this.f3707b.post(new Runnable() {
                public void run() {
                    if (C5446ac.this.f16973k != null) {
                        C5446ac.this.f16973k.mo11640a();
                    }
                }
            });
        }
    ...
    public boolean mo12126r() {
        ...
        C2261g.m9770d("MirrorlessStopmotionMovieMakingViewModel", "MirrorlessStopmotionMovieMakingCancel");
