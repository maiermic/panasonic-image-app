...
public abstract class SettingMenuBaseActivity extends C5741i {
    ...
    public void onBackPressed() {
        ImageAppLog.info("SettingMenuBaseActivity", "onBackPressed()");
        super.onBackPressed();
    }

    /* access modifiers changed from: protected */
    public void onSaveInstanceState(Bundle bundle) {
        ImageAppLog.info("SettingMenuBaseActivity", "onSaveInstanceState()");
        this.f17157o = true;
        if (bundle != null) {
    ...
    public boolean mo12297y() {
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                SettingMenuBaseActivity.this.f17156d = null;
            }
        }, (long) i);
        return false;
    }
