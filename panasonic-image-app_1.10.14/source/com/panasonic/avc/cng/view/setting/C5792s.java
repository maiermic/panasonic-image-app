...
public class C5792s extends C1342a {
    ...
    private class C5794a implements C1986a {
        ...
        /* renamed from: a */
        public void mo5201a() {
            if (C5792s.this.f17781e != null && C5792s.this.f3707b != null) {
                C5792s.this.f3707b.post(new Runnable() {
                    public void run() {
                        C5792s.this.f17781e.mo7033b();
                    }
                });
            }
        }
        ...
        public void mo5202b() {
            if (C5792s.this.f17781e != null && C5792s.this.f3707b != null) {
                C5792s.this.f3707b.post(new Runnable() {
                    public void run() {
                        C5792s.this.f17781e.mo7034c();
                        C5792s.this.f17781e.mo7035c_();
                    }
                });
            }
        }
    ...
    public C5792s(Context context, Handler handler, C5541am amVar, C5806a aVar) {
        ...
        if (C1712b.m6919c() != null) {
            ...
            if (this.f17782f != null) {
                this.f17783g = C2253z.m9679a(this.f3706a, this.f17782f);
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (a == null) {
                            C2261g.m9769c("LiveSetupDrumPickerWhiteBalanceViewModel", "Cmd() is null....");
                        }
                    }
                    if (new C1853h(a).mo4771a()) {
                        C5792s.this.f17783g.mo5185a((C1986a) null);
                        if (aVar != null) {
                            aVar.mo5202b();
                        }
                    }
