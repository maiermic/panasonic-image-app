...
public class EasyWiFiClockTopActivity extends C5763k implements C2265k {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (m21343b()) {
            C2261g.m9770d(f15931d, "onCreate");
        }
    ...
    public void onClickNext(View view) {
        ...
        } else if (!C2331d.m10125b((Activity) this, C2328a.ON_TIMER)) {
            final Date date = new Date();
            final DateFormat dateTimeInstance = DateFormat.getDateTimeInstance();
            C2331d.m10115a((Activity) this, C2328a.ON_TIMER, new Bundle(), (C2325c) new C2325c() {
                /* renamed from: a */
                public void mo6131a() {
                    C2331d.m10111a(this, C2328a.ON_TIMER, (int) R.id.text, (CharSequence) dateTimeInstance.format(date));
                }
            });
    ...
    public void mo11460a() {
        if (C2331d.m10125b((Activity) this, C2328a.ON_TIMER)) {
    ...
    public boolean mo5760b(C2272n nVar, int i) {
        ...
        if (date != null) {
            while (!C2331d.m10125b((Activity) this, C2328a.ON_TIMER)) {
                try {
                    Thread.sleep(100);
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            if (a != null) {
                if (this.f17702a.mo12610a() == 2) {
                    new C1492aw(a.f5682d).mo3641a(Calendar.getInstance(TimeZone.getTimeZone("GMT")), instance.getTimeZone());
                } else {
