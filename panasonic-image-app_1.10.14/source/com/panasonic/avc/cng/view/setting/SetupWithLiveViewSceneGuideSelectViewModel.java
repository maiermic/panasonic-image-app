...
public class SetupWithLiveViewSceneGuideSelectViewModel extends C1342a {
    ...
    private class C5653a implements C1986a {
        ...
        /* renamed from: a */
        public void mo5201a() {
            if (SetupWithLiveViewSceneGuideSelectViewModel.this.f17482e != null && SetupWithLiveViewSceneGuideSelectViewModel.this.f3707b != null) {
                SetupWithLiveViewSceneGuideSelectViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        SetupWithLiveViewSceneGuideSelectViewModel.this.f17482e.mo7033b();
                    }
                });
            }
        }
        ...
        public void mo5202b() {
            if (SetupWithLiveViewSceneGuideSelectViewModel.this.f17482e != null && SetupWithLiveViewSceneGuideSelectViewModel.this.f3707b != null) {
                SetupWithLiveViewSceneGuideSelectViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        SetupWithLiveViewSceneGuideSelectViewModel.this.f17482e.mo7034c();
                        SetupWithLiveViewSceneGuideSelectViewModel.this.f17482e.mo7035c_();
                        SetupWithLiveViewSceneGuideSelectViewModel.this.f17489l.mo12042a(SetupWithLiveViewSceneGuideSelectViewModel.this.f17490m);
                    }
                });
            }
        }
    ...
    public SetupWithLiveViewSceneGuideSelectViewModel(Context context, Handler handler, C5541am amVar, C5555h hVar, C5657b bVar) {
        ...
        if (C1712b.m6919c() != null) {
            ...
            if (this.f17484g != null) {
                this.f17485h = ServiceFactory.m9679a(this.f17483f, this.f17484g);
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (a == null) {
                            ImageAppLog.error("SetupWithLiveViewSceneGuideSelectViewModel", "Cmd() is null....");
                        }
                    }
                    if (new ParseTagHighlightSceneInfo(a).mo4771a()) {
                        SetupWithLiveViewSceneGuideSelectViewModel.this.f17485h.mo5185a((C1986a) null);
                        if (aVar != null) {
                            aVar.mo5202b();
                        }
                    }
