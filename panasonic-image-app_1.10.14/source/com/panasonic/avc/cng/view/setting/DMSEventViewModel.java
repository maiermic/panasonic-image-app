...
public class DMSEventViewModel extends C1342a implements C2044a {
    ...
    public DMSEventViewModel(Context context, Handler handler) {
    ...
    public void mo12575a(int i, C5740a aVar) {
        ...
        ServiceFactory.m9688b(this.f3706a, true).mo5321a((C2044a) this);
    }
    ...
    public void mo12576c() {
        ...
        C2043f b = ServiceFactory.m9688b(this.f3706a, false);
        if (b != null) {
    ...
    public void mo5347a(int i) {
        C5740a aVar;
        ImageAppLog.info("DMSEventViewModel", String.valueOf(i));
        synchronized (this.f17661d) {
            aVar = this.f17660c;
        }
        if (aVar != null) {
