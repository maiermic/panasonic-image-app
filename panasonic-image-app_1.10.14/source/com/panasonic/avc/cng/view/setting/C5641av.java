...
public class C5641av extends C1342a {
    ...
    private class C5646a implements C1986a {
        ...
        /* renamed from: a */
        public void mo5201a() {
            if (C5641av.this.f17461e != null && C5641av.this.f3707b != null) {
                C5641av.this.f3707b.post(new Runnable() {
                    public void run() {
                        C5641av.this.f17461e.mo7033b();
                    }
                });
            }
        }
        ...
        public void mo5202b() {
            if (C5641av.this.f17461e != null && C5641av.this.f3707b != null) {
                C5641av.this.f3707b.post(new Runnable() {
                    public void run() {
                        C5641av.this.f17461e.mo7034c();
                        C5641av.this.f17461e.mo7035c_();
                    }
                });
            }
        }
    ...
    public C5641av(Context context, Handler handler, C5541am amVar, C5555h hVar, C5650b bVar) {
        ...
        if (C1712b.m6919c() != null) {
            ...
            if (this.f17464h != null) {
                this.f17465i = C2253z.m9679a(this.f17463g, this.f17464h);
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (a == null) {
                            C2261g.m9769c("LiveSetupDrumPickerPhotoStyleViewModel", "Cmd() is null....");
                        }
                    }
                    if (new C1853h(a).mo4771a()) {
                        C5641av.this.f17465i.mo5185a((C1986a) new C1986a() {
                            /* renamed from: a */
                            public void mo5201a() {
                            }
                            ...
                            /* renamed from: b */
                            public void mo5202b() {
                                if (C5641av.this.f3707b != null) {
                                    C5641av.this.f3707b.post(new Runnable() {
                                        public void run() {
                                            C5641av.this.f17462f.mo12009a();
                                        }
                                    });
                                }
                            }
