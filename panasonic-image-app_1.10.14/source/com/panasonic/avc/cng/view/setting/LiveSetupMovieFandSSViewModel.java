...
public class LiveSetupMovieFandSSViewModel extends C3501e {
    ...
    private class C5827a implements C1986a {
        ...
        /* renamed from: b */
        public void mo5202b() {
            if (LiveSetupMovieFandSSViewModel.this.f17889ag != null && LiveSetupMovieFandSSViewModel.this.f3707b != null) {
                LiveSetupMovieFandSSViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        LiveSetupMovieFandSSViewModel.this.f17889ag.mo11544a(LiveSetupMovieFandSSViewModel.this.f17894al);
                    }
                });
            }
        }
    ...
    public LiveSetupMovieFandSSViewModel(Context context, Handler handler, C5829b bVar) {
        ...
        if (C1712b.m6919c() != null) {
            ...
            if (this.f17887ae != null) {
                this.f17888af = ServiceFactory.m9679a(this.f3706a, this.f17887ae);
            }
        }
    }
            ...
            new Thread(new Runnable() {
                public void run() {
                    ...
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (a == null) {
                            ImageAppLog.error("LiveSetupMovieFandSSViewModel", "Cmd() is null....");
                        }
                    }
                    if (new ParseTagHighlightSceneInfo(a).mo4771a()) {
                        LiveSetupMovieFandSSViewModel.this.f17888af.mo5185a((C1986a) null);
                    }
                }
            }).start();
        } else if (aVar != null) {
            ...
            new Thread(new Runnable() {
                ...
                public void run() {
                    /*
                        ...
                        monitor-enter(r1)
                        java.lang.String r0 = com.panasonic.avc.cng.core.p040a.StaticHttpCommand.m5704a(r0)     // Catch:{ all -> 0x007d }
                        if (r0 != 0) goto L_0x0032
                        java.lang.String r2 = "LiveSetupMovieFandSSViewModel"
                        java.lang.String r3 = "Cmd() is null...."
                        com.panasonic.avc.cng.util.ImageAppLog.error(r2, r3)     // Catch:{ all -> 0x007d }
                    L_0x0032:
                        ...
                        com.panasonic.avc.cng.view.setting.w r3 = com.panasonic.avc.cng.view.setting.LiveSetupMovieFandSSViewModel.this     // Catch:{ all -> 0x007d }
                        java.lang.String r2 = r2.mo4833c()     // Catch:{ all -> 0x007d }
                        r3.f17892aj = r2     // Catch:{ all -> 0x007d }
                    L_0x004c:
                        com.panasonic.avc.cng.view.setting.w r2 = com.panasonic.avc.cng.view.setting.LiveSetupMovieFandSSViewModel.this     // Catch:{ all -> 0x007d }
                        java.lang.String r3 = r3     // Catch:{ all -> 0x007d }
                    ...
                    L_0x00a8:
                        ...
                        goto L_0x0068
                    */
                    throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.setting.LiveSetupMovieFandSSViewModel.C58262.run():void");
                }
            }).start();
        } else if (aVar != null) {
            aVar.mo5203c();
