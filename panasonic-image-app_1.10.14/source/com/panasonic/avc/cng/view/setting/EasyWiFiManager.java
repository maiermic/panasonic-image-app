...
public class EasyWiFiManager implements C2265k {
    ...
    public EasyWiFiManager(Context context, int i) {
        ImageAppLog.info("EasyWiFiManager", "Setting Mode:" + i);
        this.f17691k = i;
    ...
    public boolean mo5760b(C2272n nVar, int i) {
        ...
        if (i == 1) {
            ...
            while (aVar != null && !DialogFactory.m10125b((Activity) this.f17681a, aVar)) {
                try {
                    Thread.sleep(500);
                } catch (Exception e) {
                    e.printStackTrace();
            ...
            if (a3 != null) {
                new WearableSettingCommand(a3.f5682d).mo3646c(true);
            }
        } else if (i == 4) {
            C1892f a4 = C1712b.m6919c().mo4896a();
            if (a4 != null) {
                WearableSettingCommand awVar = new WearableSettingCommand(a4.f5682d);
            ...
            while (aVar2 != null && !DialogFactory.m10125b((Activity) this.f17681a, aVar2)) {
                try {
                    Thread.sleep(500);
                } catch (Exception e2) {
                    e2.printStackTrace();
            ...
            if (a5 != null) {
                new WearableSettingCommand(a5.f5682d).mo3646c(false);
            }
        }
        return false;
    }
    ...
    public void mo5757a(Object obj, int i) {
        if ((i == 2 || i == 5) && obj != null) {
            if (DialogFactory.m10125b((Activity) this.f17681a, (C2328a) obj)) {
                DialogFactory.m10100a((Activity) this.f17681a);
            }
        }
    }
}
