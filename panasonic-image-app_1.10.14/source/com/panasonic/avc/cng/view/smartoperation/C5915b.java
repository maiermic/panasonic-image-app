...
public class C5915b extends C1342a {
    ...
    public C5915b(Context context, Handler handler, C5916a aVar) {
    ...
    public String[] mo12927g() {
        ...
        for (int i = 0; i < this.f18110m.size(); i++) {
            ...
            C2261g.m9771e("GetSelectFormatList", String.format("[%d]:%d, %s, %s, %s, %s, %s", new Object[]{Integer.valueOf(i), Integer.valueOf(bjVar.mo9752a()), bjVar.mo9753b(), bjVar.mo9754c().f5591c, bjVar.mo9754c().f5589a, bjVar.mo9754c().f5592d, bjVar.mo9754c().f5590b}));
