...
public class PictureJumpViewModel extends C1342a {
    ...
    public C5872b f18201K = new C5872b() {
        ...
        public void mo10285a(int i) {
            if (i != 0) {
                if (i == 1) {
                    if (PictureJumpViewModel.this.f3707b != null) {
                        while (!C2266l.m9800a()) {
                            try {
                                Thread.sleep(500);
                            ...
                            ImageAppLog.error("PictureJumpViewModel", "wait isNetwork...");
                        }
                        if (PictureJumpViewModel.this.f3707b != null) {
                            PictureJumpViewModel.this.f3707b.post(new Runnable() {
                                public void run() {
                                    PictureJumpViewModel.this.f18205g.mo12889e();
                                }
                            });
                        }
                    }
                    ...
                    if (PictureJumpViewModel.this.f3707b != null) {
                        PictureJumpViewModel.this.f3707b.post(new Runnable() {
                            public void run() {
                                PictureJumpViewModel.this.f18205g.mo12887c(true);
                            }
                        });
                    }
                } else if (PictureJumpViewModel.this.f3707b != null) {
                    PictureJumpViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            PictureJumpViewModel.this.f18205g.mo12885b(false);
                        }
                    });
                }
            }
    ...
    /* renamed from: p */
    public ContentsCopyViewModel f18214p = null;
    /* access modifiers changed from: private */
    ...
    private class C5967a implements C2031c {
        ...
        public void mo5337a(CameraStatus eVar) {
            ImageAppLog.verbose("PictureJumpViewModel", "OnGetState");
            if (CameraStatus.m7190a(eVar)) {
                String C = eVar.mo4654C();
                if (C.equalsIgnoreCase("high")) {
                    PictureJumpViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            PictureJumpViewModel.this.f18219u.mo4495a("high");
                        }
                    });
                }
                SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(PictureJumpViewModel.this.f3706a);
                if (!defaultSharedPreferences.getBoolean("HighTemperature", false) && C.equalsIgnoreCase("assert")) {
                    ...
                    PictureJumpViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            PictureJumpViewModel.this.f18219u.mo4495a("assert");
                        }
                    });
                }
            } else if (PictureJumpViewModel.this.f3707b != null) {
                C2028e a = ServiceFactory.m9680a(PictureJumpViewModel.this.f3706a, false);
                if (a != null && a.mo5284h()) {
                    return;
                }
                if (eVar == null) {
                    PictureJumpViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (PictureJumpViewModel.this.f18219u != null) {
                                PictureJumpViewModel.this.f18219u.mo4493a(1);
                            }
                        }
                    });
                    return;
                ...
                PictureJumpViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (PictureJumpViewModel.this.f18219u != null) {
                            PictureJumpViewModel.this.f18219u.mo4493a(b);
                        }
                    }
                });
            }
        ...
        public void mo5335a() {
            if (PictureJumpViewModel.this.f3707b != null) {
                PictureJumpViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        if (PictureJumpViewModel.this.f18219u != null) {
                            PictureJumpViewModel.this.f18219u.mo4492a();
                        }
                    }
                });
            }
        ...
        public void mo5336a(C1699h hVar) {
            if (PictureJumpViewModel.this.f18219u != null) {
                PictureJumpViewModel.this.f18219u.mo4494a(hVar);
            }
        }
    }
    ...
    protected class C5974c implements Runnable {
        ...
        public void run() {
            PictureJumpViewModel.this.m22137c(PictureJumpViewModel.this.f18201K);
        }
    }
    ...
    protected class C5975d implements Runnable {
        ...
        public void run() {
            PictureJumpViewModel.this.m22133b(PictureJumpViewModel.this.f18201K);
        }
    }
    ...
    protected class C5976e implements Runnable {
        ...
        public void run() {
            PictureJumpViewModel.this.m22127a((C5872b) new C5872b() {
                /* renamed from: a */
                public void mo10285a(int i) {
                    if (i != 0) {
                        if (i == 1) {
                            if (PictureJumpViewModel.this.f3707b != null) {
                                PictureJumpViewModel.this.f3707b.post(new Runnable() {
                                    public void run() {
                                        PictureJumpViewModel.this.f18205g.mo12885b(true);
                                    }
                                });
                            }
                        } else if (PictureJumpViewModel.this.f3707b != null) {
    ...
    public PictureJumpViewModel(Context context, Handler handler, C1756a aVar) {
    ...
    public boolean mo13049j() {
        ...
        CameraStatus i = this.f18210l.mo5285i();
        if (i != null) {
            return i.mo4699g();
        }
        return false;
            ...
            while (true) {
                ...
                if (i2 < this.f18204f.size()) {
                    ...
                    this.f18213o.mo4501a(arrayList, new C1764a() {
                        /* renamed from: a */
                        public void mo4510a() {
                            if (PictureJumpViewModel.this.f18206h != null) {
                                PictureJumpViewModel.this.f18206h.mo12879a();
                            }
                        }
                        ...
                        public void mo4512a(String str) {
                            if (PictureJumpViewModel.this.f18206h != null) {
                                if (str.equalsIgnoreCase("cancel")) {
                                    PictureJumpViewModel.this.f18206h.mo12881a("cancel");
                                } else if (str.equalsIgnoreCase("deleteerror")) {
                                    PictureJumpViewModel.this.f18206h.mo12881a("errordelete");
                                } else {
                                    PictureJumpViewModel.this.f18206h.mo12881a("error");
                                }
                            }
                            PictureJumpViewModel.this.f18213o.mo4503d();
                        }

                        /* renamed from: b */
                        public void mo4513b() {
                            if (PictureJumpViewModel.this.f18206h != null) {
                                PictureJumpViewModel.this.f18206h.mo12882a(true);
                            }
                            PictureJumpViewModel.this.f18213o.mo4503d();
                        }
                        ...
                        public void mo4511a(int i, int i2) {
                            if (PictureJumpViewModel.this.f18206h != null) {
                                PictureJumpViewModel.this.f18206h.mo12880a(i, i2);
                            }
                        }
                    });
                    return;
        ...
        if (Environment.getExternalStorageState().equalsIgnoreCase("mounted")) {
            ...
            while (true) {
                ...
                if (i2 >= this.f18204f.size()) {
                    ...
                    this.f18214p = new ContentsCopyViewModel(this.f3706a, this.f3707b, this.f18219u);
    ...
    public void mo13055n() {
        this.f18214p.mo4474a((C1757b) new C1757b() {
            /* renamed from: a */
            public void mo4496a() {
                PictureJumpViewModel.this.f18192B = -1;
                if (PictureJumpViewModel.this.f18205g != null) {
                }
            }
            ...
            public void mo4498a(int i, int i2) {
                if (PictureJumpViewModel.this.f18205g != null) {
                    PictureJumpViewModel.this.f18224z = PictureJumpViewModel.this.f18214p.mo4480g();
                    if (PictureJumpViewModel.this.f18192B != i2) {
                        PictureJumpViewModel.this.f18205g.mo12880a(i, i2);
                    }
                    PictureJumpViewModel.this.f18192B = i2;
                }
            }
            ...
            public void mo4499a(String str) {
                if (PictureJumpViewModel.this.f18205g != null) {
                    PictureJumpViewModel.this.f18224z = PictureJumpViewModel.this.f18214p.mo4480g();
                    if (str.equalsIgnoreCase("cancel")) {
                        PictureJumpViewModel.this.f18205g.mo12881a("cancel");
                    } else if (str.equalsIgnoreCase("notRemain")) {
                        PictureJumpViewModel.this.f18205g.mo12881a("notRemain");
                    } else {
                        PictureJumpViewModel.this.f18205g.mo12881a("error");
                    }
                }
                PictureJumpViewModel.this.f18214p.mo4477d();
                PictureJumpViewModel.this.f18192B = -1;
            }
            ...
            public void mo4500b() {
                ...
                if (PictureJumpViewModel.this.f18205g != null) {
                    PictureJumpViewModel.this.f18224z = PictureJumpViewModel.this.f18214p.mo4480g();
                    PictureJumpViewModel.this.f18205g.mo12882a(true);
                }
            }
            ...
            public void mo4591a(String str) {
                if (PictureJumpViewModel.this.f18205g != null) {
                    if (str.equalsIgnoreCase("cancel")) {
                        ...
                        PictureJumpViewModel.this.f18205g.mo12881a("notContents");
                    } else {
                        PictureJumpViewModel.this.f18205g.mo12881a("error");
                    }
                }
                PictureJumpViewModel.this.f18215q.mo4575d();
            }

            /* renamed from: b */
            public void mo4592b() {
                if (PictureJumpViewModel.this.f18205g != null) {
                    PictureJumpViewModel.this.f18205g.mo12882a(false);
                }
                PictureJumpViewModel.this.f18215q.mo4575d();
            }
        });
        ...
        if (Environment.getExternalStorageState().equalsIgnoreCase("mounted")) {
            ...
            this.f18216r.mo4453a((C1742a) new C1742a() {
                ...
                public void mo4472a(String str) {
                    ...
                    PictureJumpViewModel.this.f18216r.mo4456d();
                }
        ...
        if (Environment.getExternalStorageState().equalsIgnoreCase("mounted")) {
            ...
            this.f18217s.mo4429a((C1728a) new C1728a() {
                ...
                public void mo4451a(String str) {
                    ...
                    PictureJumpViewModel.this.f18217s.mo4432d();
                }
    ...
    public void mo13057p() {
        ...
        this.f18218t.mo4514a((C1813a) new C1813a() {
            ...
            public void mo4570a(String str) {
                ...
                PictureJumpViewModel.this.f18218t.mo4518d();
            }

            /* renamed from: b */
            public void mo4571b() {
                if (PictureJumpViewModel.this.f18205g != null) {
                    PictureJumpViewModel.this.f18205g.mo12888d();
                }
            }
        });
    }
    ...
    public void m22127a(C5872b bVar) {
        if (this.f18222x != null) {
            ...
            if (this.f18194D == null) {
                ...
                ImageAppLog.debug("★WifiConnectDialog:", "ResultList.size=" + String.valueOf(this.f18194D.size()));
            }
            if (bVar == null) {
                return;
            }
