...
public class MultiPhotoFrameBrowseViewModel extends C2291c {
    ...
    /* renamed from: o */
    private BrowserViewModel f15056o;
    ...
    /* renamed from: s */
    private GetSelectFormatList f15060s;
    ...
    private class C4604b implements C5916a {
        ...
        public void mo10545a() {
            MultiPhotoFrameBrowseViewModel.this.mo10777l();
            MultiPhotoFrameBrowseViewModel.this.mo10776k();
        }
    }
    ...
    private class C4605c implements C2201b {
        ...
        public void mo5827a(final int i, List<String> list, final int i2) {
            ...
            MultiPhotoFrameBrowseViewModel.this.mo10770c(false);
            MultiPhotoFrameBrowseViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (i == 0) {
                        Intent intent = new Intent(MultiPhotoFrameBrowseViewModel.this.f3706a, MultiPhotoFrameExecuteActivity.class);
                        intent.putStringArrayListExtra("MultiPhotoPicupList", arrayList);
                        ((Activity) MultiPhotoFrameBrowseViewModel.this.f3706a).startActivityForResult(intent, 21);
                        MultiPhotoFrameBrowseViewModel.this.f15052k.mo10659a((List<String>) arrayList);
                    } else if (i == 1) {
                        MultiPhotoFrameBrowseViewModel.this.f15052k.mo10661b(i2);
                    } else if (i == 2) {
                        MultiPhotoFrameBrowseViewModel.this.f15052k.mo10660b();
                    }
                }
            });
        }
        ...
        public void mo5826a(int i) {
            MultiPhotoFrameBrowseViewModel.this.f15055n = i;
            MultiPhotoFrameBrowseViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameBrowseViewModel.this.f15052k != null) {
                        MultiPhotoFrameBrowseViewModel.this.f15052k.mo10658a(MultiPhotoFrameBrowseViewModel.this.f15055n);
                    }
                }
            });
            ImageAppLog.info("MultiPhotoFrameBrowseViewModel", String.format("progress = %d", new Object[]{Integer.valueOf(MultiPhotoFrameBrowseViewModel.this.f15055n)}));
        }
    }

    public MultiPhotoFrameBrowseViewModel(Context context, Handler handler) {
    ...
    public void mo3205a() {
        ...
        ServiceFactory.m9685a(this.f15058q);
        super.mo3205a();
    }

    /* renamed from: q */
    private void m18007q() {
        this.f15058q = ServiceFactory.m9703f();
        if (this.f15058q != null) {
            this.f15058q.mo5041f();
        }
        this.f15056o = new BrowserViewModel(this.f3706a, this.f3707b, this.f15057p);
        this.f15056o.mo9947a(16);
        this.f15056o.mo9957b(true);
        this.f15061t = new C4604b();
        this.f15060s = new GetSelectFormatList(this.f3706a, this.f3707b, this.f15061t);
        this.f15053l = ServiceFactory.m9709i(this.f3706a);
    ...
    /* renamed from: i */
    public BrowserViewModel mo10774i() {
        return this.f15056o;
    }

    /* renamed from: j */
    public GetSelectFormatList mo10775j() {
        return this.f15060s;
    }
    ...
    public void mo10777l() {
        ImageAppLog.verbose("MultiPhotoFrameBrowseViewModel", "StopBrowsing()");
        if (this.f15056o != null) {
    ...
    public void mo6018a(CameraStatus eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    MultiPhotoFrameBrowseViewModel.this.f15048g.mo3216a(Integer.valueOf(b));
                    MultiPhotoFrameBrowseViewModel.this.f15047f.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public boolean mo10779n() {
        ...
        new Thread(new Runnable() {
            public void run() {
                MultiPhotoFrameBrowseViewModel.this.f15053l.mo5389a(arrayList, MultiPhotoFrameBrowseViewModel.this.f15054m);
            }
        }).start();
        return true;
    }
