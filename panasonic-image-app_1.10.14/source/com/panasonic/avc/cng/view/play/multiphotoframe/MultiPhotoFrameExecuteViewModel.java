...
public class MultiPhotoFrameExecuteViewModel extends C2291c {
    ...
    private class C4615a implements C2200a {
        ...
        public void mo5825a(final int i, final List<C2003c> list, final int i2) {
            if (MultiPhotoFrameExecuteViewModel.this.f15086k != null) {
                MultiPhotoFrameExecuteViewModel.this.f15086k.mo5394d();
            }
            MultiPhotoFrameExecuteViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (i == 0) {
                        MultiPhotoFrameExecuteViewModel.this.mo10791a(list);
                        MultiPhotoFrameExecuteViewModel.this.mo10795e(false);
                        MultiPhotoFrameExecuteViewModel.this.mo6022d().putBoolean("GalleryUpdateKey", true);
                        MultiPhotoFrameExecuteViewModel.this.f15088m.mo10670a(list);
                    } else if (i == 1) {
                        MultiPhotoFrameExecuteViewModel.this.f15088m.mo10668a(i2);
                        MultiPhotoFrameExecuteViewModel.this.f15085j.mo3216a(Boolean.valueOf(true));
                    } else if (i == 2) {
                        MultiPhotoFrameExecuteViewModel.this.mo10795e(false);
                        MultiPhotoFrameExecuteViewModel.this.mo6022d().putBoolean("GalleryUpdateKey", false);
                        MultiPhotoFrameExecuteViewModel.this.mo6022d().putBoolean("MultiPhotoFinish", true);
                        MultiPhotoFrameExecuteViewModel.this.f15088m.mo10671b();
                    }
                    MultiPhotoFrameExecuteViewModel.this.mo10793c(false);
                }
            });
        }
        ...
        public void mo5824a(int i, int i2) {
            MultiPhotoFrameExecuteViewModel.this.f15089n = i2;
            MultiPhotoFrameExecuteViewModel.this.f15090o = i;
            MultiPhotoFrameExecuteViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameExecuteViewModel.this.f15088m != null) {
                        MultiPhotoFrameExecuteViewModel.this.f15088m.mo10669a(MultiPhotoFrameExecuteViewModel.this.f15090o, MultiPhotoFrameExecuteViewModel.this.f15089n);
                    }
                }
            });
        }
    ...
    public MultiPhotoFrameExecuteViewModel(Context context, Handler handler) {
    ...
    private void m18047q() {
        ...
        this.f15086k = ServiceFactory.m9709i(this.f3706a);
    ...
    public void mo6018a(CameraStatus eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    MultiPhotoFrameExecuteViewModel.this.f15082g.mo3216a(Integer.valueOf(b));
                    MultiPhotoFrameExecuteViewModel.this.f15081f.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public boolean mo10797g() {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                if (MultiPhotoFrameExecuteViewModel.this.f15088m != null) {
                    MultiPhotoFrameExecuteViewModel.this.f15088m.mo10667a();
                }
            }
        });
            ...
            public void run() {
                ...
                while (true) {
                    ...
                    if (i2 < o.size()) {
                        ...
                        MultiPhotoFrameExecuteViewModel.this.f15086k.mo5390a(arrayList, n, ".jpg", MultiPhotoFrameExecuteViewModel.this.f15087l);
                        return;
                    }
                }
            }
    ...
    public void mo10798h() {
        ImageAppLog.verbose("MultiPhotoFrameExecuteViewModel", "MultiPhotoFrameExecuteCancel");
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                MultiPhotoFrameExecuteViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        MultiPhotoFrameExecuteViewModel.this.mo6022d().putBoolean("GalleryUpdateKey", false);
                        MultiPhotoFrameExecuteViewModel.this.f15088m.mo10672c();
                    }
                });
            }
        }).start();
