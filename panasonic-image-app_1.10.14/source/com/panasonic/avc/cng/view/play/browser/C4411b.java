...
public class C4411b implements C2265k {
    ...
    public C4411b(Activity activity, String str, String str2, int i, boolean z) {
        C2261g.m9771e("BrowserConnectWiFi", "SSID;" + str);
        ...
        this.f14538a.start();
        if (z) {
            C2331d.m10114a(this.f14539b, C2328a.ON_PROGRESS, (Bundle) null);
        }
    }
    ...
    public void mo10305a(boolean z) {
        this.f14542e = z;
        if (!z && C2331d.m10125b(this.f14539b, C2328a.ON_PROGRESS)) {
            C2331d.m10100a(this.f14539b);
        }
    }
    ...
    public void mo5757a(Object obj, int i) {
        if (i != 0 || obj == null || !this.f14542e) {
            if (C2331d.m10125b(this.f14539b, C2328a.ON_PROGRESS)) {
                C2331d.m10100a(this.f14539b);
            }
            this.f14540c = false;
        } else {
        ...
        if (!this.f14540c && this.f14539b != null) {
            C2028e a2 = C2253z.m9680a((Context) this.f14539b, false);
            if (a2 == null) {
                return;
            }
            if (a2.mo5284h()) {
