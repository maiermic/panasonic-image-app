...
public class MultiPhotoFrameSelectPictureViewModel extends C2291c {

    /* renamed from: j */
    public static final String f15181j = MultiPhotoFrameSelectPictureViewModel.class.getSimpleName();
    ...
    /* renamed from: l */
    protected BrowserViewModel f15207l;
    ...
    private class C4653a implements C2200a {
        ...
        public void mo5825a(final int i, final List<C2003c> list, final int i2) {
            MultiPhotoFrameSelectPictureViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (i == 0) {
                        ...
                        for (int i = 0; i < list.size(); i++) {
                            ...
                            arrayList.add(cVar);
                            ImageAppLog.info("MultiPhotoFrameSelectPictureViewModel", String.format(Locale.US, "rotation[%d], path[%s]", new Object[]{Integer.valueOf(cVar.f6192d), cVar.f6191c}));
                        }
                        if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                            MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10739a(arrayList, true);
                        }
                    } else if (i == 1) {
                        if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                            MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10743c(i2);
                        }
                    } else if (i == 2) {
                        new Thread(new Runnable() {
                            public void run() {
                                if (MultiPhotoFrameSelectPictureViewModel.this.f15185D == null) {
                                    MultiPhotoFrameSelectPictureViewModel.this.f15185D = ServiceFactory.m9711j(MultiPhotoFrameSelectPictureViewModel.this.f3706a);
                                    MultiPhotoFrameSelectPictureViewModel.this.f15185D.mo5204a();
                                }
                                MultiPhotoFrameSelectPictureViewModel.this.f15185D.mo5214b(MultiPhotoFrameSelectPictureViewModel.m18171A(), new C2011a() {
                                    /* renamed from: b */
                                    public void mo4443b(String str) {
                                        MultiPhotoFrameSelectPictureViewModel.this.mo3207a((Runnable) new Runnable() {
                                            public void run() {
                                                MultiPhotoFrameSelectPictureViewModel.this.f15185D.mo5213b();
                                                MultiPhotoFrameSelectPictureViewModel.this.f15185D = null;
                                                if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                                                    MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10742c();
                                                }
                                            }
                                        });
                                    }
                                    ...
                                    public void mo4441a(int i, int i2) {
                                        ImageAppLog.verbose("MultiPhotoFrameSelectPictureViewModel", String.format(Locale.US, "num[%d], progress[%d]", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
                                    }
                    ...
                    MultiPhotoFrameSelectPictureViewModel.this.mo10905g(false);
                }
            });
        }
        ...
        public void mo5824a(int i, int i2) {
            MultiPhotoFrameSelectPictureViewModel.this.f15197P = i2;
            MultiPhotoFrameSelectPictureViewModel.this.f15198Q = i;
            MultiPhotoFrameSelectPictureViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                        MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10738a(MultiPhotoFrameSelectPictureViewModel.this.f15198Q, MultiPhotoFrameSelectPictureViewModel.this.f15197P);
                    }
                }
            });
        }
    ...
    public MultiPhotoFrameSelectPictureViewModel(Context context, Handler handler) {
    ...
    private void mo10882i() {
        ...
        this.f15203g = new C3972a() {
            /* renamed from: a */
            public void mo9426a() {
                MultiPhotoFrameSelectPictureViewModel.this.f15207l.mo9978l();
                MultiPhotoFrameSelectPictureViewModel.this.f15201e = -1;
                MultiPhotoFrameSelectPictureViewModel.this.mo10885l();
            }
        };
        this.f15202f = new C3971aa(this.f3706a, this.f3707b, this.f15203g);
        this.f15201e = -1;
        this.f15196O = new C4653a();
        this.f15195N = ServiceFactory.m9709i(this.f3706a);
    ...
    public void mo10917t() {
        ...
        if (((Boolean) mo10922y().f13292d.mo3217b()).booleanValue()) {
            for (int i2 = 0; i2 < mo10922y().mo9411e(); i2++) {
                ...
                ImageAppLog.info("MultiPhotoFrameSelectPictureViewModel", String.format(Locale.US, "name[%s], type[%d]", new Object[]{mo10922y().mo9406b(i2), Integer.valueOf(a2)}));
                if (a2 == 4) {
                    mo10922y().mo9412e(i2);
                    return;
                }
                ...
                if (c.f5597c.equalsIgnoreCase("sd")) {
                    ...
                    if (i != null && !i.mo4706n()) {
                        mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                                    MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10736a();
                                }
                            }
                        });
                        return;
    ...
    public void mo10877b(final int i) {
        ...
        if (this.f15207l.mo9975j(i)) {
            ...
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                        MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10737a(i);
                    }
                }
            });
        } else {
    ...
    public void mo6018a(CameraStatus eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    MultiPhotoFrameSelectPictureViewModel.this.f15212q.mo3216a(Integer.valueOf(b));
                    MultiPhotoFrameSelectPictureViewModel.this.f15211p.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        if (!(a2 == null || a2.f5691m == null || !a2.f5691m.mo4754z())) {
            ...
            if (this.f15187F.equals("wslot_change")) {
                ...
                mo3207a((Runnable) new Runnable() {
                    public void run() {
                        MultiPhotoFrameSelectPictureViewModel.this.mo10922y().mo9408c(X.equals("sd1") ? 0 : 1);
                    }
                });
        ...
        if (z && this.f3707b != null) {
            this.f3707b.post(new Runnable() {
                public void run() {
                    if (MultiPhotoFrameSelectPictureViewModel.this.f15207l != null) {
                        MultiPhotoFrameSelectPictureViewModel.this.f15207l.mo9978l();
                    }
                    MultiPhotoFrameSelectPictureViewModel.this.f15201e = -1;
                    MultiPhotoFrameSelectPictureViewModel.this.mo10885l();
    ...
    public boolean mo6019a(int i) {
        ...
        if (this.f15185D == null) {
            this.f15185D = ServiceFactory.m9711j(this.f3706a);
    ...
    public void mo10891a(List<C1878d> list) {
        if (list.size() == 0) {
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                        MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10740b();
                    }
                }
            });
            return;
        }
        ImageAppLog.info("MultiPhotoFrameSelectPictureViewModel", mo10922y().mo9417h().mo9750b());
        if (this.f15205i == null && mo10922y().mo9417h().mo9749a() == 1) {
            ...
            mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                        MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10739a(arrayList, false);
                    }
                }
            });
        }
    ...
    public boolean mo10892a(final List<C1878d> list, final String str) {
        ...
        new Thread(new Runnable() {
            public void run() {
                MultiPhotoFrameSelectPictureViewModel.this.mo10905g(true);
                new File(str).mkdirs();
                ArrayList arrayList = new ArrayList();
                int size = list.size();
                for (int i = 0; i < size; i++) {
                    ...
                    if (dVar instanceof C1833c) {
                        ...
                        ImageAppLog.info("MultiPhotoFrameSelectPictureViewModel", String.format("type[%s], url[%s], path[%s]", new Object[]{cVar.f5308l.f5319e, cVar2.f6189a, cVar2.f6191c}));
                ...
                MultiPhotoFrameSelectPictureViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        if (MultiPhotoFrameSelectPictureViewModel.this.f15206k != null) {
                            MultiPhotoFrameSelectPictureViewModel.this.f15206k.mo10741b(size2);
                        }
                    }
                });
                MultiPhotoFrameSelectPictureViewModel.this.f15195N.mo5391a(arrayList, str, ".jpg", true, MultiPhotoFrameSelectPictureViewModel.this.f15196O);
            }
        }).start();
        return true;
    }
    ...
    public void mo10887B() {
        ImageAppLog.warning("MultiPhotoFrameSelectPictureViewModel", "CancelPhotoListCopying()");
            ...
            public void mo4443b(String str) {
                MultiPhotoFrameSelectPictureViewModel.this.mo3207a((Runnable) new Runnable() {
                    public void run() {
                        MultiPhotoFrameSelectPictureViewModel.this.f15185D.mo5213b();
                        MultiPhotoFrameSelectPictureViewModel.this.f15185D = null;
                        MultiPhotoFrameSelectPictureViewModel.this.mo10892a(list, str);
                    }
                });
            }
