...
public class MultiPhotoFrameMainViewModel extends C2291c {
    ...
    /* renamed from: i */
    private MultiPhotoFrameMainData f15132i;
    ...
    public MultiPhotoFrameMainViewModel(Context context, Handler handler, C4625a aVar) {
        super(context, handler);
        this.f15131h = aVar;
        this.f15132i = new MultiPhotoFrameMainData(context);
    ...
    /* renamed from: m */
    public MultiPhotoFrameMainData mo10846m() {
        return this.f15132i;
    }
    ...
    public void mo10831b(ArrayList<C2003c> arrayList) {
        if (arrayList != null) {
            ...
            for (int i = 0; i < min; i++) {
                ...
                ImageAppLog.info("MultiPhotoFrameMainViewModel", String.format("setSelectList()[%d]%s", new Object[]{Integer.valueOf(i), cVar.f6191c}));
    ...
    public void mo10838f(final boolean z) {
        if (!this.f15139p) {
            ...
            if (this.f15137n && this.f15136m != null) {
                if (this.f15142s == null) {
                    this.f15142s = ServiceFactory.m9711j(this.f3706a);
                    this.f15142s.mo5204a();
                }
                this.f15142s.mo5214b(this.f15136m, new C2011a() {
                    /* renamed from: b */
                    public void mo4443b(String str) {
                        MultiPhotoFrameMainViewModel.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                MultiPhotoFrameMainViewModel.this.f15131h.mo10686a(z);
                            }
                        });
                    }
                    ...
                    public void mo4441a(int i, int i2) {
                        ImageAppLog.verbose("MultiPhotoFrameMainViewModel", String.format("num[%d], progress[%d]", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
                    }
