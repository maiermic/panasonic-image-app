...
public class GroupBrowserViewModel extends C2291c {
    ...
    /* renamed from: m */
    public BrowserViewModel f14561m;
    ...
    private class C4422a implements C3972a {
        ...
        /* renamed from: a */
        public void mo9426a() {
            GroupBrowserViewModel.this.f14561m.mo9978l();
            GroupBrowserViewModel.this.f14565q = -1;
            GroupBrowserViewModel.this.mo10340s();
        }
    }
    ...
    private class C4424c implements C5932b {
        ...
        /* renamed from: a */
        public int mo10350a() {
            return GroupBrowserViewModel.this.mo10331j();
        }

        /* renamed from: b */
        public int mo10352b() {
            C1867b c = GroupBrowserViewModel.this.f14567s.mo9417h().mo9751c();
            if (c != null) {
                return c.mo4825a();
            }
            return 0;
        ...
        public String mo10354c() {
            if (GroupBrowserViewModel.this.f14567s != null) {
                return GroupBrowserViewModel.this.f14567s.mo9420k();
            }
            return "";
        }
        ...
        public void mo10353b(int i) {
            if (GroupBrowserViewModel.this.f14559k != null) {
                GroupBrowserViewModel.this.f14559k.mo10105a(i);
            }
        }
        ...
        public void mo10355c(int i) {
            if (GroupBrowserViewModel.this.f14559k != null) {
                GroupBrowserViewModel.this.f14559k.mo10107b(i);
            }
        }
    ...
    public GroupBrowserViewModel(Context context, Handler handler) {
    ...
    public void mo3205a() {
        ...
        ServiceFactory.m9685a(this.f14560l);
        if (this.f14571w != null) {
    ...
    private void m17365z() {
        ...
        this.f14561m = new BrowserViewModel(this.f3706a, this.f3707b, this.f14562n);
        this.f14561m.mo9947a(30);
        this.f14572x = new C4470j(this.f3706a, this.f3707b);
        this.f14565q = -1;
        this.f14566r = -1;
        this.f14560l = ServiceFactory.m9703f();
    ...
    /* renamed from: m */
    public BrowserViewModel mo10334m() {
        return this.f14561m;
    }
    ...
    public void mo6018a(CameraStatus eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    GroupBrowserViewModel.this.f14555g.mo3216a(Integer.valueOf(b));
                    GroupBrowserViewModel.this.f14554f.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
        ...
        if (!z) {
            ...
            this.f3707b.post(new Runnable() {
                public void run() {
                    GroupBrowserViewModel.this.f14559k.mo10104a();
                }
            });
        }
    }
            ...
            public void run() {
                ...
                if (a != null) {
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (!a2.mo4771a()) {
                            ImageAppLog.warning("GroupBrowserViewModel", "PlayMode Error:" + a2.mo4772b());
                        } else {
                            ServiceFactory.m9679a(GroupBrowserViewModel.this.f3706a, a).mo5185a((C1986a) new C1986a() {
                                /* renamed from: a */
                                public void mo5201a() {
                                }
