...
public class HighlightViewModel extends C2291c {
    ...
    /* renamed from: j */
    public BrowserViewModel f14767j;
    ...
    /* renamed from: n */
    private GetSelectFormatList f14771n;
    ...
    private class C4489a implements C2096a {
        ...
        public void mo5516a(final C2042b bVar) {
            HighlightViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (HighlightViewModel.this.f14775r != null) {
                        if (bVar.mo5344a()) {
                            HighlightViewModel.this.f14775r.mo10522b();
                        } else if (bVar.mo5346c()) {
                            HighlightViewModel.this.f14775r.mo10523c();
                        } else {
                            HighlightViewModel.this.f14775r.mo10521a(bVar.mo5345b());
                        }
                        HighlightViewModel.this.mo10531c(false);
                    }
                }
            });
        }
        ...
        public void mo5515a(int i) {
            HighlightViewModel.this.f14776s = i;
            HighlightViewModel.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (HighlightViewModel.this.f14775r != null) {
                        HighlightViewModel.this.f14775r.mo10520a(HighlightViewModel.this.f14776s);
                    }
                }
            });
            ImageAppLog.info("HighlightViewModel", String.format("progress = %d", new Object[]{Integer.valueOf(HighlightViewModel.this.f14776s)}));
        }
    }
    ...
    private class C4493c implements C5916a {
        ...
        public void mo10545a() {
            HighlightViewModel.this.f14767j.mo9978l();
            HighlightViewModel.this.f14770m = -1;
            HighlightViewModel.this.mo10535j();
        }
    }

    public HighlightViewModel(Context context, Handler handler) {
    ...
    public void mo3205a() {
        ...
        ServiceFactory.m9685a(this.f14769l);
        super.mo3205a();
    }

    /* renamed from: p */
    private void m17692p() {
        this.f14769l = ServiceFactory.m9703f();
        if (this.f14769l != null) {
            this.f14769l.mo5041f();
        }
        this.f14767j = new BrowserViewModel(this.f3706a, this.f3707b, this.f14768k);
        this.f14767j.mo9947a(30);
        this.f14767j.mo9957b(true);
        this.f14772o = new C4493c();
        this.f14771n = new GetSelectFormatList(this.f3706a, this.f3707b, this.f14772o);
        C1892f a = C1712b.m6919c().mo4896a();
        this.f14773p = ServiceFactory.m9707h(this.f3706a);
    ...
    /* renamed from: h */
    public BrowserViewModel mo10533h() {
        return this.f14767j;
    }

    /* renamed from: i */
    public GetSelectFormatList mo10534i() {
        return this.f14771n;
    }
    ...
    public void mo6018a(CameraStatus eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    HighlightViewModel.this.f14764g.mo3216a(Integer.valueOf(b));
                    HighlightViewModel.this.f14763f.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void mo10536k() {
        ImageAppLog.verbose("HighlightViewModel", "HighlightSetting");
    ...
    public boolean mo10537l() {
        ...
        mo10531c(true);
        new ArrayList();
        ImageAppLog.verbose("HighlightViewModel", "HighlightExecute");
        ...
        if (this.f3707b != null) {
            this.f3707b.post(new Runnable() {
                public void run() {
                    if (HighlightViewModel.this.f14775r != null) {
                        HighlightViewModel.this.f14775r.mo10519a();
                    }
                }
            });
        }
    ...
    public void mo10538m() {
        ImageAppLog.verbose("HighlightViewModel", "HighlightCancel");
