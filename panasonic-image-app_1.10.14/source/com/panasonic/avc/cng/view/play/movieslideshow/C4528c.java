...
public class C4528c extends C2291c {
    ...
    private class C4536a implements C2096a {
        ...
        public void mo5516a(final C2042b bVar) {
            C4528c.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C4528c.this.f14878t != null) {
                        if (bVar.mo5344a()) {
                            C4528c.this.f14878t.mo10560b();
                        } else if (bVar.mo5346c()) {
                            C4528c.this.f14878t.mo10561c();
                        } else {
                            C4528c.this.f14878t.mo10559a(bVar.mo5345b());
                        }
                        C4528c.this.mo10603c(false);
                    }
                }
            });
        }
        ...
        public void mo5515a(int i) {
            C4528c.this.f14879u = i;
            C4528c.this.mo3207a((Runnable) new Runnable() {
                public void run() {
                    if (C4528c.this.f14878t != null) {
                        C4528c.this.f14878t.mo10558a(2, C4528c.this.f14879u);
                    }
                }
            });
            C2261g.m9771e("MovieSlideshowViewModel", String.format("progress = %d", new Object[]{Integer.valueOf(C4528c.this.f14879u)}));
        }
    }
    ...
    private class C4540c implements C5916a {
        ...
        public void mo10545a() {
            C4528c.this.mo10609k();
            C4528c.this.mo10608j();
        }
    }

    public C4528c(Context context, Handler handler) {
    ...
    public void mo3205a() {
        ...
        C2253z.m9685a(this.f14872n);
        String str = Environment.getExternalStorageDirectory().getPath() + C1712b.m6917b().mo4996c() + "/slideshowtitle";
        C2264j.m9784g(str);
        String str2 = str + "/title.jpg";
        C2264j.m9783f(str2);
        C2261g.m9771e("MovieSlideshowViewModel", "save:" + str2);
        super.mo3205a();
    }

    /* renamed from: t */
    private void m17805t() {
        this.f14872n = C2253z.m9703f();
        if (this.f14872n != null) {
            this.f14872n.mo5041f();
        }
        this.f14870l = new C4245t(this.f3706a, this.f3707b, this.f14871m);
        this.f14870l.mo9947a(30);
        this.f14870l.mo9957b(true);
        this.f14875q = new C4540c();
        this.f14874p = new C5915b(this.f3706a, this.f3707b, this.f14875q);
        C1892f a = C1712b.m6919c().mo4896a();
        this.f14876r = C2253z.m9707h(this.f3706a);
    ...
    /* renamed from: h */
    public C4245t mo10606h() {
        return this.f14870l;
    }

    /* renamed from: i */
    public C5915b mo10607i() {
        return this.f14874p;
    }
    ...
    public void mo10609k() {
        C2261g.m9770d("MovieSlideshowViewModel", "StopBrowsing()");
    ...
    public void mo6018a(C1846e eVar) {
        ...
        mo3207a((Runnable) new Runnable() {
            public void run() {
                try {
                    C4528c.this.f14867i.mo3216a(Integer.valueOf(b));
                    C4528c.this.f14866h.mo3216a(Integer.valueOf(a));
                } catch (Exception e) {
                    e.printStackTrace();
                }
            }
    ...
    public void mo10610l() {
        C2261g.m9770d("MovieSlideshowViewModel", "MovieSlideshowSetting");
    ...
    public boolean mo10613o() {
        ...
        mo10603c(true);
        new ArrayList();
        C2261g.m9770d("MovieSlideshowViewModel", "MovieSlideshowExecute");
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                C2264j.m9783f(str3);
                C2261g.m9771e("MovieSlideshowViewModel", "save:" + str3);
                if (C4528c.this.f14863e != null) {
                    Bitmap a = C2257c.m9738a(C4528c.this.f14863e, 1920, 1080);
                    if (a == null) {
                        C2261g.m9769c("MovieSlideshowViewModel", "bitmap = null");
                        C4528c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (C4528c.this.f14878t != null) {
                                    C4528c.this.f14878t.mo10559a("outofmemory");
                                    C4528c.this.mo10608j();
                                }
                            }
                        });
                    ...
                    try {
                        ...
                        if (createBitmap != null) {
                            C2261g.m9771e("MovieSlideshowViewModel", String.format("Base[%d, %d], Bitmap[%d, %d]", new Object[]{Integer.valueOf(1920), Integer.valueOf(1080), Integer.valueOf(width), Integer.valueOf(height)}));
                            ...
                            if (height * 16 == width * 9) {
                                ...
                                C2261g.m9771e("MovieSlideshowViewModel", String.format("scale:%f, dest left:top[%d, %d], right:bottom[%d, %d]", new Object[]{Float.valueOf(min), Integer.valueOf(rect2.left), Integer.valueOf(rect2.top), Integer.valueOf(rect2.right), Integer.valueOf(rect2.bottom)}));
                            }
                    ...
                    C2261g.m9771e("MovieSlideshowViewModel", str);
                } else {
                    str = null;
                }
                C4528c.this.f14876r.mo5339a(parseInt3, parseInt2, parseInt, parseInt4, w, str, C4528c.this.f14864f, z, new C2097b() {
                    /* renamed from: a */
                    public void mo5517a(final int i, final int i2) {
                        C4528c.this.mo3207a((Runnable) new Runnable() {
                            public void run() {
                                if (C4528c.this.f14878t != null) {
                                    C4528c.this.f14878t.mo10558a(i, i2);
                                }
                            }
                        });
                    }
    ...
    public void mo10614p() {
        C2261g.m9770d("MovieSlideshowViewModel", "MovieSlideshowCancel");
