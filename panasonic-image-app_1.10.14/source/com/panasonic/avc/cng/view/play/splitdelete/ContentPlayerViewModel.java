...
public class ContentPlayerViewModel extends C1342a {
    ...
    private class C4849b implements C2031c {
        ...
        public void mo5337a(CameraStatus eVar) {
            ImageAppLog.verbose("ContentPlayerViewModel", "OnGetState");
            if (!CameraStatus.m7190a(eVar) && (ContentPlayerViewModel.this.f15722j instanceof C1833c) && ContentPlayerViewModel.this.f15724l != null) {
                ContentPlayerViewModel.this.f15724l.mo11234a(CameraStatus.m7191b(eVar));
            }
        }
                ...
                switch (hVar.mo4319b(i)) {
                    case 401:
                        ...
                        if (a != null && a.f5688j == 131074) {
                            ContentPlayerViewModel.this.f15724l.mo11246j();
                            break;
                        }
                }
            }
    ...
    private class C4851d implements C2237a {
        ...
        public void mo5900a(int i, int i2) {
            ContentPlayerViewModel.this.f15728p = 1;
            ContentPlayerViewModel.this.f15730r = i;
            ContentPlayerViewModel.this.f15731s = i2;
            if (ContentPlayerViewModel.this.f15724l != null && ContentPlayerViewModel.this.f3707b != null) {
                ContentPlayerViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        ContentPlayerViewModel.this.f15724l.mo11235a(ContentPlayerViewModel.this.f15730r, ContentPlayerViewModel.this.f15731s);
                    }
                });
            }
        }
        ...
        /* renamed from: c */
        public void mo5904c() {
            ContentPlayerViewModel.this.f15728p = ContentPlayerViewModel.this.f15729q;
            if (ContentPlayerViewModel.this.f15724l != null) {
                ContentPlayerViewModel.this.f15724l.mo11233a();
            }
        }
        ...
        public void mo5905d() {
            if (ContentPlayerViewModel.this.f15724l != null && ContentPlayerViewModel.this.f3707b != null) {
                ContentPlayerViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        ContentPlayerViewModel.this.f15724l.mo11237b();
                    }
                });
            }
        }
        ...
        public void mo5906e() {
            if (ContentPlayerViewModel.this.f15724l != null && ContentPlayerViewModel.this.f3707b != null) {
                ContentPlayerViewModel.this.f3707b.post(new Runnable() {
                    public void run() {
                        ContentPlayerViewModel.this.f15724l.mo11239c();
                    }
                });
            }
        }
        ...
        /* renamed from: f */
        public void mo5907f() {
            if (ContentPlayerViewModel.this.f15728p != 99) {
                ContentPlayerViewModel.this.f15728p = 3;
                ContentPlayerViewModel.this.f15729q = 3;
                if (ContentPlayerViewModel.this.f15724l != null && ContentPlayerViewModel.this.f3707b != null) {
                    ContentPlayerViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            ContentPlayerViewModel.this.f15724l.mo11240d();
                        }
                    });
                }
            }
        ...
        public void mo5903b(int i, int i2) {
            ContentPlayerViewModel.this.f15728p = 99;
            if (ContentPlayerViewModel.this.f15724l != null) {
                ContentPlayerViewModel.this.f15724l.mo11238b(i, i2);
            }
        }
    ...
    public ContentPlayerViewModel(Context context, Handler handler) {
    ...
    public void mo11281a(int i, SurfaceHolder surfaceHolder, C4850c cVar) {
        ...
        this.f15732t = ServiceFactory.m9680a(this.f3706a, true);
    ...
    public void mo11285d() {
        if (this.f15726n == null) {
            this.f15726n = ServiceFactory.m9691b(this.f3706a, this.f15722j);
        }
        if (this.f15726n != null) {
    ...
    public void mo11293l() {
        synchronized (this.f15734v) {
            ImageAppLog.debug("ContentPlayerViewModel", "BeginSeek()");
            if (this.f15726n != null) {
                this.f15728p = 4;
    ...
    public void mo11280a(int i) {
        synchronized (this.f15734v) {
            ImageAppLog.debug("ContentPlayerViewModel", String.format("Seek() pos = %d", new Object[]{Integer.valueOf(i)}));
            if (this.f15726n != null) {
    ...
    public boolean mo11294m() {
        boolean z;
        synchronized (this.f15734v) {
            ImageAppLog.debug("ContentPlayerViewModel", "EndSeek()");
    ...
    public void mo11297p() {
        ...
        new Thread(new Runnable() {
            public void run() {
                C1833c cVar;
                C1892f a = C1712b.m6919c().mo4896a();
                if (ContentPlayerViewModel.this.f15722j instanceof C1833c) {
                    cVar = (C1833c) ContentPlayerViewModel.this.f15722j;
                } else {
                    cVar = null;
                }
                if (!(a == null || cVar == null)) {
                    VideoEditCommand auVar = new VideoEditCommand(a.f5682d);
                    int i = 0;
                    if (ContentPlayerViewModel.this.f15726n instanceof C2157d) {
                        i = ((C2157d) ContentPlayerViewModel.this.f15726n).mo5717l();
                    }
                    ParseTagHighlightSceneInfo a2 = auVar.mo3632a(cVar.f5298b, i);
                    ContentPlayerViewModel.this.f15725m.add(ContentPlayerViewModel.this.m18794a(a2.mo4784n()));
                    ContentPlayerViewModel.this.f15725m.add(ContentPlayerViewModel.this.m18799b(a2.mo4785o()));
                }
                ContentPlayerViewModel.this.f15725m.add(ContentPlayerViewModel.this.m18821r());
                if (ContentPlayerViewModel.this.f3707b != null) {
                    ContentPlayerViewModel.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (ContentPlayerViewModel.this.f15724l != null) {
                                ContentPlayerViewModel.this.f15724l.mo11241e();
                            }
                        }
                    });
                }
    ...
    public C4848a m18794a(boolean z) {
        if (z) {
            return new C4848a(this.f3706a.getText(R.string.msg_split_delete_front).toString(), new Runnable() {
                public void run() {
                    ContentPlayerViewModel.this.m18803c(true);
                }
            });
        }
        return new C4848a(this.f3706a.getText(R.string.msg_split_delete_front).toString(), new Runnable() {
            public void run() {
                if (ContentPlayerViewModel.this.f15724l != null) {
                    ContentPlayerViewModel.this.f15724l.mo11236a(true);
                }
            }
        });
    }
    ...
    public C4848a m18799b(boolean z) {
        if (z) {
            return new C4848a(this.f3706a.getText(R.string.msg_split_delete_back).toString(), new Runnable() {
                public void run() {
                    ContentPlayerViewModel.this.m18803c(false);
                }
            });
        }
        return new C4848a(this.f3706a.getText(R.string.msg_split_delete_back).toString(), new Runnable() {
            public void run() {
                if (ContentPlayerViewModel.this.f15724l != null) {
                    ContentPlayerViewModel.this.f15724l.mo11236a(false);
                }
            }
        });
    }
    ...
    public C4848a m18821r() {
        return new C4848a(this.f3706a.getText(R.string.msg_split_delete_return).toString(), new Runnable() {
            public void run() {
                if (ContentPlayerViewModel.this.f15724l != null) {
                    ContentPlayerViewModel.this.f15724l.mo11245i();
                }
            }
        });
    }
    ...
    public void m18803c(boolean z) {
        ...
        if (a != null && cVar != null) {
            ...
            C2246v e = ServiceFactory.m9701e(this.f3706a, a);
            e.mo5821a(new C2247a() {
                /* renamed from: a */
                public void mo5920a(C2198b bVar) {
                    if (ContentPlayerViewModel.this.f15724l != null) {
                        if (bVar.mo5823a()) {
                            ContentPlayerViewModel.this.f15724l.mo11243g();
                        } else {
                            ContentPlayerViewModel.this.f15724l.mo11244h();
                        }
                    }
                    ContentPlayerViewModel.this.f15737y = false;
                }
            });
