...
public class C4776c {
    ...
    public void mo11124a(C4778a aVar) {
        ...
        if (c == null) {
            C2261g.m9769c(f15510a, "StartEncode(): Error!!");
            return;
        }
        ...
        this.f15513d.mo3837a(0, (C1558d) new C1558d() {
            ...
            /* renamed from: c */
            public void mo3872c() {
                C2261g.m9771e(C4776c.f15510a, "OnEndOfStream(" + String.valueOf(C4776c.this.f15516g) + ")");
                if (!C4776c.this.f15516g) {
                    ...
                    C2261g.m9771e(C4776c.f15510a, String.format("title[%s], path[%s]", new Object[]{name, C4776c.this.f15515f}));
                }
