...
public class GeoTagViewModel extends C1342a {
    ...
    private class C2856a implements C2083b {
        ...
        public void mo3746a(int i, Object obj, int i2, int i3) {
            if (GeoTagViewModel.this.f3707b != null) {
                Message obtainMessage = GeoTagViewModel.this.f3707b.obtainMessage();
                if (i == 268435756) {
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(0, obj));
                } else if (i == 268435758) {
                    obtainMessage.arg1 = i2;
                    obtainMessage.what = 1;
                    GeoTagViewModel.this.f3707b.sendMessage(obtainMessage);
                    if (i2 >= 100 && GeoTagViewModel.this.f8830A != null) {
                        GeoTagViewModel.this.f8830A.mo5422a(GeoTagViewModel.this.f3706a.getResources().getString(R.string.geotag_worklog_status_send_gps_data));
                        if (GeoTagViewModel.this.f8852w != null) {
                            GeoTagViewModel.this.f8852w.mo6914a();
                        }
                    }
                } else if (i == 268435757) {
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(2, obj));
                    GeoTagViewModel.this.f8853x = 0;
                    if (GeoTagViewModel.this.f8854y) {
                        GeoTagViewModel.this.f8854y = false;
                        GeoTagViewModel.this.m11919a(7, 0);
                    }
                } else if (i == 268435759) {
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(4, obj));
                    GeoTagViewModel.this.f8853x = 0;
                    if (GeoTagViewModel.this.f8854y) {
                        GeoTagViewModel.this.f8854y = false;
                        GeoTagViewModel.this.m11919a(7, 0);
                    ...
                    GeoTagViewModel.this.f3707b.sendMessage(obtainMessage);
                    if (GeoTagViewModel.this.f8830A != null) {
                        GeoTagViewModel.this.f8830A.mo5422a(GeoTagViewModel.this.f3706a.getResources().getString(R.string.geotag_worklog_status_error_send_gps_data));
                        if (GeoTagViewModel.this.f8852w != null) {
                            GeoTagViewModel.this.f8852w.mo6914a();
                        }
                    }
                    ...
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(5, obj));
                } else if (i == 268435566) {
                    obtainMessage.arg1 = ((i3 - i2) * 100) / i3;
                    obtainMessage.what = 6;
                    GeoTagViewModel.this.f3707b.sendMessage(obtainMessage);
                } else if (i == 268435568) {
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(9, obj));
                } else if (i == 268435567) {
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(7, obj));
                    GeoTagViewModel.this.f8853x = 0;
                } else if (i == 113) {
                    obtainMessage.arg1 = i3;
                    ...
                    GeoTagViewModel.this.mo6938b(true);
                    GeoTagViewModel.this.f3707b.sendMessage(GeoTagViewModel.this.f3707b.obtainMessage(10, null));
                } else if (i == 1) {
                    obtainMessage.arg1 = i2;
    ...
    public GeoTagViewModel(Context context, Handler handler, C2857b bVar) {
            ...
            public void run() {
                ...
                if (a != null) {
                    synchronized (C1910l.m7679a()) {
                        ...
                        if (!a2.mo4771a()) {
                            ImageAppLog.warning("GeoTagViewModel", "PlayMode Error:" + a2.mo4772b());
                        }
                    }
                }
            }
    ...
    private C2081h m11912H() {
        C2081h d = ServiceFactory.m9698d(this.f3706a, C1712b.m6919c().mo4896a());
        if (d == null) {
            return null;
        }
