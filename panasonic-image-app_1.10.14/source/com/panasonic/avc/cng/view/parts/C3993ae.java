...
public class C3993ae extends RelativeLayout implements Callback {
    ...
    /* renamed from: f */
    public C3973ab f13430f;
    /* access modifiers changed from: private */

    /* renamed from: g */
    public C3973ab f13431g;
    /* access modifiers changed from: private */

    /* renamed from: h */
    public C3973ab f13432h;
    ...
    public C3993ae(Context context, Activity activity, C4036ak akVar, boolean z, boolean z2) {
        boolean z3;
        boolean z4 = false;
        super(context);
        ...
        if (activity != null) {
            ...
            if (C1712b.m6919c() != null) {
                ...
                if (this.f13421S != null) {
                    C1985b a = C2253z.m9679a(this.f13425a, this.f13421S);
                    if (a != null) {
                        a.mo5189b();
                    }
                }
    ...
    public void mo9487a(short[] sArr, short[] sArr2) {
        ...
        this.f13404B = b;
        this.f13430f = new C3973ab(this.f13425a, this.f13404B);
        this.f13430f.setOnPostionChangedListener(new C3977a() {
            /* renamed from: a */
            public void mo9447a(int i, int i2, boolean z) {
                if (C3993ae.this.f13405C && z) {
                    C3993ae.this.f13429e.mo9495a(Long.toString(C3993ae.this.f13444t[i2].f13458b));
                    C3993ae.this.f13430f.setUserTouch(false);
                }
            }
        });
        this.f13430f.setCoverType(1);
        this.f13430f.setDivision(2);
        this.f13431g = new C3973ab(this.f13425a, this.f13404B);
        this.f13431g.setOnPostionChangedListener(new C3977a() {
            /* renamed from: a */
            public void mo9447a(int i, int i2, boolean z) {
                if (C3993ae.this.f13406D && z) {
                    C3993ae.this.f13429e.mo9496b(Long.toString(C3993ae.this.f13445u[i2].f13458b));
                    C3993ae.this.f13431g.setUserTouch(false);
                }
            }
        });
        ...
        for (int i = 0; i < length; i++) {
            ...
            strArr[i] = str;
            C2261g.m9763a(getClass().getSimpleName(), "SS : value = " + str);
        ...
        for (int i3 = 0; i3 < this.f13447w.length; i3++) {
            ...
            strArr2[i3] = num;
            C2261g.m9763a(getClass().getSimpleName(), "F : value = " + num);
        ...
        this.f13432h = new C3973ab(this.f13425a, this.f13404B);
        this.f13432h.setOnPostionChangedListener(new C3977a() {
            /* renamed from: a */
            public void mo9447a(int i, int i2, boolean z) {
                int i3;
                if (!C3993ae.this.f13403A) {
                    C3993ae.this.f13403A = true;
                    return;
                }
                String str = "";
                if (C3993ae.this.f13448x > i2) {
                    i3 = C3993ae.this.f13448x - i2;
                    str = C3993ae.this.f13424V;
                } else if (C3993ae.this.f13448x < i2) {
                    i3 = i2 - C3993ae.this.f13448x;
                    str = C3993ae.this.f13423U;
                } else if (C3993ae.this.f13448x != i2) {
                    i3 = 0;
                } else {
                    return;
                }
                C3993ae.this.f13448x = i2;
                if (C3993ae.this.f13422T == 0 && str.equalsIgnoreCase("down")) {
                    return;
                }
                if (C3993ae.this.f13422T != C3993ae.this.f13445u.length - 1 || !str.equalsIgnoreCase("up")) {
                    C3993ae.this.f13420R.mo9613b();
                    C3993ae.this.f13420R.mo9612a(str, i3);
                    C3993ae.this.f13432h.setUserTouch(false);
                }
            }
        });
    ...
    public void mo9486a(long[] jArr, long[] jArr2) {
        ...
        this.f13432h.setOnPostionChangedListener(new C3977a() {
            ...
            public void mo9447a(int i, int i2, boolean z) {
                ...
                C3993ae.this.f13448x = i2;
                if (C3993ae.this.f13422T == 0 && str.equalsIgnoreCase("up")) {
                    return;
                }
                if (C3993ae.this.f13422T != C3993ae.this.f13445u.length - 1 || !str.equalsIgnoreCase("down")) {
                    C3993ae.this.f13420R.mo9613b();
                    C3993ae.this.f13420R.mo9612a(str, i3);
                    C3993ae.this.f13432h.setUserTouch(false);
                }
    ...
    public void mo9485a(long j, long j2, boolean z) {
        ...
        if (z) {
            C2261g.m9771e("DrumPickerFandSSandPLayout", "setFandSsMoveCheck() setPickerPosition:" + this.f13448x);
