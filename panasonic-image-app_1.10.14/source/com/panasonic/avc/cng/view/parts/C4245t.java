...
public class C4245t extends C1342a {
    ...
    private class C4247a extends Thread {
        ...
        public void run() {
            this.f14261b = false;
            C4245t.this.f14236d = C2253z.m9703f();
            if (C4245t.this.f14236d != null) {
                C4245t.this.f14250r = C4245t.this.f14236d.mo5034b();
                synchronized (C4245t.this.f14227L) {
                    for (int i = 0; i < C4245t.this.f14250r && !this.f14261b; i++) {
                        C4245t.this.f14249q.add(new C4262x(null, i, C4245t.this.f14256x, C4245t.this.f14236d));
                    }
                }
                if (C4245t.this.f14256x != null) {
                    C4245t.this.f14256x.post(new Runnable() {
                        public void run() {
                            C4245t.this.f14239g.mo3216a(Integer.valueOf(C4245t.this.f14250r));
                            C4245t.this.f14240h.mo3216a(Integer.valueOf(C4245t.this.f14251s.size()));
                            if (C4245t.this.f14250r > 0) {
                                C4245t.this.f14243k.mo3216a(Boolean.valueOf(true));
                                if (C4245t.this.f14252t == -1) {
                                    C4245t.this.mo9959c(C4245t.this.f14250r - 1);
                                } else {
                                    C4245t.this.mo9959c(Math.min(C4245t.this.f14252t, C4245t.this.f14250r - 1));
                                }
                            }
                        }
                    });
                }
                if (C4245t.this.f14226K != null) {
                    C4245t.this.f14234S = 0;
                    C4245t.this.f14226K.mo10010c();
                }
                if (C4245t.this.f14236d instanceof C1936c) {
                    m16913a();
                    return;
                }
                synchronized (C4245t.this.f14227L) {
                    int b = C4245t.this.f14250r - 1;
                    while (true) {
                        if (b < 0 || this.f14261b) {
                            break;
                        }
                        C1878d b2 = C4245t.this.f14236d.mo5036b(b);
                        if (b2 == null) {
                            C4245t.this.f14234S = 0;
                            if (C4245t.this.f14226K != null) {
                                C4245t.this.f14226K.mo10012e();
                            }
                            this.f14261b = true;
                        } else {
                            ((C4262x) C4245t.this.f14249q.get(b)).mo10028a(b2);
                            b--;
                        }
                    }
                }
        ...
        private void m16913a() {
            C4252c cVar;
            C4245t.this.f14217B = C4245t.this.f14257y;
            C4245t.this.f14218C = C4245t.this.f14235c;
            C4245t.this.f14219D = C4245t.this.f14258z;
            C4245t.this.f14220E = C4245t.this.f14216A;
            C4252c cVar2 = null;
            while (!this.f14261b) {
                m16914a(500);
                if (C4245t.this.f14226K != null) {
                    cVar = C4245t.this.f14226K.mo10013f();
                } else {
                    cVar = null;
                }
                if (cVar != null) {
                    if (cVar2 != null && cVar2.mo10001a(cVar)) {
                        ...
                        while (true) {
                            ...
                            synchronized (C4245t.this.f14227L) {
                                if (C4245t.this.f14236d.mo5034b() == C4245t.this.f14249q.size()) {
                                    C1878d b = C4245t.this.f14236d.mo5036b(i);
                                    if (b != null) {
                                        if (C4245t.this.f14249q.size() <= i) {
                                            C2261g.m9766b("BrowserViewModel", "Contents is Out of index!!");
                                        } else {
                                            ((C4262x) C4245t.this.f14249q.get(i)).mo10028a(b);
                                        }
                                    }
                                }
                            }
    ...
    private class C4249b implements Runnable {
        ...
        private void m16916a() {
            C4245t.this.f14236d = C2253z.m9703f();
            if (C4245t.this.f14236d != null) {
                int size = C4245t.this.f14249q.size();
                C4245t.this.f14250r = C4245t.this.f14236d.mo5034b();
                C2261g.m9763a("BrowserViewModel", "AddBrowsing " + size + "→" + C4245t.this.f14250r);
                synchronized (C4245t.this.f14227L) {
                    Runtime runtime = Runtime.getRuntime();
                    int maxMemory = (int) (runtime.maxMemory() / 1024);
                    int i = size;
                    while (true) {
                        if (i >= C4245t.this.f14250r || this.f14269g) {
                            break;
                        }
                        if (i % 1000 == 0) {
                            int freeMemory = (int) ((runtime.totalMemory() - runtime.freeMemory()) / 1024);
                            C2261g.m9769c("TEST", "loop:" + i + "usedMemory[KB] = " + freeMemory + " maxMemory[KB] = " + maxMemory);
                            if (freeMemory + 10000 > maxMemory) {
                                C4245t.this.f14250r = i;
                                C4245t.this.f14236d.mo5030a(C4245t.this.f14250r);
                                break;
                            }
                        }
                        C4245t.this.f14249q.add(new C4262x(null, i, C4245t.this.f14256x, C4245t.this.f14236d));
                ...
                synchronized (C4245t.this.f14227L) {
                    ...
                    while (true) {
                        ...
                        if (b2 == null) {
                            ...
                            C4262x xVar = (C4262x) C4245t.this.f14249q.get(b);
                            if (C4245t.this.f14257y == 9 && xVar.mo10034h()) {
                                b2.mo4606a(0);
                            }
                            xVar.mo10028a(b2);
                            b--;
        ...
        private void m16917b() {
            C1922a aVar;
            C1922a aVar2 = null;
            if (C4245t.this.f14257y == 2) {
                C4245t.this.f14236d = C2253z.m9695c(C4245t.this.f3706a, null);
            } else if (C4245t.this.f14257y == 5) {
                C4245t.this.f14236d = C2253z.m9687b(C4245t.this.f3706a);
            } else if (C4245t.this.f14257y == 6) {
                C4245t.this.f14236d = C2253z.m9694c(C4245t.this.f3706a);
                if (C4245t.this.f14236d instanceof C1924c) {
                    ((C1924c) C4245t.this.f14236d).mo5050a(C4245t.this.f14232Q, C4245t.this.f14233R);
                }
            } else if (C4245t.this.f14257y == 7) {
                C4245t.this.f14236d = C2253z.m9697d(C4245t.this.f3706a);
            } else if (C4245t.this.f14257y == 10) {
                C4245t.this.f14236d = C2253z.m9700e(C4245t.this.f3706a);
            } else if (C4245t.this.f14257y == 1 || C4245t.this.f14257y == 9) {
                C1892f a = C1712b.m6919c().mo4896a();
                C4245t.this.f14236d = C2253z.m9695c(C4245t.this.f3706a, a);
                if (C4245t.this.f14236d instanceof C1922a) {
                    aVar = (C1922a) C4245t.this.f14236d;
                } else {
                    aVar = null;
                }
                ...
                aVar2 = aVar;
            } else if (C4245t.this.f14257y == 3) {
                C4245t.this.f14236d = C2253z.m9678a(C4245t.this.f3706a, C4245t.this.f14256x, C4245t.this.f14226K);
            } else if (C4245t.this.f14257y == 4) {
                C4245t.this.f14236d = C2253z.m9704f(C4245t.this.f3706a);
            } else if (C4245t.this.f14257y == 8) {
                C4245t.this.f14236d = C2253z.m9705g(C4245t.this.f3706a);
                if (C4245t.this.f14236d instanceof C1923b) {
                    ((C1923b) C4245t.this.f14236d).mo5048a(C4245t.this.f14233R);
                }
            }
            if (C4245t.this.f14236d != null) {
                C2253z.m9685a(C4245t.this.f14236d);
                C4245t.this.f14236d.mo5032a(C4245t.this.f14235c, C4245t.this.f14258z, C4245t.this.f14216A);
                if (aVar2 == null || !aVar2.mo5044i()) {
                    if (aVar2 == null || !aVar2.mo5045j()) {
                        C4245t.this.f14250r = C4245t.this.f14236d.mo5034b();
                        if (!this.f14263a) {
                            if (C4245t.this.f14250r > 100000) {
                                C4245t.this.f14226K.mo10007a(0);
                            }
                            synchronized (C4245t.this.f14227L) {
                                Runtime runtime = Runtime.getRuntime();
                                int maxMemory = (int) (runtime.maxMemory() / 1024);
                            ...
                            if (this.f14266d) {
                                this.f14266d = false;
                            } else if (C4245t.this.f14236d instanceof C1936c) {
                                m16918c();
                            } else {
                                synchronized (C4245t.this.f14227L) {
                                    int b3 = C4245t.this.f14250r - 1;
                                    while (true) {
                                        if (b3 < 0 || this.f14269g) {
                                            break;
                                        }
                                        C1878d b4 = C4245t.this.f14236d.mo5036b(b3);
                                        if (b4 == null) {
                                            C4245t.this.f14234S = 0;
                                            if (C4245t.this.f14226K != null) {
                                                C4245t.this.f14226K.mo10012e();
                                            ...
                                            C4262x xVar2 = (C4262x) C4245t.this.f14249q.get(b3);
                                            if (C4245t.this.f14257y == 9 && xVar2.mo10034h()) {
                                                b4.mo4606a(0);
                                            }
                                            xVar2.mo10028a(b4);
                                            b3--;
                        ...
                        } else if (C4245t.this.f14226K != null) {
                            C4245t.this.f14234S = 0;
                            C4245t.this.f14226K.mo10010c();
                        }
                    } else if (C4245t.this.f14226K != null) {
                        C4245t.this.f14226K.mo10007a(2);
                    }
                } else if (C4245t.this.f14226K != null) {
                    C4245t.this.f14226K.mo10007a(1);
                }
            }
        }
                                ...
                                if (C4245t.this.f14236d.mo5034b() == C4245t.this.f14249q.size()) {
                                    ...
                                    if (b != null) {
                                        if (C4245t.this.f14249q.size() <= i) {
                                            ...
                                            C4262x xVar = (C4262x) C4245t.this.f14249q.get(i);
                                            if (C4245t.this.f14257y == 9 && b.mo4858w()) {
                                                b.mo4606a(0);
                                            }
                                            xVar.mo10028a(b);
                                        }
    ...
    private class C4253d implements Runnable {
        ...
        public void run() {
            ...
            C4245t.this.f14234S = 0;
            if (C4245t.this.f14226K != null && !this.f14278d) {
                C4245t.this.f14226K.mo10011d();
            }
        }
        ...
        private void m16923a() {
            ...
            C4245t.this.f14236d = C2253z.m9695c(C4245t.this.f3706a, null);
            if (C4245t.this.f14236d instanceof C1924c) {
                cVar = (C1924c) C4245t.this.f14236d;
            } else {
                cVar = null;
            }
            if (cVar != null) {
                SparseArray sparseArray = new SparseArray();
                cVar.mo5051b(C4245t.this.f14235c);
                int b = C4245t.this.f14236d.mo5034b();
                ArrayList arrayList = new ArrayList();
                List a = C4245t.this.f14249q;
                int i2 = -1;
                if (a != null) {
                    ...
                    while (true) {
                        ...
                        i2 = i + 1;
                        C1878d b2 = C4245t.this.f14236d.mo5036b(i2);
                        if (b2 == null) {
                            C4245t.this.f14234S = 0;
                            if (C4245t.this.f14226K != null) {
                                C4245t.this.f14226K.mo10012e();
                            ...
                            arrayList.add(new C4262x(b2, i2, C4245t.this.f14256x, C4245t.this.f14236d));
                        } else {
                            return;
                        }
                    }
                ...
                int i3 = i + 1;
                while (i3 < b) {
                    arrayList.add(new C4262x(C4245t.this.f14236d.mo5036b(i3), i3, C4245t.this.f14256x, C4245t.this.f14236d));
                    if (!this.f14277c) {
                        i3++;
                    } else {
                        return;
                ...
                C4245t.this.f14249q = arrayList;
                C4245t.this.f14250r = b;
                if (C4245t.this.f14256x != null) {
                    C4245t.this.f14256x.post(new Runnable() {
                        public void run() {
                            C4245t.this.f14239g.mo3216a(Integer.valueOf(C4245t.this.f14250r));
    ...
    public C4245t(Context context, Handler handler, C4255e eVar) {
    ...
    public C4245t(Context context, Handler handler, C4255e eVar, boolean z) {
        super(context, handler);
        this.f14256x = handler;
        this.f14226K = eVar;
        m16845e(z);
    ...
    private void m16845e(boolean z) {
        ...
        this.f14242j = new C1344c<Boolean>(Boolean.valueOf(false)) {
            ...
            public void mo3216a(Boolean bool) {
                super.mo3216a(bool);
                C4245t.this.f14248p.mo3216a(Boolean.valueOf(!bool.booleanValue()));
            }
        };
    ...
    public void mo9960c(boolean z) {
        ...
        synchronized (this.f14227L) {
            ...
            if (this.f14236d instanceof C1936c) {
    ...
    public boolean mo9969g(int r7) {
        ...
        L_0x00d6:
            ...
            goto L_0x0061
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.parts.C4245t.mo9969g(int):boolean");
    }
    ...
    public boolean mo9971h(int r7) {
        ...
        L_0x00c4:
            ...
            goto L_0x002a
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.parts.C4245t.mo9971h(int):boolean");
    }
    ...
    public boolean mo9973i(int r4) {
        ...
        L_0x005c:
            ...
            goto L_0x001c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.view.parts.C4245t.mo9973i(int):boolean");
    }
