...
public class SetPickerPosition extends FrameLayout {
    ...
    public SetPickerPosition(Context context) {
        this(context, (AttributeSet) null);
    }

    public SetPickerPosition(Context context, int i) {
        this(context, (AttributeSet) null);
        this.f13315g = i;
    }

    public SetPickerPosition(Context context, AttributeSet attributeSet) {
    ...
    public boolean mo9431a(String[] strArr, LinearLayout linearLayout, FrameLayout frameLayout, int i, int i2, int i3, boolean z) {
        ...
        this.f13319k.setOnPositionChangedListener(new C4045a() {
            ...
            public void mo9445a(int i, boolean z) {
                if (SetPickerPosition.this.f13309a != null && SetPickerPosition.this.f13320l != i) {
                    SetPickerPosition.this.f13309a.mo9447a(i4, i, z);
                    SetPickerPosition.this.f13320l = i;
                }
            }
        });
            ...
            public void onDraw(Canvas canvas) {
                if (getWidth() > 0 && getHeight() > 0) {
                    if (this.f13332c == null) {
                        float c = SetPickerPosition.this.getDisplayScale();
                        ...
                        canvas2.rotate(180.0f, (float) (this.f13332c.getWidth() / 2), (float) (this.f13332c.getHeight() / 2));
                        if (SetPickerPosition.this.f13324p == 0) {
                            SetPickerPosition.this.m16031a((View) this, canvas2);
                        }
                    }
    ...
    public void mo9433b(int i, int i2) {
        if (i >= 0 && this.f13310b.size() > i && i2 != this.f13321m) {
            ...
            invalidate();
            ImageAppLog.error("setPickerPosition", String.format(Locale.getDefault(), " itemPos : %d pos : %d", new Object[]{Integer.valueOf(i), Integer.valueOf(i2)}));
        }
    }
