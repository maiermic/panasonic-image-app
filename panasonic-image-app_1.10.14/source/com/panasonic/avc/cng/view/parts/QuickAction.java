...
public class QuickAction extends C4268z {
    ...
    public void mo9726a(int i) {
        ...
        ImageAppLog.verbose("QuickAction", String.format(Locale.US, "mergin[%d]", new Object[]{Integer.valueOf(i)}));
        ImageAppLog.verbose("QuickAction", String.format(Locale.US, "root[%d:%d, %d:%d], screen[%d:%d]", new Object[]{Integer.valueOf(left), Integer.valueOf(top), Integer.valueOf(measuredWidth), Integer.valueOf(measuredHeight), Integer.valueOf(i4), Integer.valueOf(i5)}));
        ImageAppLog.verbose("QuickAction", String.format(Locale.US, "anchor[%d:%d, %d:%d]", new Object[]{Integer.valueOf(rect.left), Integer.valueOf(rect.top), Integer.valueOf(rect.right), Integer.valueOf(rect.bottom)}));
