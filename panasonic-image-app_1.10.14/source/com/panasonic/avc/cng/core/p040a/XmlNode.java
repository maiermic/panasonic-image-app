...
public class XmlNode extends C1497c {
        ...
        public static C1524a m6016a() {
            ...
            synchronized (f4230b) {
                if (!f4230b.isEmpty()) {
                    ...
                    if (aVar.f4231c != 0) {
                        ImageAppLog.error("XmlNode", "mRefCnt=" + aVar.f4231c);
                    }
                    aVar.f4231c++;
                    aVar.f4233e = null;
                    aVar.f4232d = null;
        ...
        public static C1524a m6017a(String str) {
            if (str == null) {
                try {
                    ...
                    ImageAppLog.error("XmlNode", "XmlPullParserException!!");
                    throw new XmlPullParserException("MovieRemoteError.CONTROL_BADRESPONSE");
                } catch (IOException e2) {
                    ImageAppLog.error("XmlNode", "IOException!!");
        ...
        new Thread(new Runnable() {
            public void run() {
                synchronized (C1910l.m7679a()) {
                    XmlNode.this.m6002b(XmlNode.this.f4222l);
                }
            }
        }).start();
        return true;
    ...
    public boolean mo3740a(String str) {
        ...
        new ParseTagHighlightSceneInfo((String) null);
        for (int i = 0; i < this.f4121d; i++) {
            String a = StaticHttpCommand.m5704a(str2);
            if (a == null) {
                ImageAppLog.error("CameraService", "SetMenuValue() is null....");
                mo3674a(1000);
            } else {
                ...
                if (hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                    ImageAppLog.warning("CameraService", String.format("sendGeotagCommand() Result = %s", new Object[]{hVar.mo4772b()}));
                    mo3674a(1000);
                } else {
                    ImageAppLog.warning("CameraService", String.format("sendGeotagCommand() Result = %s", new Object[]{hVar.mo4772b()}));
                    return false;
            ...
            if (a != null) {
                ...
                if (!aeVar.mo4634a()) {
                    if (!aeVar.mo4635b().equalsIgnoreCase("err_busy")) {
                        ImageAppLog.warning("CameraService", String.format("sendGeotagCommand() Result = %s", new Object[]{aeVar.mo4635b()}));
                        break;
                    }
                    ImageAppLog.warning("CameraService", String.format("sendGeotagCommand() Result = %s", new Object[]{aeVar.mo4635b()}));
                    mo3674a(1000);
    ...
    public boolean m6006e() {
        ...
        L_0x0154:
            ...
            java.lang.String r4 = com.panasonic.avc.cng.core.p040a.StaticHttpCommand.m5704a(r4)     // Catch:{ Exception -> 0x01ba }
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r5, r1)     // Catch:{ Exception -> 0x01ba }
        ...
        L_0x01ca:
            ...
            goto L_0x0135
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.core.p040a.XmlNode.m6006e():boolean");
    }
    ...
    public boolean m6002b(Context context) {
        this.f4223m = false;
        try {
            String a = StaticHttpCommand.m5704a(this.f4119b + "/cam.cgi?mode=camcmd&value=playmode");
            ImageAppLog.info("CameraService", "ExecuteGeoTagSend=/cam.cgi?mode=camcmd&value=playmode");
            if (!new ParseTagHighlightSceneInfo(a).mo4771a()) {
                ImageAppLog.error("CameraService", "sendGeotagData setPlayMode error");
                if (this.f4219i == null) {
                    return false;
                }
            ...
            String a2 = StaticHttpCommand.m5704a(this.f4119b + str);
            ImageAppLog.info("CameraService", "NotifyClock=" + str);
            ImageAppLog.info("CameraService", a2);
            if (new ParseTagHighlightSceneInfo(a2).mo4771a()) {
                ...
                String a3 = StaticHttpCommand.m5704a(this.f4119b + format);
                ImageAppLog.info("CameraService", "StartGeotag=" + format);
                if (new ParseTagHighlightSceneInfo(a3).mo4771a()) {
                    C1524a b = m6001b(a3);
                    if (b != null) {
            ...
            ImageAppLog.error("CameraService", "sendGeotagData error=" + Integer.toHexString(e2.hashCode()));
            if (this.f4219i == null) {
                return false;
            }
    ...
    private synchronized java.lang.String m5997a(android.content.Context r8, java.lang.String r9) {
        ...
        L_0x0025:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r1, r2)     // Catch:{ all -> 0x0151 }
            ...
            com.panasonic.avc.cng.util.ImageAppLog.debug(r2, r3)     // Catch:{ Exception -> 0x00f7 }
        ...
        L_0x00ee:
            ...
            com.panasonic.avc.cng.core.p040a.StaticHttpCommand.m5715c()     // Catch:{ all -> 0x0151 }
        L_0x00f2:
            monitor-exit(r7)
            return r6
        L_0x00f4:
        ...
        L_0x00f7:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.error(r1, r2)     // Catch:{ all -> 0x0162 }
            java.lang.String r1 = r0.getMessage()     // Catch:{ all -> 0x0162 }
            if (r1 == 0) goto L_0x011f
            java.lang.String r1 = "CameraService"
            java.lang.String r0 = r0.getMessage()     // Catch:{ all -> 0x0162 }
            com.panasonic.avc.cng.util.ImageAppLog.error(r1, r0)     // Catch:{ all -> 0x0162 }
        L_0x011f:
        ...
        L_0x0177:
            ...
            throw r0     // Catch:{ all -> 0x0151 }
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.core.p040a.XmlNode.m5997a(android.content.Context, java.lang.String):java.lang.String");
    }
