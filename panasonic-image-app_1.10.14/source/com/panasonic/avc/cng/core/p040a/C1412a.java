...
public class C1412a extends C1497c {
    ...
    public boolean mo3410a(String str) {
        ...
        C1450al.m5708a(this.f4119b + "/cam.cgi?mode=senddata", b);
        return true;
    }
    ...
    public boolean mo3413b(String str) {
        ...
        C1853h c = mo3678c("pantiltstart", str);
        if (c == null || !c.mo4771a()) {
            return false;
        }
        return true;
    ...
    public boolean mo3415c(String str) {
        ...
        C1853h c = mo3678c("pantiltstop", str);
        if (c == null || !c.mo4771a()) {
            return false;
        }
        return true;
    ...
    private void m5531d() {
        if (this.f3845i == null) {
            do {
                try {
                    C2261g.m9771e("BabyMonitorCommand", String.format("UDP socket open[%d]", new Object[]{Integer.valueOf(this.f3846j)}));
                    this.f3845i = new DatagramSocket(this.f3846j);
                } catch (Exception e) {
                    e.printStackTrace();
                    C2261g.m9771e("BabyMonitorCommand", String.format("UDP socket close[%d]", new Object[]{Integer.valueOf(this.f3846j)}));
                    if (this.f3845i != null) {
                        this.f3845i.close();
                    }
                    this.f3846j++;
