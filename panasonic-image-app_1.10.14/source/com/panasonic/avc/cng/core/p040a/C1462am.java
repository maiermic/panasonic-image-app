...
class C1462am {
    ...
    static synchronized String m5736a(String str, int i) {
        ...
        synchronized (C1462am.class) {
            ...
            synchronized (f3956a) {
                C2260f.m9757d("StaticHttpCustomCommand", "SendCGICommand:" + str);
                try {
                    ...
                    str2 = (String) defaultHttpClient.execute(httpGet, new ResponseHandler<String>() {
                        ...
                        public String handleResponse(HttpResponse httpResponse) {
                            switch (httpResponse.getStatusLine().getStatusCode()) {
                                ...
                                default:
                                    C2260f.m9758e("StaticHttpCustomCommand", String.format("HttpStatus = %d", new Object[]{Integer.valueOf(httpResponse.getStatusLine().getStatusCode())}));
                                    return null;
                            }
                        }
                    });
                    ...
                    C2260f.m9756c("StaticHttpCustomCommand", e.toString());
                    if (defaultHttpClient != null) {
                        if (defaultHttpClient.getConnectionManager() != null) {
                            defaultHttpClient.getConnectionManager().shutdown();
                        }
                    ...
                    C2260f.m9756c("StaticHttpCustomCommand", e2.toString());
                    if (defaultHttpClient != null) {
                        if (defaultHttpClient.getConnectionManager() != null) {
                            defaultHttpClient.getConnectionManager().shutdown();
                        }
                    ...
                    C2260f.m9756c("StaticHttpCustomCommand", e3.toString());
                    if (defaultHttpClient != null) {
                        if (defaultHttpClient.getConnectionManager() != null) {
                            defaultHttpClient.getConnectionManager().shutdown();
                        }
