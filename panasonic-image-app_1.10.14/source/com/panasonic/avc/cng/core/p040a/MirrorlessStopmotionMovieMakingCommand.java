...
public class MirrorlessStopmotionMovieMakingCommand extends C1497c implements Runnable {
    ...
    public MirrorlessStopmotionMovieMakingCommand(String str) {
        super(str);
    }
    ...
    public void run() {
        /*
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r0, r2)     // Catch:{ all -> 0x002e }
        ...
        L_0x00a5:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.error(r0, r2)     // Catch:{ all -> 0x002e }
            com.panasonic.avc.cng.core.a.r r0 = r7.f4278j     // Catch:{ all -> 0x002e }
            com.panasonic.avc.cng.model.service.l.b r2 = new com.panasonic.avc.cng.model.service.l.b     // Catch:{ all -> 0x002e }
            java.lang.String r3 = "error"
        ...
        L_0x0111:
            ...
            goto L_0x002c
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.core.p040a.MirrorlessStopmotionMovieMakingCommand.run():void");
    }
            ...
            if (a != null) {
                ...
                if (true != "ok".equalsIgnoreCase(split[0])) {
                    if (true != "err_busy".equalsIgnoreCase(split[0])) {
                        ImageAppLog.info("MirrorlessStopmotionMovieMakingCommand", String.format("Command = %s, Result = %s", new Object[]{str2, split[0]}));
                        break;
                    }
                    mo3674a(1000);
                } else {
                ...
                ImageAppLog.error("MirrorlessStopmotionMovieMakingCommand", "setMirrorlessStopmotionMovieMakingProcess() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    private void m6104a(String[] strArr, int[] iArr, String[] strArr2) {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            if (b == null) {
                ImageAppLog.error("MirrorlessStopmotionMovieMakingCommand", "getProgress() Error = null");
                mo3674a(1000);
            } else {
                ...
                if (xVar.mo4849a()) {
                    ...
                    ImageAppLog.error("MirrorlessStopmotionMovieMakingCommand", String.format("Result = %s %s", new Object[]{xVar.mo4850b(), str}));
                    strArr[0] = "error";
                    iArr[0] = -1;
                    strArr2[0] = "getprogress";
                }
