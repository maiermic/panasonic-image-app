...
public class LiveViewCommand extends C1497c implements Runnable {
    ...
    /* renamed from: m */
    private ModeChangeCommand f4260m;
    ...
    public LiveViewCommand(String str, String str2) {
        super(str);
        this.f4261n = str;
        this.f4262o = str2;
        this.f4256i = null;
        this.f4258k = null;
        this.f4260m = new ModeChangeCommand(str);
    }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:147:?, code lost:
        com.panasonic.avc.cng.util.ImageAppLog.error("LiveViewCommand", r0.toString());
     */
    ...
    public void run() {
        ...
        L_0x0009:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r0, r2)     // Catch:{ Exception -> 0x00f6 }
        ...
        L_0x0053:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r0, r1)     // Catch:{ all -> 0x01a2 }
        ...
        L_0x0093:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r1, r0)     // Catch:{ all -> 0x01a2 }
            r0 = 1
            r1 = 0
            r14 = r0
            r0 = r1
        ...
        L_0x00f6:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.error(r2, r0)     // Catch:{ SocketException -> 0x011d }
        ...
        L_0x01af:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.info(r0, r1)
        ...
        L_0x0293:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.error(r1, r0)     // Catch:{ Exception -> 0x01a5 }
            com.panasonic.avc.cng.core.a.q r0 = r15.f4256i     // Catch:{ Exception -> 0x01a5 }
        ...
        L_0x02b0:
            ...
            goto L_0x0029
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.core.p040a.LiveViewCommand.run():void");
    }

    /* renamed from: a */
    public ParseTagHighlightSceneInfo mo3789a(int i, int i2) {
            ...
            if (b != null) {
                ...
                if (!hVar.mo4771a()) {
                    if (!hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                        ImageAppLog.error("LiveViewCommand", String.format("StartStream() Error = %s.", new Object[]{hVar.mo4772b()}));
                        break;
                    }
                    ImageAppLog.error("LiveViewCommand", String.format("StartStream() Error = %s.", new Object[]{hVar.mo4772b()}));
                    if (f4255h) {
                        ImageAppLog.error("LiveViewCommand", "StartStream _forceStopStream and break2!");
                        f4255h = false;
                        break;
                    }
                    mo3674a(1000);
                    if (f4255h) {
                        ImageAppLog.error("LiveViewCommand", "StartStream _forceStopStream and break3!");
                        f4255h = false;
                        break;
                    }
                } else {
                ...
                ImageAppLog.error("LiveViewCommand", "StartStream() Error = null.");
                if (f4255h) {
                    ImageAppLog.error("LiveViewCommand", "StartStream _forceStopStream and break!");
                    break;
                }
                mo3674a(1000);
            }
    ...
    /* renamed from: b */
    public ParseTagHighlightSceneInfo mo3792b(int i) {
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                if (!hVar.mo4771a()) {
                    if (!hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                        ImageAppLog.error("LiveViewCommand", String.format("StopStream() Error = %s.", new Object[]{hVar.mo4772b()}));
                        break;
                    }
                    mo3674a(1000);
                } else {
                ...
                ImageAppLog.error("LiveViewCommand", "StopStream() Error = null.");
                if (f4255h) {
                    ImageAppLog.error("LiveViewCommand", "_forceStopStream and break!");
                    break;
                }
                mo3674a(1000);
            }
