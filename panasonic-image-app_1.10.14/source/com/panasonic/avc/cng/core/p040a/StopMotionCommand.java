...
public class StopMotionCommand extends C1501d {

    /* renamed from: h */
    private final String f3968h = "StopMotionCommand";

    public StopMotionCommand(String str) {
        super(str);
    }
    ...
    public C1915a mo3573o() {
        ...
        if (!b.mo4831a()) {
            ImageAppLog.info("StopMotionCommand", String.format("getStopMotionInfo Result = %s", new Object[]{b.mo4832b()}));
            return null;
        }
    ...
    /* renamed from: a */
    public ParseTagHighlightSceneInfo mo3570a(C1915a aVar) {
    ...
    public C1916b mo3574p() {
        ...
        if (!b.mo4831a()) {
            ImageAppLog.info("StopMotionCommand", String.format("getStopMotionConvertInfo Result = %s", new Object[]{b.mo4832b()}));
            return null;
        }
    ...
    public int mo3572f(String str, String str2) {
        ...
        for (int i2 = 0; i2 < this.f4121d; i2++) {
            String a = StaticHttpCommand.m5704a(str3);
            if (a == null) {
                ImageAppLog.error("StopMotionCommand", "RecStop() is null....");
                mo3674a(1000);
            } else {
                new ParseTagHighlightSceneInfo(a);
                ...
                if (hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                    ...
                    ImageAppLog.info("StopMotionCommand", String.format("RecStop() Result = %s", new Object[]{hVar.mo4772b()}));
                    return -1;
                }
            }
        }
