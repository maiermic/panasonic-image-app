...
public class HighLightCommand extends C1497c implements Runnable {
    ...
    public HighLightCommand(String str) {
        super(str);
    }
    ...
    public void run() {
        ...
        L_0x008d:
            ...
            com.panasonic.avc.cng.util.ImageAppLog.error(r0, r2)     // Catch:{ all -> 0x003d }
            com.panasonic.avc.cng.core.a.p r0 = r6.f4246i     // Catch:{ all -> 0x003d }
            com.panasonic.avc.cng.model.service.e.b r2 = new com.panasonic.avc.cng.model.service.e.b     // Catch:{ all -> 0x003d }
            java.lang.String r3 = "error"
        ...
        L_0x00f9:
            ...
            goto L_0x008d
        */
        throw new UnsupportedOperationException("Method not decompiled: com.panasonic.avc.cng.core.p040a.HighLightCommand.run():void");
    }
            ...
            if (b != null) {
                ...
                if (!hVar.mo4771a()) {
                    if (!hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                        ImageAppLog.warning("HighLightCommand", String.format("Result = %s %s", new Object[]{hVar.mo4772b(), str}));
                        break;
                    }
                    mo3674a(1000);
                } else {
                ...
                ImageAppLog.error("HighLightCommand", "highlightCancel() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    public boolean mo3756a(String[] strArr, String[] strArr2) {
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                ImageAppLog.error("HighLightCommand", "getHighlightScene() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    private boolean m6028b(int i) {
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                ImageAppLog.error("HighLightCommand", "setHighlightDataSize() Error = null");
                mo3674a(1000);
            }
            i2++;
        }
    ...
    private boolean m6027a(String str) {
        ...
        while (true) {
            ...
            String a = StaticHttpCommand.m5705a(str2, str);
            if (a != null) {
                ParseTagHighlightSceneInfo hVar = new ParseTagHighlightSceneInfo(a);
                if (!hVar.mo4771a()) {
                    if (!hVar.mo4772b().equalsIgnoreCase("err_busy")) {
                        ImageAppLog.warning("HighLightCommand", String.format("Result = %s %s", new Object[]{hVar.mo4772b(), str2}));
                        break;
                    }
                    mo3674a(1000);
                } else {
                ...
                ImageAppLog.error("HighLightCommand", "sendHighlightData() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    public void mo3754a(String[] strArr, int[] iArr, String[] strArr2) {
        ...
        for (int i = 0; i < 5; i++) {
            byte[] b = StaticHttpCommand.m5713b(str);
            if (b == null) {
                ImageAppLog.error("HighLightCommand", "getProgress() Error = null");
                mo3674a(1000);
            } else {
                ...
                if (aeVar.mo4634a()) {
                    ...
                    ImageAppLog.error("HighLightCommand", String.format("Result = %s %s", new Object[]{aeVar.mo4635b(), str}));
                    strArr[0] = "error";
                    iArr[0] = -1;
                    strArr2[0] = "getprogress";
                }
    ...
    /* renamed from: a */
    public ParseTagHighlightSceneInfo mo3752a(String str, long j) {
    ...
    public boolean mo3755a(byte[] bArr) {
        ...
        while (true) {
            ...
            if (a != null) {
                ...
                ImageAppLog.error("HighLightCommand", "sendData() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    public boolean mo3758c() {
        ParseTagHighlightSceneInfo hVar;
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                ImageAppLog.error("HighLightCommand", "requestSendData() Error = null");
                mo3674a(1000);
            }
        }
        return hVar.mo4771a();
    ...
    public boolean mo3759d() {
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                ImageAppLog.error("HighLightCommand", "endSendData() Error = null");
                mo3674a(1000);
            }
            i++;
        }
    ...
    public boolean mo3760e() {
        ...
        while (true) {
            ...
            if (b != null) {
                ...
                ImageAppLog.error("HighLightCommand", "abortsenddata() Error = null");
                mo3674a(1000);
            }
            i++;
        }
