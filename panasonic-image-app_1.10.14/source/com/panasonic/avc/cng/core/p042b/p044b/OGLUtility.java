...
public class OGLUtility {
    ...
    public static int m6246a(String str, String str2) {
        ...
        if (glCreateProgram != 0) {
            ...
            if (iArr[0] != 1) {
                ImageAppLog.error("OGLUtility", "Could not link program: ");
                ImageAppLog.error("OGLUtility", GLES20.glGetProgramInfoLog(glCreateProgram));
    ...
    public static int m6245a(int i, String str) {
        ...
        if (glCreateShader != 0) {
            ...
            if (iArr[0] == 0) {
                ImageAppLog.error("OGLUtility", "Could not compile shader " + i + ":");
                ImageAppLog.error("OGLUtility", GLES20.glGetShaderInfoLog(glCreateShader));
