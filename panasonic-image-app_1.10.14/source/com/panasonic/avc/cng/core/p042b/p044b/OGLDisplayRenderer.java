...
public class OGLDisplayRenderer {
    ...
    public void mo3884a() {
        try {
            ImageAppLog.info("OGLDisplayRenderer", String.format("Render Performance = %f fps", new Object[]{Double.valueOf((((double) this.f4374d) * 1000.0d) / ((double) this.f4375e))}));
            if (this.f4372b != null) {
                this.f4372b.mo3874a();
                this.f4372b = null;
            }
