...
public class RemoteWatchNfcSupportActivity extends C1350a implements C2323a {
    ...
    protected RemoteWatchNfcSupportViewModel _nfcViewModel;
    ...
    private class C1388b implements C1400e {
        ...
        public void mo3358a(int i, C1892f fVar) {
            RemoteWatchNfcSupportActivity.this._nfcViewModel.mo3366a(false, false);
            switch (i) {
                case 0:
                    RemoteWatchNfcSupportActivity.this._listener.mo3357a(fVar);
                    return;
                case 2:
                    RemoteWatchNfcSupportActivity.this.SettingMenuBaseViewModelThreadFinish();
                    RemoteWatchNfcSupportActivity.this._listener.mo3356a();
                    return;
                default:
                    RemoteWatchNfcSupportActivity.this.SettingMenuBaseViewModelThreadFinish();
                    RemoteWatchNfcSupportActivity.this._listener.mo3356a();
    ...
    public void InitializeNfc(String str) {
        ...
        if (this._nfcViewModel == null) {
            this._nfcViewModel = new RemoteWatchNfcSupportViewModel(this._context, this._handler, this._nfcServiceLister, this._nfcViewModelListener);
    ...
    public void finish() {
        if (this._nfcViewModel != null) {
            ...
            if (!booleanValue) {
                C2820e.m11806a(this._activityName, (RemoteWatchNfcSupportViewModel) null);
            }
        }
        super.finish();
    }
    ...
    /* access modifiers changed from: protected */
    public void onPause() {
        ImageAppLog.debug("RemoteWatchNfcSupportActivity", "");
        super.onPause();
        if (this._nfcViewModel != null) {
    ...
    public C2242a GetRemoteWatchNfcResultListener() {
        return new C2242a() {
            ...
            /* renamed from: a */
            public void mo3345a() {
                ImageAppLog.debug("RemoteWatchNfcSupportActivity", "SetNfcProcessFlg");
                RemoteWatchNfcSupportActivity.this._nfcViewModel.mo3366a(false, false);
            ...
            public void mo3346a(long j) {
                if (RemoteWatchNfcSupportActivity.this._handler != null) {
                    RemoteWatchNfcSupportActivity.this._handler.post(new Runnable() {
                        public void run() {
                            RemoteWatchNfcSupportActivity.this._nfcViewModel.f3798c = true;
                            Intent intent = new Intent(RemoteWatchNfcSupportActivity.this._context, NfcFirstTouchActivity.class);
                            RemoteWatchNfcSupportActivity.this._nfcViewModel.mo3365a(true);
                            RemoteWatchNfcSupportActivity.this.startActivityForResult(intent, 14);
                        }
                    });
                }
            }
