...
public class C1389e extends C1342a {
    ...
    protected class C1391a implements Runnable {
        ...
        public void run() {
            this.f3821b = false;
            C1389e.this.m5458a((C1398c) new C1398c() {
                /* renamed from: a */
                public void mo3385a() {
                    C2261g.m9763a("★ImageAppViewModel", "OnFind");
                    if (!C1391a.this.f3821b) {
                        C1389e.this.f3707b.post(new Runnable() {
                            public void run() {
                                C1389e.this.m5478n();
                            }
                        });
                ...
                public void mo3386b() {
                    ...
                    if (!C1391a.this.f3821b) {
                        C1389e.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (C1389e.this.f3811p != null) {
                                    C2261g.m9763a("★ImageAppActivity", "dismiss.CameraSearching");
                                    C1389e.this.f3811p.mo3360b(C2328a.CameraSearching);
                                    C1389e.this.f3811p.mo3359a(C2328a.WiFiFailed);
                                }
                            }
                        });
                    }
    ...
    protected class C1395b implements Runnable {
        ...
        public void run() {
            ...
            this.f3826b = false;
            try {
                C1389e.this.f3817v = null;
                String str = "\"" + C1389e.this.f3814s + "\"";
                Iterator it = C1389e.this.f3813r.iterator();
                while (true) {
                    if (!it.hasNext()) {
                        break;
                    }
                    ...
                    if (fVar.f5685g.equals(str)) {
                        C1389e.this.f3817v = fVar;
                        break;
                    } else if (fVar.f5685g.equals(C1389e.this.f3814s)) {
                        C1389e.this.f3817v = fVar;
                        break;
                    } else {
                ...
                if (z) {
                    ...
                    C1389e.this.f3707b.post(new Runnable() {
                        public void run() {
                            if (C1389e.this.f3811p != null) {
                                C1389e.this.f3811p.mo3360b(C2328a.CameraSearching);
                                C1389e.this.f3811p.mo3358a(0, C1389e.this.f3817v);
                            }
                        }
                    });
                }
    ...
    protected class C1406g implements Runnable {
        ...
        public void run() {
            this.f3836b = false;
            C1389e.this.m5464b((C1399d) new C1399d() {
                /* renamed from: c */
                public void mo3395c() {
                    if (!C1406g.this.f3836b) {
                        C1389e.this.f3707b.post(new Runnable() {
                            public void run() {
                                if (C1389e.this.f3811p != null) {
                                    C1389e.this.f3811p.mo3360b(C2328a.WifiConnecting);
                                    C1389e.this.f3811p.mo3359a(C2328a.WiFiFailed);
                                }
                            }
                        });
    ...
    public C1389e(Context context, Handler handler, C2242a aVar, C1400e eVar) {
    ...
    /* renamed from: a */
    public void mo3205a() {
        C2261g.m9763a("RemoteWatchNfcSupportViewModel", "Dispose");
        if (this.f3807l != null) {
            C2261g.m9763a("RemoteWatchNfcSupportViewModel", "StopNfcWatch");
            this.f3807l.mo5533f();
            mo3372d();
            if (!this.f3818w) {
                C2261g.m9763a("RemoteWatchNfcSupportViewModel", "Finalize");
                this.f3807l.mo5534g();
                C2261g.m9763a("RemoteWatchNfcSupportViewModel", "Finalize end");
                this.f3807l = null;
            }
        }
        super.mo3205a();
    ...
    public void m5458a(C1398c cVar) {
        ...
        if (this.f3813r == null) {
            ...
            C2261g.m9763a("★CameraSearch:", "DeviceList.size=" + String.valueOf(this.f3813r.size()));
        }
    ...
    public void mo3377i() {
        if (this.f3807l != null) {
            new Thread(new Runnable() {
                public void run() {
                    C1389e.this.mo3370c(1000);
                    if (C1389e.this.f3807l != null && !C1389e.this.f3808m) {
                        C1389e.this.f3807l.mo5531d();
                    }
                }
            }).start();
        }
    ...
    public void mo3366a(boolean z, boolean z2) {
        synchronized (this.f3809n) {
            if (this.f3807l != null) {
                C2261g.m9763a("RemoteWatchNfcSupportViewModel", "SetNfcProcessFlg");
