...
public abstract class NfcSupportActivity extends C5741i {
    ...
    public NfcSupportViewModel _nfcViewModel;
    ...
    private class C1361b implements C1373e {
        ...
        public void mo3273a(int i, C1892f fVar) {
            NfcSupportActivity.this._nfcViewModel.mo3282a(false, false);
            switch (i) {
                case 0:
                    SharedPreferences defaultSharedPreferences = PreferenceManager.getDefaultSharedPreferences(NfcSupportActivity.this._context);
                    ...
                    if (!string.equals(fVar.f5697s) || !string2.equals(fVar.f5698t) || string.length() == 0 || string2.length() == 0) {
                        NfcSupportActivity.this._nfcViewModel.mo3280a(fVar.f5696r, fVar.f5697s, fVar.f5698t);
                    }
                    NfcSupportActivity.this._listener.mo3272a(fVar);
                    return;
                case 2:
                    NfcSupportActivity.this.SettingMenuBaseViewModelThreadFinish();
                    NfcSupportActivity.this._listener.mo3271a();
                    return;
                default:
                    NfcSupportActivity.this.SettingMenuBaseViewModelThreadFinish();
                    NfcSupportActivity.this._listener.mo3271a();
    ...
    public void InitializeNfc(String str, byte b, boolean z) {
        ...
        if (this._nfcViewModel == null) {
            this._nfcViewModel = new NfcSupportViewModel(this._context, this._handler, this._nfcServiceLister, this._nfcViewModelListener, b, C2208b.f6845a, z);
    ...
    public void finish() {
        ImageAppLog.debug("NfcSupportActivity", "");
        if (this._nfcViewModel != null) {
            ImageAppLog.debug("NfcSupportActivity", "_nfcViewModel != null");
            boolean booleanValue = this._nfcViewModel.mo3301m().booleanValue();
            this._nfcViewModel.mo3205a();
            this._nfcViewModel = null;
            if (!booleanValue) {
                C2820e.m11805a(this._activityName, (NfcSupportViewModel) null);
            }
        }
        super.finish();
    }
    ...
    public C2207a GetNfcResultListener() {
        return new C2207a() {
            ...
            public void mo3255a(String str, String str2, String str3, boolean z, long j, long j2, long j3) {
                NfcSupportActivity.this._nfcViewModel.mo3292e(str2);
                NfcSupportActivity.this._nfcViewModel.mo3290d(str);
                if (!z) {
                    NfcSupportActivity.this._nfcViewModel.mo3284b(str2);
                } else {
                    NfcSupportActivity.this._nfcViewModel.mo3279a(str2, str3);
                }
            }

            /* renamed from: a */
            public void mo3251a() {
                ImageAppLog.debug("NfcSupportActivity", "SetNfcProcessFlg");
                NfcSupportActivity.this._nfcViewModel.mo3282a(false, false);
                ImageAppLog.debug("★ImageAppActivity", "NFC OnFailed");
            }
            ...
            public void mo3253a(long j) {
                if (NfcSupportActivity.this._handler != null) {
                    NfcSupportActivity.this._handler.post(new Runnable() {
                        public void run() {
                            NfcSupportActivity.this._nfcViewModel.f3750c = true;
                            Intent intent = new Intent(NfcSupportActivity.this._context, NfcFirstTouchActivity.class);
                            NfcSupportActivity.this._nfcViewModel.mo3281a(true);
                            NfcSupportActivity.this.startActivityForResult(intent, 14);
                        }
                    });
                }
            }
