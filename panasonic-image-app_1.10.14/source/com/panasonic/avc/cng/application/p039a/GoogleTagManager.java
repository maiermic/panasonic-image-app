...
public class GoogleTagManager {
    ...
    /* renamed from: a */
    private static GoogleTagManager f3724a;
    ...
    /* renamed from: b */
    static /* synthetic */ int m5321b(GoogleTagManager bVar) {
        int i = bVar.f3730g + 1;
        bVar.f3730g = i;
        return i;
    }
    ...
    public static void m5319a(String str) {
        ImageAppLog.debug("Google-TagManager", str);
    }

    /* renamed from: a */
    public static GoogleTagManager m5317a() {
        if (f3724a == null) {
            f3724a = new GoogleTagManager();
        }
        return f3724a;
    }
            ...
            this.f3725b.mo2949a(this.f3728e, (int) R.raw.gtm_default_container).mo1593a(new C0594i<C1124b>() {
                ...
                public void mo1596a(C1124b bVar) {
                    if (bVar.mo1561b().mo1562c()) {
                        GoogleTagManager.m5319a("[SUCCESS] Container Loading");
                        GoogleTagManager.this.f3726c = bVar;
                        if (map != null) {
                            GoogleTagManager.m5319a("[TRACKING] " + GoogleTagManager.this.m5322b(map));
                            GoogleTagManager.this.f3725b.mo2950a().mo2909a("openScreen", map);
                            return;
                        }
                        return;
                    }
                    GoogleTagManager.m5321b(GoogleTagManager.this);
                    GoogleTagManager.m5319a("[FAILURE] Container Loading (" + GoogleTagManager.this.f3730g + " times)");
                }
            });
        }
    }
